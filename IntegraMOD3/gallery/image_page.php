...
$template->assign_vars(array(
    ...
    'UC_IMAGE'          => phpbb_gallery_image::generate_link('medium', phpbb_gallery_config::get('link_imagepage'), $image_id, $image_data['image_name'], $album_id, (substr($image_data['image_filename'], -3) == 'gif'), false, '', (isset($next_data['image_id'])) ? (int) $next_data['image_id'] : 0),
