...
function who_posted($topic_id)
{
    ...
    {
        // check permissions for seeing forum
        $topic_id = 0;
    }
    else if (!$forum_id)
    {
    ...
    // main query: select all the data for users and posts (thanks to poyntesm for documenting this so nicely)
$sql_ary = array(
...
'GROUP_BY'  => 'u.username, u.user_id, u.user_colour, p.post_username',
