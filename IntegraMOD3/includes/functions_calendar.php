...
if (!isset($weekday_list))
{
	...
	$weekday_list = array(
		'S' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][0]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][0] : 'Sunday',
		'M' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][1]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][1] : 'Monday',
		'T' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][2]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][2] : 'Tuesday',
		'W' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][3]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][3] : 'Wednesday',
		'H' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][4]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][4] : 'Thursday',
		'F' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][5]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][5] : 'Friday',
		'A' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][6]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_DAY'][6] : 'Saturday',
	);
}
...
{
	$month_list = array(
		'J' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][1]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][1] : 'January',
		'F' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][2]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][2] : 'February',
		'M' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][3]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][3] : 'March',
		'A' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][4]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][4] : 'April',
		'Y' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][5]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][5] : 'May',
		'U' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][6]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][6] : 'June',
		'L' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][7]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][7] : 'July',
		'G' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][8]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][8] : 'August',
		'S' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][9]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][9] : 'September',
		'O' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][10]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][10] : 'October',
		'N' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][11]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][11] : 'November',
		'D' => isset($user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][12]) ? $user->lang['CAL_CALENDAR']['CAL_LONG_MONTH'][12] : 'December',
	);
}
...
{
	$parts = preg_split("[\s|\:|\-]", $t . ' ' .  $d);
	$hour  = isset($parts[0]) ? $parts[0] : '';
	$min   = isset($parts[1]) ? $parts[1] : '';
	$ampm  = isset($parts[2]) ? $parts[2] : '';
	$month = isset($parts[3]) ? $parts[3] : '';
	$day   = isset($parts[4]) ? $parts[4] : '';
	$year  = isset($parts[5]) ? $parts[5] : '';

	if ($hour === '' || $min === '' || $ampm === '' || $month === '' || $day === '' || $year === '')
	{
		return null;
	}
	$hour = (int)$hour;
