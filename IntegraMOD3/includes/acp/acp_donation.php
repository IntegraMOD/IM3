			...
			case 'configuration':
				...
				$display_vars = array(
					...
					'vars'	=> array(
                        ...
                        'donation_default_currency'     => array('lang' => 'DONATION_DEFAULT_CURRENCY',     'validate' => 'string', 'type' => 'select', 'function' => 'donation_item_list', 'params' => array('currency', '{CONFIG_VALUE}', 'acp', $user->lang['CURRENCY_DEFAULT']), 'explain' => true,),
