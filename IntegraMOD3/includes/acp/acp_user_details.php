...
class acp_user_details
{
	...
	function main($id, $mode)
	{
		...
		$select_ary = array(
			...
			array('id' => 'user_fb',  'attribute' => $user->lang['USER_FB'],  'explain' => $user->lang['USER_FB_EXPLAIN'],  'size' => ONE_COL, 'sort_key' => 'u28', 'filter' => true, 'save_id' => 's28'),
			array('id' => 'user_ig',  'attribute' => $user->lang['USER_IG'],  'explain' => $user->lang['USER_IG_EXPLAIN'],  'size' => ONE_COL, 'sort_key' => 'u29', 'filter' => true, 'save_id' => 's29'),
			array('id' => 'user_pt',  'attribute' => $user->lang['USER_PT'],  'explain' => $user->lang['USER_PT_EXPLAIN'],  'size' => ONE_COL, 'sort_key' => 'u30', 'filter' => true, 'save_id' => 's30'),
			array('id' => 'user_twr', 'attribute' => $user->lang['USER_TWR'], 'explain' => $user->lang['USER_TWR_EXPLAIN'], 'size' => ONE_COL, 'sort_key' => 'u31', 'filter' => true, 'save_id' => 's31'),
			array('id' => 'user_skp', 'attribute' => $user->lang['USER_SKP'], 'explain' => $user->lang['USER_SKP_EXPLAIN'], 'size' => ONE_COL, 'sort_key' => 'u32', 'filter' => true, 'save_id' => 's32'),
			array('id' => 'user_tg',  'attribute' => $user->lang['USER_TG'],  'explain' => $user->lang['USER_TG_EXPLAIN'],  'size' => ONE_COL, 'sort_key' => 'u33', 'filter' => true, 'save_id' => 's33'),
			array('id' => 'user_li',  'attribute' => $user->lang['USER_LI'],  'explain' => $user->lang['USER_LI_EXPLAIN'],  'size' => ONE_COL, 'sort_key' => 'u34', 'filter' => true, 'save_id' => 's34'),
			array('id' => 'user_tt',  'attribute' => $user->lang['USER_TT'],  'explain' => $user->lang['USER_TT_EXPLAIN'],  'size' => ONE_COL, 'sort_key' => 'u35', 'filter' => true, 'save_id' => 's35'),
			array('id' => 'user_dc',  'attribute' => $user->lang['USER_DC'],  'explain' => $user->lang['USER_DC_EXPLAIN'],  'size' => ONE_COL, 'sort_key' => 'u36', 'filter' => true, 'save_id' => 's36'),
			...
			case 'display':			
				...
				{						
					...
					$user_vars = array(
						...
						'user_ig'				=> $row['user_ig'],
						'user_pt'				=> $row['user_pt'],
						'user_twr'				=> $row['user_twr'],
						'user_skp'				=> $row['user_skp'],
						'user_tg'				=> $row['user_tg'],
						'user_li'				=> $row['user_li'],
						'user_tt'				=> $row['user_tt'],
						'user_dc'				=> $row['user_dc'],
