...
function view_message($id, $mode, $folder_id, $msg_id, $folder, $message_row)
{
	...
	$template->assign_vars(array(
		...
		'U_FB'			=> ($user_info['user_fb']) ? 'https://www.facebook.com/' . urlencode((string) $user_info['user_fb']) : append_sid("{$phpbb_root_path}memberlist.$phpEx", 'mode=contact&amp;action=fb&amp;u=' . $author_id),
		'U_IG'			=> ($user_info['user_ig']) ? 'https://www.instagram.com/' . urlencode((string) $user_info['user_ig']) : append_sid("{$phpbb_root_path}memberlist.$phpEx", 'mode=contact&amp;action=ig&amp;u=' . $author_id),
		'U_PT'			=> ($user_info['user_pt']) ? 'https://www.pinterest.com/' . urlencode((string) $user_info['user_pt']) : append_sid("{$phpbb_root_path}memberlist.$phpEx", 'mode=contact&amp;action=pt&amp;u=' . $author_id),
		'U_TWR'			=> ($user_info['user_twr']) ? 'https://twitter.com/' . urlencode((string) $user_info['user_twr']) : append_sid("{$phpbb_root_path}memberlist.$phpEx", 'mode=contact&amp;action=twr&amp;u=' . $author_id),
		'U_SKP'			=> ($user_info['user_skp']) ? 'skype:' . urlencode((string) $user_info['user_skp']) . '?chat' : append_sid("{$phpbb_root_path}memberlist.$phpEx", 'mode=contact&amp;action=skp&amp;u=' . $author_id),
		'U_TG'			=> ($user_info['user_tg']) ? 'https://t.me/' . urlencode((string) $user_info['user_tg']) : append_sid("{$phpbb_root_path}memberlist.$phpEx", 'mode=contact&amp;action=tg&amp;u=' . $author_id),
		'U_LI'			=> ($user_info['user_li']) ? 'https://www.linkedin.com/in/' . urlencode((string) $user_info['user_li']) : append_sid("{$phpbb_root_path}memberlist.$phpEx", 'mode=contact&amp;action=li&amp;u=' . $author_id),
		'U_TT'			=> ($user_info['user_tt']) ? 'https://www.tiktok.com/@' . urlencode((string) $user_info['user_tt']) : append_sid("{$phpbb_root_path}memberlist.$phpEx", 'mode=contact&amp;action=tt&amp;u=' . $author_id),
		'U_DC'			=> ($user_info['user_dc']) ? append_sid("{$phpbb_root_path}memberlist.$phpEx", 'mode=contact&amp;action=dc&amp;u=' . $author_id) : '',
