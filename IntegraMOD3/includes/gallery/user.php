	...
	static public function add_user_to_cache(&$user_cache, $row)
	{
		...
		else
		{
			...
			$user_cache[$user_id] = array(
				...
				'fb'			=> ($row['user_fb'] && $auth->acl_get('u_sendim')) ? phpbb_gallery_url::append_sid('phpbb', 'memberlist', "mode=contact&amp;action=fb&amp;u=$user_id") : '',
				'ig'			=> ($row['user_ig'] && $auth->acl_get('u_sendim')) ? phpbb_gallery_url::append_sid('phpbb', 'memberlist', "mode=contact&amp;action=ig&amp;u=$user_id") : '',
				'pt'			=> ($row['user_pt'] && $auth->acl_get('u_sendim')) ? phpbb_gallery_url::append_sid('phpbb', 'memberlist', "mode=contact&amp;action=pt&amp;u=$user_id") : '',
				'twr'			=> ($row['user_twr'] && $auth->acl_get('u_sendim')) ? phpbb_gallery_url::append_sid('phpbb', 'memberlist', "mode=contact&amp;action=twr&amp;u=$user_id") : '',
				'skp'			=> ($row['user_skp'] && $auth->acl_get('u_sendim')) ? phpbb_gallery_url::append_sid('phpbb', 'memberlist', "mode=contact&amp;action=skp&amp;u=$user_id") : '',
				'tg'			=> ($row['user_tg'] && $auth->acl_get('u_sendim')) ? phpbb_gallery_url::append_sid('phpbb', 'memberlist', "mode=contact&amp;action=tg&amp;u=$user_id") : '',
				'li'			=> ($row['user_li'] && $auth->acl_get('u_sendim')) ? phpbb_gallery_url::append_sid('phpbb', 'memberlist', "mode=contact&amp;action=li&amp;u=$user_id") : '',
				'tt'			=> ($row['user_tt'] && $auth->acl_get('u_sendim')) ? phpbb_gallery_url::append_sid('phpbb', 'memberlist', "mode=contact&amp;action=tt&amp;u=$user_id") : '',
				'dc'			=> ($row['user_dc'] && $auth->acl_get('u_sendim')) ? phpbb_gallery_url::append_sid('phpbb', 'memberlist', "mode=contact&amp;action=dc&amp;u=$user_id") : '',
