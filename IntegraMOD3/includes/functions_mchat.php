...
*
*/
if (!function_exists('mchat_session_time'))   {
	function mchat_session_time($time)
	{
		...
		if ($chat_timeout >= 3600)
		{
			...
			$chat_timeout = (int)$chat_timeout - ((int)$hours * 3600);
		...
		if ($minutes)
		{
			...
			$chat_timeout = (int)$chat_timeout - ((int)$minutes * 60);
...
*/
if (!function_exists('mchat_sessions'))   {
...
*/
if (!function_exists('mchat_prune'))   {
...
* @param mixed $mchat_prune_amount set from mchat config entry
*/
if (!function_exists('display_mchat_bbcodes'))   {
