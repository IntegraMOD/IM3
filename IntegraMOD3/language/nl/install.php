...
$lang = array_merge($lang, array(
	...
	'BACKUP_NOTICE'					=> 'We raden je aan een back-up te maken, voor het geval er problemen ontstaan tijdens de update.',
	
	'CATEGORY'					=> 'Categorie',
	'CACHE_STORE'				=> 'Buffertype',
    'CACHE_STORE_EXPLAIN'		=> 'De fysieke locatie waar gegevens worden gecachet. Bestandsgebaseerde cache is eenvoudig en betrouwbaar; memcache/memcached en redis bieden snellere in-memory caching gedeeld tussen processen/servers.',
    'CACHE_FILE'				=> 'Bestand (standaard)',
    ...
    'CACHE_MEMORY'				=> 'Geheugen (alleen proces)',
    'CACHE_NULL'				=> 'Geen cache',
    'CACHE_FILE_EXPLAIN'        => 'Bestandscache slaat gecachte data op schijf op in de map store/. Eenvoudig en betrouwbaar, maar langzamer dan in-memory systemen.',
    'CACHE_MEMCACHE_EXPLAIN'    => 'Memcache (PHP-extensie) biedt snelle, gedistribueerde in-memory caching. Vereist de memcache-extensie en een memcached-server.',
    'CACHE_MEMCACHED_EXPLAIN'   => 'Memcached (PHP-extensie) biedt hoge prestaties voor gedistribueerde in-memory caching. Vereist de memcached-extensie en server.',
    'CACHE_REDIS_EXPLAIN'       => 'Redis is een geavanceerde in-memory data store met optional persistence. Vereist de redis-extensie en een Redis-server.',
    'CACHE_APC_EXPLAIN'         => 'APC/APCu biedt lokaal shared-memory caching binnen PHP-processen. Goed voor single-server opstellingen.',
    'CACHE_WINCACHE_EXPLAIN'    => 'WinCache is een opcode- en datacache beschikbaar op Windows-hosts.',
    'CACHE_XCACHE_EXPLAIN'      => 'XCache is een opcode-cache die ook gebruikersdata in gedeeld geheugen kan opslaan.',
    'CACHE_EACCELERATOR_EXPLAIN'=> 'eAccelerator biedt opcode-caching en gebruikerscache; verouderd maar aanwezig op sommige systemen.',
    'CACHE_MEMORY_EXPLAIN'      => 'Memory-cache slaat data alleen in-process op; snel maar niet gedeeld tussen processen of servers.',
    ...
    'INSTALL_SN'				=> 'Sociaal netwerk installeren',
	...
	'INST_ERR_DB_INVALID_PREFIX'=> 'Het ingevoerde voorvoegsel is ongeldig. Het voorvoegsel moet starten met een letter en mag enkel letters, cijfers en lage/liggende streepjes bevatten.',
	...
	'OVERVIEW_BODY'				=> 'Welkom bij IntegraMOD!<br /><br />IntegraMOD is gebouwd op phpBB. phpBB® is de meest gebruikte open source bulletinboard-oplossing ter wereld. phpBB3 is het nieuwste deel in een pakketlijn die in 2000 is gestart. Net als zijn voorgangers is phpBB3 rijk aan functies, gebruiksvriendelijk en volledig ondersteund door het phpBB-team. phpBB3 verbetert aanzienlijk wat phpBB2 populair maakte, en voegt veelgevraagde functies toe die in eerdere versies niet aanwezig waren. We hopen dat het uw verwachtingen overtreft.<br /><br />KISS Portal&copy; is het originele phpBB3-portaalsysteem. Kiss Portal was de eerste mod geschreven voor phpBB3 (ontwikkeld tijdens de alpha/bèta-fasen van phpBB3)...<br />KISS Portal wordt sinds 2005 continu ontwikkeld en is het enige volledig geïntegreerde phpBB3-portaal dat beschikbaar is. KISS Portal is de grootste mod geschreven voor phpBB3, dus het zal even duren voordat je ermee vertrouwd raakt. Laat je niet afschrikken door de grootte, het is vrij eenvoudig te leren. voor de meeste mensen is het enige dat nodig is een paar beheerdersinstellingen en het is niet nodig om deze opnieuw aan te raken.<br /><br />Dit installatiesysteem begeleidt u bij het installeren van phpBB3 / KISS Portal, updaten naar de nieuwste versie van phpBB3 uit eerdere releases, en converteren naar phpBB3 vanuit een ander discussiebordsysteem (inclusief phpBB2). Voor meer informatie raden we u aan de <a href="../docs/INSTALL.html">de installatiehandleiding</a> te lezen.<br /><br />Om de phpBB3-licentie te lezen of meer te weten te komen over het verkrijgen van ondersteuning en ons standpunt daarover, selecteert u de respectievelijke opties in het zijmenu. Om door te gaan, selecteert u hierboven het juiste tabblad.',
	...
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Vereist</strong> - Je moet minstens PHP-versie 7.0 hebben om phpBB te kunnen installeren. Als <var>veilige modus</var> hieronder weergegeven wordt, werkt de PHP-installatie in die modus. Dit veroorzaakt enkele beperkingen bij afstandsbeheer en gelijkaardige mogelijkheden.',
	...
	'PHP_VERSION_REQD'				=> 'PHP versie >= 7.0',
	'POST_ID'						=> 'Bericht ID',
	...
	'TABLE_PREFIX_EXPLAIN'		=> 'Het tabelvoorvoegsel moet starten met een letter en mag enkel letters, cijfers en en lage/liggende streepjes bevatten.',
