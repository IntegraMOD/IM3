...
$lang = array_merge($lang, array(
	...
	'PORTAL_NAME_EXPLAIN'			=> 'Stelt het standaard label voor de portaal-link in.<br> Laat dit op <strong>Portal</strong> staan om de standaard vertaling uit het taalbestand te gebruiken. Indien gewijzigd, kunnen gelokaliseerde namen worden ingevoerd voor elke geïnstalleerde taal.',
	'FORUM_NAME'					=> 'Forumnaam',
	'FORUM_NAME_EXPLAIN'			=> 'Stelt het standaard label voor de forum-link in.<br> Laat dit op <strong>Forum</strong> staan om de standaard vertaling uit het taalbestand te gebruiken. Indien gewijzigd, kunnen gelokaliseerde namen worden ingevoerd voor elke geïnstalleerde taal.',
	'LOCALIZED_NAMES'				=> 'Gelokaliseerde namen',
	'PORTAL_NAME_LANG'				=> 'Portalnaam - %s',
	'FORUM_NAME_LANG'				=> 'Forumnaam - %s',
...
$lang = array_merge($lang, array(
    ...
    'SERVER_PORT_EXPLAIN'		=> 'De poort waarop uw server draait, meestal 80 voor HTTP en 443 voor HTTPS. Wijzig dit alleen als deze anders is.',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED'			=> 'Zelfondertekende SSL-certificaten toestaan',
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Sta verbindingen toe met de Jabber-server via een zelfondertekend SSL-certificaat.<em><strong>Waarschuwing:</strong> Het toestaan van zelfondertekende SSL-certificaten kan beveiligingsrisico’s veroorzaken.</em>',
	'JAB_VERIFY_PEER'				=> 'SSL-certificaat verifiëren',
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Vereist verificatie van het SSL-certificaat dat door de Jabber-server wordt gebruikt.<em><strong>Waarschuwing:</strong> Verbinding maken met niet-geverifieerde SSL-certificaten kan beveiligingsrisico’s veroorzaken.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Jabber-peernaam verifiëren',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Vereist verificatie van de peernaam voor Jabber-servers die SSL/TLS-verbindingen gebruiken.<em><strong>Waarschuwing:</strong> Verbinding maken met niet-geverifieerde peers kan beveiligingsrisico’s veroorzaken.</em>',
	));
	
// phpBB Digest MOD - Addition begin -------------------------------------------------------
$lang = array_merge($lang, array(
    'DIGEST_ALL'                                => 'Alle',
    'DIGEST_ALL_ALLOWED_FORUMS'                 => 'Alle toegestane forums',
    'DIGEST_ALL_SUBSCRIBED'                     => 'Alle in aanmerking komende leden zijn geabonneerd',
    'DIGEST_ALL_UNSUBSCRIBED'                   => 'Alle in aanmerking komende leden zijn afgemeld',
    'DIGEST_BALANCE_LOAD'                       => 'Belasting balanceren',
    'DIGEST_BLOCK_IMAGES'                       => 'Afbeeldingen blokkeren',
    'DIGEST_BLOCK_IMAGES_EXPLAIN'               => 'Voorkomt dat afbeeldingen in samenvattingen verschijnen, inclusief afbeeldingen als bijlagen. Als bandbreedte een probleem is, wil je deze functie wellicht inschakelen.',
    'DIGEST_CHANGE_SUBSCRIPTION'                => 'Abonnement wijzigen',
    'DIGEST_CURRENT_VERSION_INFO'               => 'Je gebruikt versie <strong>%s</strong>.',
    'DIGEST_CUSTOM_STYLESHEET_PATH'             => 'Aangepast stylesheet-pad',
    'DIGEST_CUSTOM_STYLESHEET_PATH_EXPLAIN'     => 'Deze instelling is alleen van toepassing als het vakje "Aangepast stylesheet inschakelen" is aangevinkt. Als dit is ingeschakeld, wordt dit stylesheet toegepast op alle HTML-samenvattingen. Het pad moet een relatief pad zijn vanaf je phpBB styles-map en moet zich normaal gesproken in de submap theme bevinden. Let op: je bent zelf verantwoordelijk voor het maken van dit stylesheet en het plaatsen ervan in een bestand met de hier ingevoerde naam op de juiste locatie op je server. Voorbeeld: prosilver/theme/digest_stylesheet.css. Klik <a href="http://www.w3schools.com/css/">hier</a> voor informatie over het maken van stylesheets.',
    'DIGEST_COLLAPSE'                           => 'Inklappen',
    'DIGEST_DEFAULT'                            => 'Abonneren met standaardinstellingen',
    'DIGEST_ENABLED'                            => 'Samenvattingen inschakelen',
    'DIGEST_ENABLED_EXPLAIN'                    => 'Als je samenvattingen uitschakelt, verdwijnt de interface in het Gebruikerspaneel door de modulecategorie uit te schakelen. Bovendien worden er geen samenvattingen meer verzonden. Alle samenvattingsinstellingen van gebruikers blijven echter behouden.',
    'DIGEST_ENABLE_AUTO_SUBSCRIPTIONS'          => 'Automatische abonnementen inschakelen',
    'DIGEST_ENABLE_AUTO_SUBSCRIPTIONS_EXPLAIN'  => 'Selecteer Ja als je wilt dat nieuwe gebruikers automatisch samenvattingen ontvangen. De standaardinstellingen van het forum voor samenvattingen worden dan automatisch gebruikt. (Deze worden ingesteld in de Standaard gebruikersinstellingen van de samenvatting). Het inschakelen van deze optie zal <em>geen</em> abonnementen aanmaken voor momenteel niet-geabonneerde gebruikers of voor nieuwe leden die er tijdens de registratie voor hebben gekozen geen samenvatting te ontvangen. Je kunt deze individueel instellen via de functie Abonnees bewerken, of globaal met de optie Massa abonneren/afmelden.',
    'DIGEST_ENABLE_CUSTOM_STYLESHEET'           => 'Aangepast stylesheet inschakelen',
    'DIGEST_ENABLE_CUSTOM_STYLESHEET_EXPLAIN'   => 'Indien niet ingeschakeld, wordt het standaard stylesheet voor de geselecteerde stijl in het profiel van de gebruiker toegepast op de HTML-versies van hun samenvattingen.',
    'DIGEST_ENABLE_LOG'                         => 'Schrijf alle samenvattingsacties naar het beheerderslogboek',
    'DIGEST_ENABLE_LOG_EXPLAIN'                 => "Indien Ja, worden alle acties met betrekking tot de samenvattingen naar het beheerderslogboek geschreven (te vinden op het tabblad Onderhoud). Dit is handig voor het oplossen van problemen met samenvattingen, omdat het aangeeft wat het programma mail_digests.$phpEx heeft gedaan en wanneer. Dit zal echter snel leiden tot een erg lang beheerderslogboek, aangezien er elk uur minstens twee regels naar het logboek worden geschreven.",
    'DIGEST_ENABLE_SUBSCRIBE_UNSUBSCRIBE'       => 'Massa abonneren of afmelden inschakelen',
    'DIGEST_ENABLE_SUBSCRIBE_UNSUBSCRIBE_EXPLAIN' => 'Als je ja selecteert, zal de massa abonneren- of afmelden-actie worden uitgevoerd wanneer je op Bevestigen drukt. Schakel dit met zorg in!',
    'DIGEST_EXCLUDE_FORUMS'                     => 'Deze forums altijd uitsluiten',
    'DIGEST_EXCLUDE_FORUMS_EXPLAIN'             => 'Voer de forum_ids in van forums die nooit in een samenvatting mogen verschijnen. Scheid de forum_ids met komma’s. Indien ingesteld op 0, hoeven er geen forums te worden uitgesloten. Om de forum_ids te achterhalen, bekijk je tijdens het bladeren in een forum de parameter "f" in de URL-balk. Dit is het forum_id. Voorbeeld: http://www.example.com/phpBB3/viewforum.php?f=1. Gebruik geen forum_ids die overeenkomen met categorieën. <i>Deze instelling wordt genegeerd als een abonnee alleen om gevolgde onderwerpen vraagt.</i>',
    'DIGEST_EXPAND'                             => 'Uitklappen',
    'DIGEST_FROM_EMAIL_ADDRESS'                 => 'E-mailadres afzender',
    'DIGEST_FROM_EMAIL_ADDRESS_EXPLAIN'         => 'Wanneer gebruikers een samenvatting ontvangen, verschijnt dit e-mailadres in het VAN (FROM)-veld. Als dit leeg wordt gelaten, wordt standaard het e-mailadres voor contact van je forum gebruikt. Wees voorzichtig met het gebruiken van een e-mailadres met een ander domein dan dat waarop de samenvatting wordt gehost, aangezien je mailserver of de e-mailserver van de gebruiker de e-mail als spam kan interpreteren.',
    'DIGEST_FROM_EMAIL_NAME'                    => 'Naam afzender e-mail',
    'DIGEST_FROM_EMAIL_NAME_EXPLAIN'            => 'Dit is de platte tekst VAN-naam die in de e-mailclient zal verschijnen. Als dit leeg wordt gelaten, identificeert het zich als een robot voor je forum.',
    'DIGEST_HAS_UNSUBSCRIBED'                   => 'Heeft zich afgemeld',
    'DIGEST_HOUR_SENT'                          => 'Uur van verzending<br />(gebaseerd op %s GMT)',
    'DIGEST_IGNORE'                             => 'Globale acties negeren',
    'DIGEST_INCLUDE_ADMINS'                     => 'Beheerders opnemen',
    'DIGEST_INCLUDE_ADMINS_EXPLAIN'             => 'Dit zal beheerders abonneren of afmelden in aanvulling op normale gebruikers.',
    'DIGEST_INCLUDE_FORUMS'                     => 'Deze forums altijd opnemen',
    'DIGEST_INCLUDE_FORUMS_EXPLAIN'             => 'Voer de forum_ids in van forums die in een samenvatting moeten verschijnen. Scheid de forum_ids met komma’s. Indien ingesteld op 0, hoeven er geen forums verplicht te worden opgenomen. Om de forum_ids te achterhalen, bekijk je tijdens het bladeren in een forum de parameter "f" in de URL-balk. Dit is het forum_id. Voorbeeld: http://www.example.com/phpBB3/viewforum.php?f=1. Gebruik geen forum_ids die overeenkomen met categorieën. <i>Deze instelling wordt genegeerd als een abonnee alleen om gevolgde onderwerpen vraagt.</i>',
    'DIGEST_KEY_VALUE'                          => 'Sleutelwaarde',
    'DIGEST_KEY_VALUE_EXPLAIN'                  => 'Houd er rekening mee dat dit platte tekst is en niet versleuteld. Houd het simpel. Vermijd meerdere woorden, spaties en speciale tekens. Voorbeeld: qwertyuiop',
    'DIGEST_LAST_SENT'                          => 'Samenvatting laatst verzonden',
    'DIGEST_LATEST_VERSION_INFO'                => 'De nieuwst beschikbare versie is <strong>%s</strong>.',
    'DIGEST_LIST_USER'                          => '1 Gebruiker',
    'DIGEST_LIST_USERS'                         => '%s Gebruikers',
    'DIGEST_MAX_ITEMS'                          => 'Maximaal toegestane berichten in een samenvatting',
    'DIGEST_MAX_ITEMS_EXPLAIN'                  => 'Om prestatieredenen kan het nodig zijn om een absolute limiet in te stellen voor het aantal berichten in een enkele samenvatting. Als je dit instelt op 0 (nul), is de grootte van de samenvatting onbeperkt. Je kunt elk geheel getal in dit veld gebruiken. Let op dat een samenvatting wordt beperkt door het aantal berichten in het gevraagde type samenvatting (dagelijks, wekelijks of maandelijks) en door andere criteria die de gebruiker kan instellen.',
    'DIGEST_NEVER_VISITED'                      => 'Nooit bezocht',
    'DIGEST_NEW_SUBSCRIBERS'                    => ' %s gebruikers zijn geabonneerd op het ontvangen van samenvattingen: %s.',
    'DIGEST_NONSUBSCRIBER'                      => 'Niet-abonnee',
    'DIGEST_NO_DIGESTS_SENT'                    => 'Geen samenvattingen verzonden',
    'DIGEST_NO_MASS_ACTION'                     => 'Er is geen actie ondernomen, omdat je de functie niet hebt ingeschakeld',
    'DIGEST_NOTIFY_ON_MASS_SUBSCRIBE'           => 'Lid per e-mail op de hoogte stellen van de actie als deze gevolgen voor hen heeft',
    'DIGEST_OVERRIDE_QUEUE'                     => 'Elke samenvatting afzonderlijk verzenden',
    'DIGEST_OVERRIDE_QUEUE_EXPLAIN'             => 'Standaard worden samenvattingen in batches verzonden als de pakketgrootte van je e-mail groter is dan nul. Als je merkt dat niet alle samenvattingen binnen een uur worden verzonden, kun je dit op ja zetten. Indien ja, wordt een samenvatting verzonden voordat de volgende wordt samengesteld. Dit zal er waarschijnlijk toe leiden dat het samenvatting-mailprogramma er langer over doet om uit te voeren en meer CPU gebruikt, maar het is wel betrouwbaarder.',
    'DIGEST_RANDOM_HOUR'                        => 'Willekeurig uur',
    'DIGEST_REBALANCED'                         => 'Tijdens deze herbalancering is het verzenduur van in totaal %s samenvatting-abonnees gewijzigd.',
    'DIGEST_REFRESH'                            => 'Vernieuwen',
    'DIGEST_REGISTRATION_FIELD'                 => 'Gebruikers toestaan zich bij registratie te abonneren op samenvattingen',
    'DIGEST_REGISTRATION_FIELD_EXPLAIN'         => 'Indien ingeschakeld, hebben gebruikers bij de registratie de optie om samenvattingen te ontvangen met de standaardinstellingen van het forum. Deze optie verschijnt niet als automatische abonnementen zijn ingeschakeld.',
    'DIGEST_REPLY_TO_EMAIL_ADDRESS'             => 'Antwoord-naar (Reply-To) e-mailadres',
    'DIGEST_REPLY_TO_EMAIL_ADDRESS_EXPLAIN'     => 'Wanneer gebruikers een samenvatting ontvangen, verschijnt dit e-mailadres in het ANTWOORDEN AAN (REPLY TO)-veld. Als dit leeg wordt gelaten, wordt standaard het e-mailadres voor contact van je forum gebruikt. Wees voorzichtig met het gebruiken van een e-mailadres met een ander domein dan dat waarop de samenvatting wordt gehost, aangezien je mailserver of de e-mailserver van de gebruiker de e-mail als spam kan interpreteren.',
    'DIGEST_REQUIRE_KEY'                        => 'Sleutelparameter vereisen om mail_digests.php uit te voeren',
    'DIGEST_REQUIRE_KEY_EXPLAIN'                => "Dit is een extra veiligheidsmaatregel die je kunt inschakelen. Indien ingeschakeld, zal mail_digests.$phpEx alleen samenvattingen verzenden als de sleutelparameter is opgegeven en de sleutel overeenkomt met de sleutelwaarde die je hieronder definieert. Je moet je cronjob of het equivalent daarvan programmeren om de sleutel te gebruiken. Voorbeeld van de resulterende URL: http://www.example.com/phpBB3/mail_digests.$phpEx?key=qwertyuiop",
    'DIGEST_SEARCH_FOR_MEMBER'                  => 'Lid zoeken',
    'DIGEST_SEARCH_FOR_MEMBER_EXPLAIN'          => 'Voer de volledige of gedeeltelijke naam van het lid in dat je zoekt en druk op Vernieuwen. Laat leeg om alle leden te zien. Zoekopdrachten zijn hoofdlettergevoelig en vinden leden op basis van het huidige gebruikersfilter.',
    'DIGEST_SELECT_FORUMS_ADMIN_EXPLAIN'        => 'De lijst met forums bevat alleen de forums die deze gebruiker mag lezen. Als je deze gebruiker toegang wilt geven tot extra forums die hier niet worden getoond, breid dan hun forum- of groepsrechten uit. Let op: hoewel je de forums die in hun samenvatting verschijnen nauwkeurig kunt afstellen, wordt er geen samenvatting verzonden als hun samenvattingstype "Geen" is.',
    'DIGEST_SHOW'                               => 'Weergeven',
    'DIGEST_SHOW_OUTPUT'                        => 'Uitvoer weergeven',
    'DIGEST_SHOW_OUTPUT_EXPLAIN'                => "Indien ja, worden er bij het uitvoeren van mail_digests.$phpEx berichten op het scherm geschreven die aangeven wie een samenvatting heeft ontvangen en wanneer. Meestal worden deze berichten niet gezien omdat het programma automatisch wordt uitgevoerd. Het wordt aangeraden dit op Ja in te stellen totdat je het proces hebt geautomatiseerd, en het daarna op Nee te zetten.",
    'DIGEST_SHOW_EMAIL'                         => 'E-mailadres weergeven',
    'DIGEST_SHOW_EMAIL_EXPLAIN'                 => "Als 'Uitvoer weergeven' is ingeschakeld en 'E-mailadres weergeven' ook is ingeschakeld, wordt het e-mailadres van de abonnee getoond in de uitvoer op het scherm. Het wordt aangeraden dit na het oplossen van problemen <em>direct</em> uit te schakelen, omdat dit een potentieel beveiligingsrisico met zich meebrengt.",
    'DIGEST_SOCKET_FUNCTIONS_DISABLED'          => 'Socket-functies zijn momenteel uitgeschakelen.',
    'DIGEST_SORT_ORDER'                         => 'Sorteervolgorde',
    'DIGEST_STOPPED_SUBSCRIBING'                => 'Gestopt met abonneren',
    'DIGEST_SUBSCRIBE'                          => 'Abonneren met standaardwaarden',
    'DIGEST_SUBSCRIBE_SUBJECT'                  => 'Je bent geabonneerd op het ontvangen van e-mailsamenvattingen',
    'DIGEST_SUBSCRIBE_ALL'                      => 'Iedereen abonneren',
    'DIGEST_SUBSCRIBE_ALL_EXPLAIN'              => 'Als je nee selecteert, wordt iedereen afgemeld.',
    'DIGEST_SUBSCRIBE_LITERAL'                  => 'Abonneren',
    'DIGEST_SUBSCRIBED'                         => 'Geabonneerd',
    'DIGEST_SUBSCRIBER'                         => 'Abonnee',
    'DIGEST_SUBSCRIBERS'                        => 'Abonnees',
    'DIGEST_SUBSCRIBER_DETAIL'                  => 'Details van samenvatting-abonnee',
    'DIGEST_TIME_ZONE'                          => 'Tijdzone',
    'DIGEST_TIME_ZONE_EXPLAIN'                  => 'De functies abonnees bewerken en belasting balanceren tonen het uur waarop samenvattingen per e-mail worden verzonden. Als je hier een specifieke tijdzone instelt, wordt het verzenduur vertaald naar de tijdzone die je hier instelt. In eerste instantie is dit ingesteld op de tijdzone van het forum. Waarden moeten gehele getallen zijn van -12 tot 12, waarbij 0 GMT is.',
    'DIGEST_UNKNOWN'                            => 'Onbekend',
    'DIGEST_UNSUBSCRIBE'                        => 'Afmelden',
    'DIGEST_UNSUBSCRIBE_MARKED'                 => 'Gemarkeerde afmelden',
    'DIGEST_UNSUBSCRIBE_SUBJECT'                => 'Je bent afgemeld voor het ontvangen van e-mailsamenvattingen',
    'DIGEST_UNSUBSCRIBED'                       => 'Heeft zich nooit geabonneerd',
    'DIGEST_USER_DIGEST_ATTACHMENTS'            => 'Standaard voor bijlagen weergeven',
    'DIGEST_USER_DIGEST_BLOCK_IMAGES'           => 'Standaard for afbeeldingen blokkeren',
    'DIGEST_USER_DIGEST_CHECK_ALL_FORUMS'       => 'Wil je standaard alle forums selecteren',
    'DIGEST_USER_DIGEST_FILTER_TYPE'            => 'Standaardtype berichten in samenvattingen',
    'DIGEST_USER_DIGEST_MAX_DISPLAY_WORDS'      => 'Standaard maximaal aantal woorden dat in een bericht wordt weergegeven',
    'DIGEST_USER_DIGEST_MAX_DISPLAY_WORDS_EXPLAIN' => 'Stel in op -1 om standaard de volledige tekst van het bericht te tonen. Een instelling van nul (0) betekent dat de gebruiker standaard helemaal geen berichttekst te zien krijgt.',
    'DIGEST_USER_DIGEST_MAX_POSTS'              => 'Standaard maximaal aantal berichten in een samenvatting',
    'DIGEST_USER_DIGEST_MAX_POSTS_EXPLAIN'      => 'Indien ingesteld op nul, is elk aantal berichten toegestaan. Houd er rekening mee dat een samenvatting nooit meer berichten zal bevatten dan je instelling voor het maximaal aantal toegestane berichten in een samenvatting (hierboven).',
    'DIGEST_USER_DIGEST_MIN_POSTS'              => 'Standaard minimaal aantal woorden dat een bericht moet hebben om in een samenvatting te verschijnen',
    'DIGEST_USER_DIGEST_MIN_POSTS_EXPLAIN'      => 'Indien ingesteld op nul, zijn berichten met elk aantal woorden per bericht toegestaan.',
    'DIGEST_USER_DIGEST_NEW_POSTS_ONLY'         => 'Standaard voor alleen nieuwe berichten weergeven',
    'DIGEST_USER_DIGEST_PM_MARK_READ'           => 'Standaard voor privéberichten als gelezen markeren wanneer ze in de samenvatting verschijnen',
    'DIGEST_USER_DIGEST_RANDOM_HOUR'            => 'Willekeurig uur',
    'DIGEST_USER_DIGEST_REGISTRATION'           => 'Standaard voor of een gebruiker zich bij registratie abonneert op samenvattingen',
    'DIGEST_USER_DIGEST_RESET_LASTVISIT'        => 'Standaard voor datum van laatste bezoek resetten wanneer een samenvatting is verzonden',
    'DIGEST_USER_DIGEST_SEND_HOUR_GMT'          => 'Standaard verzenduur (Universele Tijd)',
    'DIGEST_USER_DIGEST_SEND_ON_NO_POSTS'       => 'Standaard voor een samenvatting sturen als er geen nieuwe berichten zijn',
    'DIGEST_USER_DIGEST_SHOW_FOES'              => 'Standaard voor berichten van vijanden van de gebruiker verwijderen',
    'DIGEST_USER_DIGEST_SHOW_MINE'              => 'Standaard voor eigen berichten van de gebruiker verwijderen',
    'DIGEST_USER_DIGEST_SHOW_PMS'               => 'Standaard voor ongelezen privéberichten van de gebruiker toevoegen',
    'DIGEST_USER_DIGEST_SORT_ORDER'             => 'Standaard sorteervolgorde berichten',
    'DIGEST_USER_DIGEST_STYLE'                  => 'Standaard samenvattingsstijl',
    'DIGEST_USER_DIGEST_TYPE'                   => 'Standaard type gebruikerssamenvatting',
    'DIGEST_USER_DIGEST_TOC'                    => 'Standaard voor inhoudsopgave',
    'DIGEST_USER_TYPE'                          => 'Gebruikerstype',
    'DIGEST_USERS_PER_PAGE'                     => 'Abonnees per pagina',
    'DIGEST_USERS_PER_PAGE_EXPLAIN'             => 'Dit bepaalt hoeveel samenvatting-abonnees een beheerder per pagina ziet wanneer deze de optie abonnees bewerken selecteert. Op basis van je max_input_vars moet je dit beperken tot ' . floor((ini_get('max_input_vars') - 100) / 24) . ' abonnenes per pagina of minder. Anders moet je max_input_vars wellicht verhogen in je php.ini-bestand om te voorkomen dat de functie mislukt.',
    'DIGEST_VERSION_NOT_UP_TO_DATE'             => 'Deze versie van phpBB Digests is niet up-to-date. Updates zijn beschikbaar op de <a href="%s">Digests website</a>.',
    'DIGEST_VERSION_UP_TO_DATE'                 => 'Deze versie van phpBB Digests is up-to-date, geen update beschikbaar.',
    'DIGEST_WEEKLY_DIGEST_DAY'                  => 'Selecteer de dag van de week voor het verzenden van wekelijkse samenvattingen',
    'DIGEST_WITH_SELECTED'                      => 'Met geselecteerde',
...
// Mod links in header
$lang = array_merge($lang, array(
    'MOD_LINKS'                 => 'Kies links om weer te geven in de navigatie',
    'SHOW_ACTIVITY'             => 'Sociaal netwerk',
    'SHOW_ACTIVITY_EXPLAIN'     => 'Toon link naar de Activiteitenpagina in de navigatie.',    
    'SHOW_BLOG'                 => 'Blog',
    'SHOW_BLOG_EXPLAIN'         => 'Toon link naar het Blog in de navigatie.',
    'SHOW_KB'                   => 'Kennisbank',
    'SHOW_KB_EXPLAIN'           => 'Toon link naar de Kennisbank in de navigatie.',
    'SHOW_CAL'                  => 'Kalender',
    'SHOW_CAL_EXPLAIN'          => 'Toon link naar de Onderwerpskalender in de navigatie',
    'SHOW_GALL'                 => 'Galerij',
    'SHOW_GALL_EXPLAIN'         => 'Toon link naar de Galerij in de navigatie',
    'SHOW_CHT'                  => 'Chat',
    'SHOW_CHT_EXPLAIN'          => 'Toon link naar de Chat in de header.',
    'SHOW_DLS'                  => 'Downloads',
    'SHOW_DLS_EXPLAIN'          => 'Toon link naar Downloads in de navigatie.',
    'SHOW_FAQ'                  => 'FAQ',
    'SHOW_FAQ_EXPLAIN'          => 'Toon link naar de FAQ in de navigatie.',
    'SHOW_MEM'                  => 'Ledenlijst',
    'SHOW_MEM_EXPLAIN'          => 'Toon link naar de Ledenlijst in de navigatie.',
    'SHOW_NOTES'                => 'Notities',
    'SHOW_NOTES_EXPLAIN'        => 'Toon link naar Notities in de navigatie.',
    'SHOW_MEETING'              => 'Vergaderingen',
    'SHOW_MEETING_EXPLAIN'      => 'Toon link naar Vergaderingen in de navigatie.',    
    'SHOW_CONTACT'              => 'Contact',
    'SHOW_CONTACT_EXPLAIN'      => 'Toon link naar Contact in de navigatie.',    
    'SHOW_RULES'                => 'Reglement',
    'SHOW_RULES_EXPLAIN'        => 'Toon link naar het Reglement in de navigatie',
));
