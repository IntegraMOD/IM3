...
$lang = array_merge($lang, array(
	...
	'LOG_KB_ROLE_ADD'		=> '<strong>Ajout d’un rôle de la base de connaissances</strong><br />» %s',
	'LOG_KB_ROLE_EDIT'		=> '<strong>Édition d’un rôle de la base de connaissances</strong><br />» %s',
	'LOG_KB_ROLE_REMOVED'	=> '<strong>Suppression d’un rôle de la base de connaissances</strong><br />» %s',
	...
	// Missing variables
	'ACP_CALENDAR'									=> 'Calendrier',
	'ACP_CALENDAR_MOD'								=> 'Calendrier',
	'ACP_CALENDAR_SETTINGS'							=> 'Paramètres du calendrier',
	'ACP_CALENDAR_USERS'							=> 'Paramètres utilisateur du calendrier',
	'ACP_CAT_DIGESTS'								=> 'Résumés',
	'ACP_CAT_FILES'									=> 'Fichiers',
	'ACP_IMOD'										=> 'IntegraMOD',
	'ACP_CAT_KB'									=> 'Base de connaissances',
	'ACP_FILE_BACKUP'								=> 'Sauvegarde des fichiers',
	'SORT_EMAIL'									=> 'E-mail',
	'LOG_CONFIG_DIGEST_BAD_DATE_PARAM'				=> '<strong>Exception du résumé : Un mauvais paramètre URL de date "%s" a été rencontré. Celui-ci doit être exprimé dans le format ISO-8601, soit AAAA-MM-JJ.</strong>',
	'LOG_CONFIG_DIGEST_BAD_DIGEST_TYPE'				=> '<strong>Exception du résumé : Un type de résumé incorrect "%s" a été rencontré</strong>',
	'LOG_CONFIG_DIGEST_BAD_HOUR_PARAM'				=> '<strong>Exception du résumé : Un mauvais paramètre URL d\'heure "%s" a été rencontré. Il doit s\'agir d\'un nombre entier compris entre 0 et 23.</strong>',
	'LOG_CONFIG_DIGEST_BAD_KEY_VALUE'				=> '<strong>Lors de l\'exécution de mail_digests.php, le paramètre "key" fourni avait une valeur non valide de "%s". Programme terminé.</strong>',
	'LOG_CONFIG_DIGEST_BOARD_DISABLED'				=> '<strong>Une exécution de mail_digests.php a été tentée, mais a été arrêtée car le forum est désactivé.</strong>',
	'LOG_CONFIG_DIGEST_EDIT_SUBSCRIBERS'			=> '<strong>Abonnés aux résumés modifiés</strong>',
	'LOG_CONFIG_DIGEST_GENERAL'						=> '<strong>Paramètres généraux des résumés altérés</strong>',
	'LOG_CONFIG_DIGEST_LOG'							=> '<strong>Paramètres de journalisation des résumés altérés</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_BAD'				=> '<strong>Impossible d\'envoyer un résumé à %s (%s)</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_BAD_NO_EMAIL'		=> '<strong>Impossible d\'envoyer un résumé à %s</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_GOOD'				=> '<strong>Un résumé a été %s envoyé à %s (%s) contenant %s messages et %s messages privés</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_GOOD_NO_EMAIL'		=> '<strong>Un résumé a été %s envoyé à %s contenant %s messages et %s messages privés</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_NONE'				=> '<strong>AUCUN résumé n\'a été envoyé à %s (%s) car les filtres et les préférences de l\'utilisateur signifient qu\'il n\'y avait rien à envoyer</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_NONE_NO_EMAIL'		=> '<strong>AUCUN résumé n\'a été envoyé à %s car les filtres et les préférences de l\'utilisateur signifient qu\'il n\'y avait rien à envoyer</strong>',
	'LOG_CONFIG_DIGEST_LOG_EMAILED'					=> '<strong>Tous les résumés pour cette heure ont été envoyés par e-mail</strong>',
	'LOG_CONFIG_DIGEST_LOG_START'					=> '<strong>Lancement de mail_digests.php</strong>',
	'LOG_CONFIG_DIGEST_LOG_END'						=> '<strong>Fin de mail_digests.php</strong>',
	'LOG_CONFIG_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE'	=> '<strong>Abonnement ou désabonnement de masse aux résumés exécuté</strong>',
	'LOG_CONFIG_DIGEST_NEED_TWO_PARAMS'				=> '<strong>Exception du résumé : La date et l\'heure doivent être spécifiées ensemble lors d\'une exécution irrégulière de mail_digests.php. Seul un des deux paramètres a été fourni.</strong>',
	'LOG_CONFIG_DIGEST_NO_BOOKMARKS'				=> '<strong>Exception du résumé : Un résumé sur les sujets favoris a été demandé pour "%s", mais l\'utilisateur n\'a pas de sujets favoris</strong>',
	'LOG_CONFIG_DIGEST_NO_ALLOWED_FORUMS'			=> '<strong>Exception du résumé : L\'utilisateur "%s" ne peut accéder à aucun forum : aucun résumé ne peut être créé.</strong>',
	'LOG_CONFIG_DIGEST_NOT_ENABLED'					=> '<strong>Les résumés ne sont pas activés pour le moment; aucun résumé n\'a été envoyé pour cette heure.</strong>',
	'LOG_CONFIG_DIGEST_SEND_MASS_EMAIL_ERROR'		=> '<strong>Impossible d\'envoyer l\'email d\'abonnement/désabonnement de masse du résumé à %s</strong>',
	'LOG_CONFIG_DIGEST_USER_DEFAULTS'				=> '<strong>Paramètres par défaut des utilisateurs des résumés altérés</strong>',
	'LOG_CONFIG_DIGEST_WRITE_LOG_ENTRY_ERROR'		=> '<strong>Exception du résumé : write_log_entry appelée avec un type non géré de "%s"</strong>',
	'LOG_FILE_BACKUP'								=> '<strong>Sauvegarde des fichiers</strong><br />',
	'ACP_DIGEST_SETTINGS'							=> 'Paramètres des résumés',
	'ACP_DIGEST_GENERAL_SETTINGS'					=> 'Paramètres généraux',
	'ACP_DIGEST_GENERAL_SETTINGS_EXPLAIN'			=> 'Ce sont les paramètres généraux applicables aux résumés.',
	'ACP_DIGEST_USER_DEFAULT_SETTINGS'				=> 'Paramètres par défaut de l\'utilisateur',
	'ACP_DIGEST_USER_DEFAULT_SETTINGS_EXPLAIN'		=> 'Ces paramètres permettent à l\'administrateur de configurer les réglages par défaut qu\'un utilisateur voit quand il s\'inscrit aux résumés.',
	'ACP_DIGEST_EDIT_SUBSCRIBERS'					=> 'Éditer les abonnés',
	'ACP_DIGEST_EDIT_SUBSCRIBERS_EXPLAIN'			=> 'Cette interface permet de voir qui reçoit ou non les résumés. Vous pouvez ajouter des inscriptions de manière sélective, désabonner certains membres et ajuster tous les détails relatifs à chaque membre. Vous pouvez également inscrire avec les réglages par défaut ou désabonner l\'ensemble des utilisateurs cochés sur cette page.',
	'ACP_DIGEST_BALANCE_LOAD'						=> 'Bilan des charges',
	'ACP_DIGEST_BALANCE_LOAD_EXPLAIN'				=> 'Si beaucoup trop de résumés envoyés durant une certaine heure causent des problèmes de performance, un bilan sur les inscriptions de résumés sera effectué afin qu\'à peu près le même nombre de résumés soit transmis pour chaque heure. Le tableau ci-dessous indique le nombre actuel d\'abonnés de résumés pour chaque heure, basé sur l\'heure du réglage du résumé défini dans les "Paramètres généraux". Cette fonction met à jour les heures d\'envoi minimalement. Des changements ont lieu seulement sur les heures où le nombre d\'abonnés dépasse la charge moyenne, et seulement aussi sur les abonnés qui dépassent la moyenne en ce qui concerne cette heure-ci. <strong>Attention</strong>: des abonnés pourraient être irrités que leurs horaires de réception aient été modifiés.',
	'ACP_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE'			=> 'Abonnement / Désabonnement en masse',
	'ACP_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE_EXPLAIN'	=> 'Cette particularité permet aux administrateurs de proposer l\'abonnement et le désabonnement à la convenance des membres de votre forum d\'un seul coup. Les paramètres par défaut des réglages sont employés pour inscrire divers membres. Si un membre s\'est déjà inscrit aux résumés, lors d\'une inscription générale, sa demande restera en effet appliquée avec ses paramètres respectifs choisis préalablement. Vous ne pouvez pas spécifier les forums dans lesquels ils seront souscrits. Les utilisateurs seront souscrits de n\'importe quel forum dont l\'accès de lecture leur est autorisé. <strong>Attention</strong>: des abonnés pourraient être irrités qu\'ils soient engagés ou désinscrits sans leurs permissions.',
	'LOG_DELETED_CALENDAR_EVENT'					=> '<strong>Événement du calendrier supprimé</strong><br />» %s',
	'LOG_DELETED_TOPIC_EVENT'						=> '<strong>Événement du sujet supprimé</strong><br />» %s',
	'LOG_DELETED_CALENDAR_EVENTS'					=> '<strong>Événements récurrents du calendrier supprimés</strong><br />» %s',
	'LOG_DELETED_TOPIC_EVENTS'						=> '<strong>Événements récurrents du sujet supprimés</strong><br />» %s',
	'LOG_DELETED_CALENDAR_EVENT_INSTANCE'			=> '<strong>Instance récurrente d\'événements du calendrier supprimée</strong><br />» %s',
	'LOG_DELETED_TOPIC_EVENT_INSTANCE'				=> '<strong>Instance récurrente d\'événements de sujet supprimée</strong><br />» %s',
	'LOG_EDITED_CALENDAR_EVENT'						=> '<strong>Événement du calendrier édité</strong><br />» %s',
	'LOG_EDITED_CALENDAR_EVENTS'					=> '<strong>Événements récurrents du calendrier édités</strong><br />» %s',
	'LOG_EDITED_CALENDAR_EVENT_INSTANCE'			=> '<strong>Instance récurrente d\'événements du calendrier éditée</strong><br />» %s',
	'ACP_KB'										=> 'Base de connaissances',
	'KB_NAME'										=> 'Base de connaissances',
	'ACP_KB_PERMISSIONS'							=> 'Permissions des catégories',
	'ACP_KB_ROLES'									=> 'Rôles de la base de connaissances',
	'KB_CONFIG'										=> 'Configuration',
	'TYPES'											=> 'Types d\'articles',
	'CATEGORIES'									=> 'Catégories',
	'ACP_MODS_DATABASE'								=> 'Base de données des MODs',
	'LOG_MOD_DELETE'								=> '<strong>MOD(s) supprimé(s) dans la base de données des MODs</strong>',
	'LOG_MOD_ADDED'									=> '<strong>MOD ajouté dans la base de données des MODs</strong>',
	'LOG_MOD_UPDATED'								=> '<strong>MOD mis à jour dans la base de données des MODs</strong>',
	'LOG_MCHAT_TABLE_PRUNED'						=> 'La table mChat a été purgée',
	'ACP_USER_MCHAT'								=> 'Paramètres mChat',
	'LOG_DELETED_MCHAT'								=> '<strong>Message mChat supprimé</strong><br />» %1$s',
	'LOG_EDITED_MCHAT'								=> '<strong>Message mChat édité</strong><br />» %1$s',
));
