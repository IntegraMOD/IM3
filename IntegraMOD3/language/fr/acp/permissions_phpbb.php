...
$lang = array_merge($lang, array(
	...
	// Missing variables
	'acl_u_activity'			=> array('lang' => 'Peut voir le lien vers la page Activité dans la navigation', 'cat' => 'misc'),
	'acl_u_blog'				=> array('lang' => 'Peut voir les liens vers les Blogs dans la navigation', 'cat' => 'misc'),
	'acl_u_kb'					=> array('lang' => 'Peut voir le lien vers la Base de connaissances dans la navigation', 'cat' => 'misc'),
	'acl_u_cal'					=> array('lang' => 'Peut voir le lien vers le Calendrier', 'cat' => 'misc'),
	'acl_u_gall'				=> array('lang' => 'Peut voir le lien vers la Galerie dans la navigation', 'cat' => 'misc'),
	'acl_u_cht'					=> array('lang' => 'Peut voir le lien vers le Chat dans la navigation', 'cat' => 'misc'),
	'acl_u_dls'					=> array('lang' => 'Peut voir le lien vers les Téléchargements', 'cat' => 'misc'),
	'acl_u_faq'					=> array('lang' => 'Peut voir le lien vers la FAQ', 'cat' => 'misc'),
	'acl_u_mem'					=> array('lang' => 'Peut voir le lien vers la Liste des membres', 'cat' => 'misc'),
	'acl_u_notes'				=> array('lang' => 'Peut voir le lien vers les Notes', 'cat' => 'misc'),
	'acl_u_meeting'				=> array('lang' => 'Peut éditer les réunions', 'cat' => 'meeting'),
	'acl_u_contact'				=> array('lang' => 'Peut voir le lien vers la page Contact', 'cat' => 'misc'),
	'acl_u_rules'				=> array('lang' => 'Peut voir le lien vers le Règlement', 'cat' => 'misc'),
	'acl_a_ajaxlike_mod'		=> array('lang' => 'Peut gérer les j\'aime', 'cat' => 'misc'),
	'acl_u_view_event'			=> array('lang' => 'Peut voir les événements', 'cat' => 'calendar'),
	'acl_u_new_event'			=> array('lang' => 'Peut publier un nouvel événement', 'cat' => 'calendar'),
	'acl_u_edit_event'			=> array('lang' => 'Peut éditer ses propres événements', 'cat' => 'calendar'),
	'acl_u_delete_event'		=> array('lang' => 'Peut supprimer ses propres événements', 'cat' => 'calendar'),
	'acl_u_allow_index_minical'	=> array('lang' => 'Peut voir le minicalendrier sur la page de l\'index', 'cat' => 'calendar'),
	'acl_m_edit_event'			=> array('lang' => 'Peut éditer les événements d\'autrui', 'cat' => 'calendar'),
	'acl_m_delete_event'		=> array('lang' => 'Peut supprimer les événements d\'autrui', 'cat' => 'calendar'),
	'acl_a_calendar_manage'		=> array('lang' => 'Peut gérer le calendrier', 'cat' => 'calendar'),
	'acl_a_edit_event'			=> array('lang' => 'Peut éditer les événements d\'autrui (admin)', 'cat' => 'calendar'),
	'acl_a_delete_event'		=> array('lang' => 'Peut supprimer les événements d\'autrui (admin)', 'cat' => 'calendar'),
	'acl_a_publish_rss'			=> array('lang' => 'Peut publier les flux RSS du calendrier', 'cat' => 'calendar'),
	'acl_kb_print_article'		=> array('lang' => 'Peut imprimer les articles', 'cat' => 'read'),
	'acl_kb_view_article'		=> array('lang' => 'Peut voir les articles de cette catégorie', 'cat' => 'read'),
	'acl_kb_download'			=> array('lang' => 'Peut télécharger les fichiers joints (BC)', 'cat' => 'read'),
	'acl_kb_report_article'		=> array('lang' => 'Peut rapporter un article', 'cat' => 'read'),
	'acl_kb_rate_article'		=> array('lang' => 'Peut noter un article', 'cat' => 'read'),
	'acl_u_rate_kb'				=> array('lang' => 'Peut noter un article', 'cat' => 'read'),
	'acl_kb_attache_article'	=> array('lang' => 'Peut télécharger des fichiers joints', 'cat' => 'write'),
	'acl_kb_edit_article'		=> array('lang' => 'Peut éditer ses propres articles', 'cat' => 'write'),
	'acl_kb_del_article'		=> array('lang' => 'Peut supprimer ses propres articles', 'cat' => 'write'),
	'acl_kb_add_article'		=> array('lang' => 'Peut ajouter des articles', 'cat' => 'write'),
	'acl_kb_add_article_direct'	=> array('lang' => 'Peut ajouter des articles sans activation', 'cat' => 'write'),
	'acl_kb_edit_all_article'	=> array('lang' => 'Peut éditer tous les articles', 'cat' => 'write'),
	'acl_m_delete_diff_kb'		=> array('lang' => 'Peut supprimer d\'anciennes versions d\'un article', 'cat' => 'kb'),
	'acl_m_restore_kb'			=> array('lang' => 'Peut restaurer d\'anciennes versions d\'un article', 'cat' => 'kb'),
	'acl_m_log_kb'				=> array('lang' => 'Peut voir le journal des articles', 'cat' => 'kb'),
	'acl_m_log_kb_delete'		=> array('lang' => 'Peut supprimer le journal des articles', 'cat' => 'kb'),
	'acl_m_report_kb'			=> array('lang' => 'Peut gérer les articles rapportés', 'cat' => 'kb'),
	'acl_m_activate_kb'			=> array('lang' => 'Peut activer un article', 'cat' => 'kb'),
	'acl_m_edit_kb'				=> array('lang' => 'Peut éditer les articles (mod)', 'cat' => 'kb'),
	'acl_m_del_kb'				=> array('lang' => 'Peut supprimer les articles (mod)', 'cat' => 'kb'),
	'acl_m_ch_poster'			=> array('lang' => 'Peut changer l\'auteur d\'un article', 'cat' => 'kb'),
	'acl_a_permissions_kb'		=> array('lang' => 'Peut éditer les permissions des catégories', 'cat' => 'kb'),
	'acl_a_config_kb'			=> array('lang' => 'Peut éditer la configuration de la BC', 'cat' => 'kb'),
	'acl_a_categorie_kb'		=> array('lang' => 'Peut éditer les catégories de la BC', 'cat' => 'kb'),
	'acl_a_types_kb'			=> array('lang' => 'Peut éditer les types (BC)', 'cat' => 'kb'),
	'acl_a_meeting_config'		=> array('lang' => 'Peut gérer la configuration des réunions', 'cat' => 'meeting'),
	'acl_a_meeting_add'			=> array('lang' => 'Peut ajouter de nouvelles réunions', 'cat' => 'meeting'),
	'acl_a_meeting_manage'		=> array('lang' => 'Peut gérer les réunions existantes', 'cat' => 'meeting'),
	'acl_u_ajaxlike_mod'		=> array('lang' => 'Peut aimer les messages', 'cat' => 'misc'),
	'acl_f_ajaxlike_mod'		=> array('lang' => 'Peut aimer les messages dans le forum', 'cat' => 'misc'),
));
