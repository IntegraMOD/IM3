...
$lang = array_merge($lang, array(
	...
	// Missing variables
	'ACP_CLOUD'						=> 'Paramètres par défaut des balises du nuage du portail. (Cloud 9)',
	'ACP_CLOUD_EXPLAIN'				=> 'Ici, vous pouvez ajouter, modifier et supprimer des balises. <strong>Note :</strong> Utiliser une taille de police supérieure à 16pt n\'est pas recommandé, de plus il peut être difficile de voir les polices de couleur claire...',
	'ADD_CLOUD'						=> 'Ajouter un nuage',
	'EDIT_CLOUD'					=> 'Éditer un nuage',
	'DELETE_CLOUD'					=> 'Supprimer un nuage',
	'CONFIG_CLOUD'					=> 'Configuration par défaut du nuage',
	'CLOUD_ID'						=> 'ID',
	'CLOUD_ID_LONG'					=> 'L\'ID de la balise (ne pas modifier)',
	'CLOUD_IS_ACTIVE'				=> 'A',
	'CLOUD_IS_ACTIVE_LONG'			=> 'Définir la balise comme active',
	'CLOUD_LONG'					=> 'Balises/Cat.',
	'CLOUD_LINK'					=> 'Lien',
	'CLOUD_LINK_LONG'				=> 'Lien à utiliser pour la balise',
	'CLOUD_COLOUR'					=> 'Couleur',
	'CLOUD_COLOUR_LONG'				=> 'Couleur de balise (Valeur couleur HEX)',
	'CLOUD_HCOLOUR'					=> 'Couleur au survol',
	'CLOUD_HCOLOUR_LONG'			=> 'Couleur au survol de la balise (Valeur couleur HEX)',
	'CLOUD_CLASS'					=> 'Classe',
	'CLOUD_CLASS_LONG'				=> 'Classe inconnue',
	'CLOUD_REL'						=> 'R',
	'CLOUD_REL_LONG'				=> 'Inconnu',
	'CLOUD_FONT_SIZE'				=> 'Taille de la police',
	'CLOUD_FONT_SIZE_LONG'			=> 'Taille de la police à utiliser (MAX ~ 16pt)',
	'CLOUD_TEXT'					=> 'Texte de la balise',
	'CLOUD_TEXT_LONG'				=> 'Texte de la balise à afficher<br />Taille et couleur effectives',
	'CLOUD_MAX_TAGS'				=> 'Nombre max de balises',
	'CLOUD_MAX_TAGS_EXPLAIN'		=> 'Définissez le nombre max de balises afin de ne pas encombrer le bloc.',
	'CLOUD_MOVIE'					=> 'Cloud Movie',
	'CLOUD_MOVIE_EXPLAIN'			=> 'Chaque nuage peut avoir sa propre vidéo.',
	'CLOUD_WIDTH'					=> 'Largeur du nuage',
	'CLOUD_WIDTH_EXPLAIN'			=> 'Largeur du bloc nuage.',
	'CLOUD_HEIGHT'					=> 'Hauteur du nuage',
	'CLOUD_HEIGHT_EXPLAIN'			=> 'Hauteur du bloc nuage.',
	'CLOUD_TCOLOUR'					=> 'Couleur de balise',
	'CLOUD_TCOLOUR_EXPLAIN'			=> 'Couleur principale de la balise.',
	'CLOUD_TCOLOUR2'				=> 'Couleur de balise secondaire',
	'CLOUD_TCOLOUR2_EXPLAIN'		=> 'Couleur pour les balises moins importantes.',
	'CLOUD_HICOLOUR'				=> 'Couleur au survol',
	'CLOUD_HICOLOUR_EXPLAIN'		=> 'Couleur de la balise lors du survol par la souris.',
	'CLOUD_BG_COLOUR'				=> 'Couleur de fond du nuage',
	'CLOUD_BG_COLOUR_EXPLAIN'		=> 'Couleur du fond du nuage *transparent (voir WMODE).',
	'CLOUD_SPEED'					=> 'Vitesse, rapidité de rotation',
	'CLOUD_SPEED_EXPLAIN'			=> 'Pourcentage, plus le chiffre est grand, plus la rotation est rapide.',
	'CLOUD_MODE'					=> 'Mode Balises/Catégories',
	'CLOUD_MODE_EXPLAIN'			=> '"tags" ou "cats" ou "both"',
	'CLOUD_WMODE'					=> 'WMode (Mode d\'affichage)',
	'CLOUD_WMODE_EXPLAIN'			=> 'Transparence du fond.',
	'CLOUD_DISTR'					=> 'Distributions de balises',
	'CLOUD_DISTR_EXPLAIN'			=> 'Vérifie si les balises sont distribuées uniformément sur la sphère.',
	'TEAMSPEAK_SETTINGS'			=> 'Configuration TeamSpeak',
	'TEAMSPEAK_PASS'				=> 'Mot de passe',
	'TEAMSPEAK_CONNECT'				=> 'Connexion',
	'CLOUD_SEARCH'					=> 'Bloc Nuage de recherche',
	'CLOUD_SEARCH_ALLOW'			=> 'Afficher le bloc de recherche nuage',
	'CLOUD_SEARCH_CACHE'			=> 'Temps de cache pour ce bloc',
	'CLOUD_SEARCH_CACHE_EXPLAIN'	=> '(temps de cache en secondes).',
	'MINI_MOD_DEVELOPMENT'			=> 'Mini Modules en Développement, options d\'affichage',
	'MINI_MOD_STYLE_COUNT'			=> 'Nombre de styles à afficher dans ce bloc',
	'MINI_MOD_STYLE_COUNT_EXPLAIN'	=> '',
	'MINI_MOD_BLOCK_COUNT'			=> 'Nombre de blocs à afficher dans ce bloc',
	'MINI_MOD_BLOCK_COUNT_EXPLAIN'	=> '',
	'MINI_MOD_MOD_COUNT'			=> 'Nombre de MODs à afficher dans ce bloc',
	'MINI_MOD_MOD_COUNT_EXPLAIN'	=> '',
	'SGP_QR_SETTINGS'				=> 'Paramètres Réponse Rapide SGP',
	'SGP_QR'						=> 'Utiliser la réponse rapide SGP',
	'SGP_QR_EXPLAIN'				=> 'Remplacer la réponse rapide par défaut par la version du portail.',
	'K_TEAMS'						=> 'Ces équipes seront affichées',
	'K_TEAMS_EXPLAIN'				=> '(ID des équipes dans une liste séparée par des virgules).',
	'K_BLOCK_TEAMS'					=> 'Sélectionner des équipes à afficher dans le bloc',
	'K_BLOCK_TEAMS_EXPLAIN'			=> 'Cette liste déroulante est réutilisable, chaque sélection mettra à jour la liste.<br />La sélection de <strong>none</strong> réinitialisera la liste.',
	'THE_TEAM_SETTINGS_2'			=> 'Limiter aux membres',
));
