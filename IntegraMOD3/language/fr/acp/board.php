...
$lang = array_merge($lang, array(
	...
	'PORTAL_NAME_EXPLAIN'         => 'Définit le libellé par défaut du lien du portail.<br> Laissez <strong>Portal</strong> pour utiliser la traduction standard du fichier de langue. Si modifié, des noms localisés peuvent être saisis pour chaque langue installée.',
	'FORUM_NAME'                  => 'Nom du forum',
	'FORUM_NAME_EXPLAIN'          => 'Définit le libellé par défaut du lien du forum.<br> Laissez <strong>Forum</strong> pour utiliser la traduction standard du fichier de langue. Si modifié, des noms localisés peuvent être saisis pour chaque langue installée.',
	'LOCALIZED_NAMES'             => 'Noms localisés',
	'PORTAL_NAME_LANG'            => 'Nom du portail - %s',
	'FORUM_NAME_LANG'             => 'Nom du forum - %s',
...
$lang = array_merge($lang, array(
    ...
    'SERVER_PORT_EXPLAIN'		=> 'Le port sur lequel votre serveur fonctionne, généralement 80 pour HTTP et 443 pour HTTPS. Ne le modifiez que s’il est différent.',
...
$lang = array_merge($lang, array(
	...
	'REFERER_VALID_EXPLAIN'			=> 'Si cette option est activée, le référant des requêtes POST sera vérifié à la place des réglages effectués sur le chemin de l’hôte ou sur le script. Cela peut s’avérer problématique concernant les forums utilisant plusieurs domaines ou connexions externes.',
