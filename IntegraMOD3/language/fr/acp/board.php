...
$lang = array_merge($lang, array(
    'DIGEST_ALL'                                => 'Tous',
    'DIGEST_ALL_ALLOWED_FORUMS'                 => 'Tous les forums autorisés',
    'DIGEST_ALL_SUBSCRIBED'                     => 'Tous les membres éligibles ont été abonnés',
    'DIGEST_ALL_UNSUBSCRIBED'                   => 'Tous les membres éligibles ont été désabonnés',
    'DIGEST_BALANCE_LOAD'                       => 'Équilibrage de la charge',
    'DIGEST_BLOCK_IMAGES'                       => 'Bloquer les images',
    'DIGEST_BLOCK_IMAGES_EXPLAIN'               => 'Empêche toutes les images d’apparaître dans les résumés, y compris les images en pièces jointes. Si la bande passante est un problème, vous devriez activer cette option.',
    'DIGEST_CHANGE_SUBSCRIPTION'                => 'Modifier l’abonnement',
    'DIGEST_CURRENT_VERSION_INFO'               => 'Vous utilisez la version <strong>%s</strong>.',
    'DIGEST_CUSTOM_STYLESHEET_PATH'             => 'Chemin de la feuille de style personnalisée',
    'DIGEST_CUSTOM_STYLESHEET_PATH_EXPLAIN'     => 'Ce paramètre ne s’applique que si la case "Activer la feuille de style personnalisée" est cochée. Si elle est activée, cette feuille de style sera appliquée à tous les résumés au format HTML. Le chemin doit être un chemin relatif depuis votre dossier de styles phpBB et devrait normalement se trouver dans le sous-dossier theme. Remarque : vous êtes responsable de la création de cette feuille de style et de son placement dans un fichier portant le nom saisi ici à l’emplacement approprié sur votre serveur. Exemple : prosilver/theme/digest_stylesheet.css. Pour plus d’informations sur la création de feuilles de style, cliquez <a href="http://www.w3schools.com/css/">ici</a>.',
    'DIGEST_COLLAPSE'                           => 'Réduire',
    'DIGEST_DEFAULT'                            => 'S’abonner en utilisant les paramètres par défaut',
    'DIGEST_ENABLED'                            => 'Activer les résumés',
    'DIGEST_ENABLED_EXPLAIN'                    => 'Si vous désactivez les résumés, l’interface dans le Panneau de contrôle de l’utilisateur disparaîtra en désactivant la catégorie du module. De plus, les résumés ne seront plus envoyés. Cependant, tous les paramètres de résumé des utilisateurs sont conservés.',
    'DIGEST_ENABLE_AUTO_SUBSCRIPTIONS'          => 'Activer les abonnements automatiques',
    'DIGEST_ENABLE_AUTO_SUBSCRIPTIONS_EXPLAIN'  => 'Si vous souhaitez que les nouveaux utilisateurs reçoivent automatiquement les résumés, sélectionnez Oui. Les paramètres par défaut du forum pour les résumés seront automatiquement utilisés. (Ceux-ci sont définis dans les paramètres utilisateur par défaut du résumé). L’activation de cette option ne créera <em>pas</em> d’abonnements pour les utilisateurs actuellement désabonnés ou pour les nouveaux membres qui ont choisi de ne pas recevoir de résumé lors de leur inscription. Vous pouvez les configurer individuellement via la fonction Modifier les abonnés, ou globalement avec l’option Inscription/Désinscription de masse.',
    'DIGEST_ENABLE_CUSTOM_STYLESHEET'           => 'Activer la feuille de style personnalisée',
    'DIGEST_ENABLE_CUSTOM_STYLESHEET_EXPLAIN'   => 'Si non activée, la feuille de style par défaut du style sélectionné dans le profil de l’utilisateur est appliquée aux versions HTML de ses résumés.',
    'DIGEST_ENABLE_LOG'                         => 'Écrire toutes les actions des résumés dans le journal d’administration',
    'DIGEST_ENABLE_LOG_EXPLAIN'                 => "Si Oui, toutes les actions liées aux résumés seront écrites dans le journal d’administration (situé dans l’onglet Maintenance). Cela est utile pour résoudre les problèmes de résumé car cela indique ce que le programme mail_digests.$phpEx a fait et quand. Cependant, cela entraînera rapidement un journal d’administration très volumineux, car au moins deux entrées y seront écrites toutes les heures.",
    'DIGEST_ENABLE_SUBSCRIBE_UNSUBSCRIBE'       => 'Activer l’abonnement ou la désinscription de masse',
    'DIGEST_ENABLE_SUBSCRIBE_UNSUBSCRIBE_EXPLAIN' => 'Si vous répondez oui, l’action d’abonnement ou de désinscription de masse sera effectuée lorsque vous cliquerez sur Envoyer. À activer avec précaution !',
    'DIGEST_EXCLUDE_FORUMS'                     => 'Toujours exclure ces forums',
    'DIGEST_EXCLUDE_FORUMS_EXPLAIN'             => 'Entrez les forum_ids des forums qui ne doivent jamais apparaître dans un résumé. Séparez les forum_ids par des virgules. Si défini sur 0, aucun forum ne sera exclu. Pour déterminer les forum_ids, lorsque vous naviguez sur un forum, observez le paramètre "f" dans la barre d’adresse de l’URL. C’est le forum_id. Exemple : http://www.example.com/phpBB3/viewforum.php?f=1. N’utilisez pas de forum_ids correspondant à des catégories. <i>Ce paramètre est ignoré si l’abonné demande uniquement les sujets surveillés.</i>',
    'DIGEST_EXPAND'                             => 'Développer',
    'DIGEST_FROM_EMAIL_ADDRESS'                 => 'Adresse e-mail de l’expéditeur',
    'DIGEST_FROM_EMAIL_ADDRESS_EXPLAIN'         => 'Lorsque les utilisateurs reçoivent un résumé, cette adresse e-mail apparaîtra dans le champ DE (FROM). Si elle est laissée vide, elle utilisera par défaut l’adresse e-mail de contact de votre forum. Soyez prudent si vous utilisez une adresse e-mail avec un domaine différent de celui où le résumé est hébergé, car votre serveur de messagerie ou le serveur de messagerie de l’utilisateur pourrait interpréter l’e-mail comme un spam.',
    'DIGEST_FROM_EMAIL_NAME'                    => 'Nom de l’expéditeur de l’e-mail',
    'DIGEST_FROM_EMAIL_NAME_EXPLAIN'            => 'Il s’agit du nom d’expéditeur en texte brut qui apparaîtra dans le client de messagerie. Si le champ est laissé vide, il s’identifiera comme un robot de votre forum.',
    'DIGEST_HAS_UNSUBSCRIBED'                   => 'S’est désabonné',
    'DIGEST_HOUR_SENT'                          => 'Heure d’envoi<br />(basé sur %s GMT)',
    'DIGEST_IGNORE'                             => 'Ignorer les actions globales',
    'DIGEST_INCLUDE_ADMINS'                     => 'Inclure les administrateurs',
    'DIGEST_INCLUDE_ADMINS_EXPLAIN'             => 'Cela abonnera ou désabonnera les administrateurs en plus des utilisateurs normaux.',
    'DIGEST_INCLUDE_FORUMS'                     => 'Toujours inclure ces forums',
    'DIGEST_INCLUDE_FORUMS_EXPLAIN'             => 'Entrez les forum_ids des forums qui doivent impérativement apparaître dans un résumé. Séparez les forum_ids par des virgules. Si défini sur 0, aucun forum n’est obligatoirement inclus. Pour déterminer les forum_ids, lorsque vous naviguez sur un forum, observez le paramètre "f" dans la barre d’adresse de l’URL. C’est le forum_id. Exemple : http://www.example.com/phpBB3/viewforum.php?f=1. N’utilisez pas de forum_ids correspondant à des catégories. <i>Ce paramètre est ignoré si l’abonné demande uniquement les sujets surveillés.</i>',
    'DIGEST_KEY_VALUE'                          => 'Valeur de la clé',
    'DIGEST_KEY_VALUE_EXPLAIN'                  => 'Gardez à l’esprit que ceci est du texte brut et non chiffré. Restez simple. Évitez les mots multiples, les espaces et les caractères spéciaux. Exemple : qwertyuiop',
    'DIGEST_LAST_SENT'                          => 'Dernier résumé envoyé',
    'DIGEST_LATEST_VERSION_INFO'                => 'La dernière version disponible est la <strong>%s</strong>.',
    'DIGEST_LIST_USER'                          => '1 Utilisateur',
    'DIGEST_LIST_USERS'                         => '%s Utilisateurs',
    'DIGEST_MAX_ITEMS'                          => 'Nombre maximal de messages autorisés par résumé',
    'DIGEST_MAX_ITEMS_EXPLAIN'                  => 'Pour des raisons de performance, vous devrez peut-être définir une limite absolue au nombre de messages dans un résumé unique. Si vous définissez cette valeur sur 0 (zéro), la taille du résumé sera illimitée. Vous pouvez utiliser n’importe quel nombre entier dans ce champ. Veuillez noter qu’un résumé est limité par le nombre de messages dans le type de résumé demandé (quotidien, hebdomadaire ou mensuel) ainsi que par d’autres critères que l’utilisateur peut définir.',
    'DIGEST_NEVER_VISITED'                      => 'Jamais visité',
    'DIGEST_NEW_SUBSCRIBERS'                    => ' %s utilisateurs ont été abonnés pour recevoir les résumés : %s.',
    'DIGEST_NONSUBSCRIBER'                      => 'Non abonné',
    'DIGEST_NO_DIGESTS_SENT'                    => 'Aucun résumé envoyé',
    'DIGEST_NO_MASS_ACTION'                     => 'Aucune action n’a été entreprise, car vous n’avez pas activé la fonctionnalité',
    'DIGEST_NOTIFY_ON_MASS_SUBSCRIBE'           => 'Notifier le membre par e-mail de l’action s’il est concerné',
    'DIGEST_OVERRIDE_QUEUE'                     => 'Envoyer chaque résumé individuellement',
    'DIGEST_OVERRIDE_QUEUE_EXPLAIN'             => 'Par défaut, les résumés seront envoyés par lots si la taille de votre paquet d’e-mails est supérieure à zéro. Si vous remarquez que tous les résumés ne sont pas envoyés au cours d’une heure, vous pouvez régler cette option sur oui. Si oui, un résumé sera envoyé avant que le suivant ne soit assemblé. Cela entraînera probablement une exécution plus longue du programme d’envoi des résumés et utilisera plus de processeur, mais c’est plus fiable.',
    'DIGEST_RANDOM_HOUR'                        => 'Heure aléatoire',
    'DIGEST_REBALANCED'                         => 'Lors de cet rééquilibrage, un total de %s abonnés aux résumés ont vu leur heure d’envoi modifiée.',
    'DIGEST_REFRESH'                            => 'Actualiser',
    'DIGEST_REGISTRATION_FIELD'                 => 'Permettre aux utilisateurs de s’abonner aux résumés lors de l’inscription',
    'DIGEST_REGISTRATION_FIELD_EXPLAIN'         => 'Si activé, les utilisateurs ont la possibilité, lors de leur inscription, de recevoir les résumés en utilisant les valeurs par défaut du forum. Cette option n’apparaît pas si les abonnements automatiques sont activés.',
    'DIGEST_REPLY_TO_EMAIL_ADDRESS'             => 'Adresse e-mail de réponse (Reply-To)',
    'DIGEST_REPLY_TO_EMAIL_ADDRESS_EXPLAIN'     => 'Lorsque les utilisateurs reçoivent un résumé, cette adresse e-mail apparaîtra dans le champ RÉPONDRE À (REPLY TO). Si elle est laissée vide, elle sera configurée par défaut sur l’adresse e-mail de contact de votre forum. Soyez prudent si vous utilisez une adresse e-mail avec un domaine autre que celui où le résumé est hébergé, car votre serveur de messagerie ou le serveur de messagerie de l’utilisateur pourrait interpréter l’e-mail comme un spam.',
    'DIGEST_REQUIRE_KEY'                        => 'Exiger un paramètre de clé pour exécuter mail_digests.php',
    'DIGEST_REQUIRE_KEY_EXPLAIN'                => "Il s’agit d’une mesure de sécurité supplémentaire que vous pouvez activer. Si elle est activée, mail_digests.$phpEx n’enverra des résumés que si le paramètre de clé est spécifié et que la clé correspond à la valeur définie ci-dessous. Vous devrez programmer votre tâche cron ou son équivalent pour utiliser cette clé. Exemple de l’URL résultante : http://www.example.com/phpBB3/mail_digests.$phpEx?key=qwertyuiop",
    'DIGEST_SEARCH_FOR_MEMBER'                  => 'Rechercher un membre',
    'DIGEST_SEARCH_FOR_MEMBER_EXPLAIN'          => 'Entrez le nom complet ou partiel du membre à rechercher puis appuyez sur Actualiser. Laissez vide pour voir tous les membres. Les recherches sont sensibles à la casse et trouveront les membres en fonction du filtre utilisateur actuel.',
    'DIGEST_SELECT_FORUMS_ADMIN_EXPLAIN'        => 'La liste des forums comprend uniquement les forums que cet utilisateur est autorisé à lire. Si vous souhaitez donner à cet utilisateur l’accès à des forums supplémentaires non affichés ici, étendez ses permissions d’utilisateur de forum ou de groupe. Notez que bien que vous puissiez affiner les forums qui apparaissent dans son résumé, si son type de résumé est "Aucun", aucun résumé ne sera envoyé.',
    'DIGEST_SHOW'                               => 'Afficher',
    'DIGEST_SHOW_OUTPUT'                        => 'Afficher les rapports de sortie',
    'DIGEST_SHOW_OUTPUT_EXPLAIN'                => "Si oui, lors de l’exécution de mail_digests.$phpEx, des messages s’afficheront à l’écran indiquant qui a reçu un résumé et quand. En règle générale, ces messages ne sont pas visibles puisque le programme s’exécute automatiquement. Il est suggéré de régler cette option sur Oui jusqu’à ce que vous automatisiez le processus, puis de la régler sur Non.",
    'DIGEST_SHOW_EMAIL'                         => 'Afficher l’adresse e-mail',
    'DIGEST_SHOW_EMAIL_EXPLAIN'                 => "Si 'Afficher les rapports de sortie' et 'Afficher l’adresse e-mail' sont tous deux activés, l’adresse e-mail de l’abonné s’affichera sur l’écran de sortie. Il est suggéré de désactiver <em>rapidement</em> cette option après le dépannage, car elle introduit un problème de sécurité potentiel.",
    'DIGEST_SOCKET_FUNCTIONS_DISABLED'          => 'Les fonctions socket sont actuellement désactivées.',
    'DIGEST_SORT_ORDER'                         => 'Ordre de tri',
    'DIGEST_STOPPED_SUBSCRIBING'                => 'Abonnement arrêté',
    'DIGEST_SUBSCRIBE'                          => 'S’abonner en utilisant les valeurs par défaut',
    'DIGEST_SUBSCRIBE_SUBJECT'                  => 'Vous avez été abonné pour recevoir les résumés par e-mail',
    'DIGEST_SUBSCRIBE_ALL'                      => 'Abonner tout le monde',
    'DIGEST_SUBSCRIBE_ALL_EXPLAIN'              => 'Si vous répondez non, tout le monde sera désabonné.',
    'DIGEST_SUBSCRIBE_LITERAL'                  => 'S’abonner',
    'DIGEST_SUBSCRIBED'                         => 'Abonné',
    'DIGEST_SUBSCRIBER'                         => 'Abonné',
    'DIGEST_SUBSCRIBERS'                        => 'Abonnés',
    'DIGEST_SUBSCRIBER_DETAIL'                  => 'Détails de l’abonné aux résumés',
    'DIGEST_TIME_ZONE'                          => 'Fuseau horaire',
    'DIGEST_TIME_ZONE_EXPLAIN'                  => 'Les fonctions de modification des abonnés et d’équilibrage de charge indiquent l’heure à laquelle les résumés sont envoyés par e-mail. Si vous définissez un fuseau horaire particulier ici, l’heure d’envoi sera convertie dans le fuseau horaire choisi. Initialement, ceci est configuré sur le fuseau horaire du forum. Les valeurs doivent être des nombres entiers compris entre -12 et 12, 0 étant le fuseau horaire GMT.',
    'DIGEST_UNKNOWN'                            => 'Inconnu',
    'DIGEST_UNSUBSCRIBE'                        => 'Se désabonner',
    'DIGEST_UNSUBSCRIBE_MARKED'                 => 'Désabonner les éléments cochés',
    'DIGEST_UNSUBSCRIBE_SUBJECT'                => 'Vous avez été désabonné de la réception des résumés par e-mail',
    'DIGEST_UNSUBSCRIBED'                       => 'Ne s’est jamais abonné',
    'DIGEST_USER_DIGEST_ATTACHMENTS'            => 'Valeur par défaut pour afficher les pièces jointes',
    'DIGEST_USER_DIGEST_BLOCK_IMAGES'           => 'Valeur par défaut pour bloquer les images',
    'DIGEST_USER_DIGEST_CHECK_ALL_FORUMS'       => 'Voulez-vous sélectionner tous les forums par défaut',
    'DIGEST_USER_DIGEST_FILTER_TYPE'            => 'Type de messages par défaut dans les résumés',
    'DIGEST_USER_DIGEST_MAX_DISPLAY_WORDS'      => 'Nombre maximal de mots par défaut à afficher dans un message',
    'DIGEST_USER_DIGEST_MAX_DISPLAY_WORDS_EXPLAIN' => 'Définissez sur -1 pour afficher le texte intégral du message par défaut. Définir sur zéro (0) signifie que par défaut l’utilisateur ne verra aucun texte du message.',
    'DIGEST_USER_DIGEST_MAX_POSTS'              => 'Nombre maximal de messages par défaut dans un résumé',
    'DIGEST_USER_DIGEST_MAX_POSTS_EXPLAIN'      => 'Si réglé à zéro, cela permettra un nombre illimité de messages. Veuillez noter qu’aucun résumé ne contiendra jamais plus que votre paramètre de nombre maximal de messages autorisés par résumé (ci-dessus).',
    'DIGEST_USER_DIGEST_MIN_POSTS'              => 'Nombre minimal de mots par défaut pour qu’un message apparaisse dans un résumé',
    'DIGEST_USER_DIGEST_MIN_POSTS_EXPLAIN'      => 'Si réglé à zéro, cela permettra les messages avec n’importe quel nombre de mots.',
    'DIGEST_USER_DIGEST_NEW_POSTS_ONLY'         => 'Valeur par défaut pour afficher uniquement les nouveaux messages',
    'DIGEST_USER_DIGEST_PM_MARK_READ'           => 'Valeur par défaut pour marquer les messages privés comme lus lorsqu’ils apparaissent dans le résumé',
    'DIGEST_USER_DIGEST_RANDOM_HOUR'            => 'Heure aléatoire',
    'DIGEST_USER_DIGEST_REGISTRATION'           => 'Valeur par défaut déterminant si un utilisateur s’abonne aux résumés lors de son inscription',
    'DIGEST_USER_DIGEST_RESET_LASTVISIT'        => 'Valeur par défaut pour réinitialiser la date de dernière visite lors de l’envoi d’un résumé',
    'DIGEST_USER_DIGEST_SEND_HOUR_GMT'          => 'Heure d’envoi par défaut (Temps Universel)',
    'DIGEST_USER_DIGEST_SEND_ON_NO_POSTS'       => 'Valeur par défaut pour envoyer un résumé s’il n’y a pas de nouveaux messages',
    'DIGEST_USER_DIGEST_SHOW_FOES'              => 'Valeur par défaut pour supprimer les messages des ignorés (foes) de l’utilisateur',
    'DIGEST_USER_DIGEST_SHOW_MINE'              => 'Valeur par défaut pour supprimer les propres messages de l’utilisateur',
    'DIGEST_USER_DIGEST_SHOW_PMS'               => 'Valeur par défaut pour ajouter les messages privés non lus de l’utilisateur',
    'DIGEST_USER_DIGEST_SORT_ORDER'             => 'Ordre de tri des messages par défaut',
    'DIGEST_USER_DIGEST_STYLE'                  => 'Style de résumé par défaut',
    'DIGEST_USER_DIGEST_TYPE'                   => 'Type de résumé utilisateur par défaut',
    'DIGEST_USER_DIGEST_TOC'                    => 'Valeur par défaut pour la table des matières',
    'DIGEST_USER_TYPE'                          => 'Type d’utilisateur',
    'DIGEST_USERS_PER_PAGE'                     => 'Abonnés par page',
    'DIGEST_USERS_PER_PAGE_EXPLAIN'             => 'Cela contrôle le nombre d’abonnés aux résumés qu’un administrateur voit par page lorsqu’il sélectionne l’option de modification des abonnés. En fonction de votre paramètre max_input_vars, vous devriez limiter cela à ' . floor((ini_get('max_input_vars') - 100) / 24) . ' abonnés par page ou moins. Sinon, vous devrez peut-être augmenter max_input_vars dans votre fichier php.ini pour empêcher la fonction d’échouer.',
    'DIGEST_VERSION_NOT_UP_TO_DATE'             => 'Cette version de phpBB Digests n’est pas à jour. Des mises à jour sont disponibles sur le <a href="%s">site web de Digests</a>.',
    'DIGEST_VERSION_UP_TO_DATE'                 => 'Cette version de phpBB Digests est à jour, aucune mise à jour n’est disponible.',
    'DIGEST_WEEKLY_DIGEST_DAY'                  => 'Sélectionnez le jour de la semaine pour l’envoi des résumés hebdomadaires',
    'DIGEST_WITH_SELECTED'                      => 'Pour la sélection',
...
// Mod links in header
$lang = array_merge($lang, array(
    'MOD_LINKS'                 => 'Choisir les liens à afficher dans la navigation',
    'SHOW_ACTIVITY'             => 'Réseau social',
    'SHOW_ACTIVITY_EXPLAIN'     => 'Afficher le lien de la page d’activité dans la navigation.',    
    'SHOW_BLOG'                 => 'Blog',
    'SHOW_BLOG_EXPLAIN'         => 'Afficher le lien du Blog dans la navigation.',
    'SHOW_KB'                   => 'Base de connaissances',
    'SHOW_KB_EXPLAIN'           => 'Afficher le lien de la Base de connaissances dans la navigation.',
    'SHOW_CAL'                  => 'Calendrier',
    'SHOW_CAL_EXPLAIN'          => 'Afficher le lien du Calendrier des sujets dans la navigation.',
    'SHOW_GALL'                 => 'Galerie',
    'SHOW_GALL_EXPLAIN'         => 'Afficher le lien de la Galerie dans la navigation.',
    'SHOW_CHT'                  => 'Chat',
    'SHOW_CHT_EXPLAIN'          => 'Afficher le lien du Chat dans l’en-tête.',
    'SHOW_DLS'                  => 'Téléchargements',
    'SHOW_DLS_EXPLAIN'          => 'Afficher le lien des Téléchargements dans la navigation.',
    'SHOW_FAQ'                  => 'FAQ',
    'SHOW_FAQ_EXPLAIN'          => 'Afficher le lien de la FAQ dans la navigation.',
    'SHOW_MEM'                  => 'Liste des membres',
    'SHOW_MEM_EXPLAIN'          => 'Afficher le lien de la Liste des membres dans la navigation.',
    'SHOW_NOTES'                => 'Notes',
    'SHOW_NOTES_EXPLAIN'        => 'Afficher le lien des Notes dans la navigation.',
    'SHOW_MEETING'              => 'Réunions',
    'SHOW_MEETING_EXPLAIN'      => 'Afficher le lien des Réunions dans la navigation.',    
    'SHOW_CONTACT'              => 'Contactez-nous',
    'SHOW_CONTACT_EXPLAIN'      => 'Afficher le lien de Contact dans la navigation.',    
    'SHOW_RULES'                => 'Règlement',
    'SHOW_RULES_EXPLAIN'        => 'Afficher le lien du Règlement dans la navigation.',
));


// Notes settings by OXPUS
$lang = array_merge($lang, array(
    'ACP_NOTES_SETTINGS'        => 'Nombre max. de notes par utilisateur',

    // Missing variables
    'SITE_COPYRIGHT_ENABLE'			=> 'Afficher le nom du site comme copyright dans le pied de page',
    'GUEST_SESSIONS_CACHE'			=> 'Utiliser le cache de sessions invité',
    'GUEST_SESSIONS_CACHE_EXPLAIN'	=> 'Stocker les sessions d\'invités anonymes dans le backend ACM configuré au lieu de la base de données pour réduire la charge d\'écriture sur la table des sessions. Nécessite includes/guest_sessions.php et un backend ACM configuré en conséquence.',
    'COOKIE_HTTPONLY'				=> 'Cookie HTTP uniquement',
    'COOKIE_DOMAIN_EXPLAIN'			=> 'Dans la plupart des cas, le domaine du cookie est facultatif. Laissez ce champ vide si vous n\'êtes pas sûr.<br />Dans le cas où vous avez intégré phpBB avec un autre logiciel ou avez plusieurs domaines, pour déterminer le domaine du cookie, vous devez savoir ce qui suit. Si vous avez un site comme <i>example.com</i> et que votre forum est sur <i>www.example.com</i> ou <i>board.example.com</i>, définissez le domaine du cookie sur <i>.example.com</i>. Le point avant le nom de domaine est requis.',
    'COOKIE_NAME_EXPLAIN'			=> 'Ce nom peut être ce que vous voulez, soyez original. À chaque changement des paramètres de cookie, le nom du cookie devrait être modifié.',
    'COOKIE_NOTICE'					=> 'Avis sur les cookies',
    'COOKIE_NOTICE_EXPLAIN'			=> 'Afficher un avis de cookies aux visiteurs. Cela peut être exigé par la loi en fonction du contenu de votre forum et de votre juridiction.',
    'COOKIE_PATH_EXPLAIN'			=> 'Généralement, il s\'agit du même chemin que celui de votre script ou simplement d\'une barre oblique (slash) pour rendre le cookie accessible sur tout le domaine.',
    'COOKIE_SAMESITE'				=> 'Cookie SameSite',
    'COOKIE_SAMESITE_EXPLAIN'		=> 'Gère quand les cookies sont envoyés lors des requêtes inter-sites.<br><strong>None</strong> autorise l\'envoi des cookies avec toutes les requêtes (requiert l\'option Sécurisé).<br><strong>Lax</strong> autorise les cookies lors de la navigation globale mais pas pour le contenu encapsulé.<br><strong>Strict</strong> empêche l\'envoi de cookies lors de toute requête inter-site.',
    'COOKIE_SAMESITE_NONE'			=> 'None (autorise toutes les requêtes inter-sites)',
    'COOKIE_SAMESITE_LAX'			=> 'Lax (autorise la navigation globale)',
    'COOKIE_SAMESITE_STRICT'		=> 'Strict (empêche toute requête inter-site)',
    'COOKIE_PARTITIONED'			=> 'Cookie Partitionnées',
    'COOKIE_PARTITIONED_EXPLAIN'	=> 'Activer les cookies partitionnés pour améliorer la confidentialité dans des contextes tiers. Utile pour les contenus intégrés et empêchant le traçage inter-site. Requiert l\'activation de l\'attribut Sécurisé.',
    'COOKIE_SECURE_ADMIN'			=> 'Forcer les cookies sécurisés pour l\'admin',
    'COOKIE_SECURE_ADMIN_EXPLAIN'	=> 'Force tous les cookies du panneau d\'administration à utiliser l\'attribut sécurisé, quel que soit le paramètre global. Ajoute une couche de sécurité supplémentaire pour les fonctions administratives.',
    'SESSION_GC'					=> 'Nettoyage des sessions',
    'SESSION_GC_EXPLAIN'			=> 'Le système nettoiera les anciennes sessions toutes les x secondes.',
    'ACTIVE_SESSIONS'				=> 'Sessions actives',
    'ACTIVE_SESSIONS_EXPLAIN'		=> 'Nombre de sessions actives dans les dernières %s minutes',
    'COOKIE_CONSENT_TITLE'			=> 'Titre de consentement aux cookies',
    'COOKIE_CONSENT_MESSAGE'		=> 'Message de consentement aux cookies',
    'COOKIE_CONSENT_SETTINGS'		=> 'Paramètres de consentement aux cookies',
    'COOKIE_CONSENT_ENABLE'			=> 'Activer la fenêtre de consentement aux cookies',
    'COOKIE_CONSENT_TEXT'			=> 'Texte de la fenêtre de consentement',
    'COOKIE_CONSENT_CONFIRM'		=> 'Texte du bouton Confirmer',
    'COOKIE_CONSENT_ACCEPT_TEXT'	=> 'Texte du bouton Accepter',
    'COOKIE_CONSENT_DECLINE_TEXT'	=> 'Texte du bouton Refuser',
    'COOKIE_CONSENT_POSITION'		=> 'Position de la fenêtre de consentement',
    'COOKIE_CONSENT_POSITION_TOP'	=> 'Haut',
    'COOKIE_CONSENT_POSITION_BOTTOM'=> 'Bas',
    'COOKIE_CONSENT_POSITION_CENTER'=> 'Centre',
    'JAB_ALLOW_SELF_SIGNED'			=> 'Autoriser les certificats SSL auto-signés',
    'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Autoriser les connexions au serveur Jabber avec un certificat SSL auto-signé.<em><strong>Attention :</strong> Cela peut entraîner des risques de sécurité.</em>',
    'JAB_VERIFY_PEER'				=> 'Vérifier le certificat SSL',
    'JAB_VERIFY_PEER_EXPLAIN'		=> 'Requièrt la vérification du certificat SSL utilisé par le serveur Jabber.<em><strong>Attention :</strong> Se connecter à des pairs avec un certificat SSL non vérifié peut entraîner des risques.</em>',
    'JAB_VERIFY_PEER_NAME'			=> 'Vérifier le nom du pair Jabber',
    'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Requièrt la vérification du nom pour les serveurs Jabber utilisant SSL / TLS.<em><strong>Attention :</strong> Se connecter à des pairs non vérifiés peut entraîner des risques.</em>',
));