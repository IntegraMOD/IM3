...
$lang = array_merge($lang, array(
	...
	'UCP_FB_POST_COUNT'							=> 'Facebook Contact Post Count',
	'UCP_FB_POST_COUNT_EXPLAIN'					=> 'If Facebook contact is set to Post Count, the user will be able to fill in that field after they have reached this many posts.',
	'UCP_IG_POST_COUNT'							=> 'Instagram Contact Post Count',
	'UCP_IG_POST_COUNT_EXPLAIN'					=> 'If Instagram contact is set to Post Count, the user will be able to fill in that field after they have reached this many posts.',
	'UCP_PT_POST_COUNT'							=> 'Pinterest Contact Post Count',
	'UCP_PT_POST_COUNT_EXPLAIN'					=> 'If Pinterest contact is set to Post Count, the user will be able to fill in that field after they have reached this many posts.',
	'UCP_TWR_POST_COUNT'						=> 'Twitter Contact Post Count',
	'UCP_TWR_POST_COUNT_EXPLAIN'				=> 'If Twitter contact is set to Post Count, the user will be able to fill in that field after they have reached this many posts.',
	'UCP_SKP_POST_COUNT'						=> 'Skype Contact Post Count',
	'UCP_SKP_POST_COUNT_EXPLAIN'				=> 'If Skype contact is set to Post Count, the user will be able to fill in that field after they have reached this many posts.',
	'UCP_TG_POST_COUNT'							=> 'Telegram Contact Post Count',
	'UCP_TG_POST_COUNT_EXPLAIN'					=> 'If Telegram contact is set to Post Count, the user will be able to fill in that field after they have reached this many posts.',
	'UCP_LI_POST_COUNT'							=> 'LinkedIn Contact Post Count',
	'UCP_LI_POST_COUNT_EXPLAIN'					=> 'If LinkedIn contact is set to Post Count, the user will be able to fill in that field after they have reached this many posts.',
	'UCP_TT_POST_COUNT'							=> 'TikTok Contact Post Count',
	'UCP_TT_POST_COUNT_EXPLAIN'					=> 'If TikTok contact is set to Post Count, the user will be able to fill in that field after they have reached this many posts.',
	'UCP_DC_POST_COUNT'							=> 'Discord Contact Post Count',
	'UCP_DC_POST_COUNT_EXPLAIN'					=> 'If Discord contact is set to Post Count, the user will be able to fill in that field after they have reached this many posts.',
