...
$lang = array_merge($lang, array(
	...
	'UCP_FB_POST_COUNT'							=> 'Cantidad de mensajes para contacto de Facebook',
	'UCP_FB_POST_COUNT_EXPLAIN'					=> 'Si el contacto de Facebook está configurado por cantidad de mensajes, el usuario podrá completar ese campo después de alcanzar esta cantidad de mensajes.',
	'UCP_IG_POST_COUNT'							=> 'Cantidad de mensajes para contacto de Instagram',
	'UCP_IG_POST_COUNT_EXPLAIN'					=> 'Si el contacto de Instagram está configurado por cantidad de mensajes, el usuario podrá completar ese campo después de alcanzar esta cantidad de mensajes.',
	'UCP_PT_POST_COUNT'							=> 'Cantidad de mensajes para contacto de Pinterest',
	'UCP_PT_POST_COUNT_EXPLAIN'					=> 'Si el contacto de Pinterest está configurado por cantidad de mensajes, el usuario podrá completar ese campo después de alcanzar esta cantidad de mensajes.',
	'UCP_TWR_POST_COUNT'						=> 'Cantidad de mensajes para contacto de Twitter',
	'UCP_TWR_POST_COUNT_EXPLAIN'				=> 'Si el contacto de Twitter está configurado por cantidad de mensajes, el usuario podrá completar ese campo después de alcanzar esta cantidad de mensajes.',
	'UCP_SKP_POST_COUNT'						=> 'Cantidad de mensajes para contacto de Skype',
	'UCP_SKP_POST_COUNT_EXPLAIN'				=> 'Si el contacto de Skype está configurado por cantidad de mensajes, el usuario podrá completar ese campo después de alcanzar esta cantidad de mensajes.',
	'UCP_TG_POST_COUNT'							=> 'Cantidad de mensajes para contacto de Telegram',
	'UCP_TG_POST_COUNT_EXPLAIN'					=> 'Si el contacto de Telegram está configurado por cantidad de mensajes, el usuario podrá completar ese campo después de alcanzar esta cantidad de mensajes.',
	'UCP_LI_POST_COUNT'							=> 'Cantidad de mensajes para contacto de LinkedIn',
	'UCP_LI_POST_COUNT_EXPLAIN'					=> 'Si el contacto de LinkedIn está configurado por cantidad de mensajes, el usuario podrá completar ese campo después de alcanzar esta cantidad de mensajes.',
	'UCP_TT_POST_COUNT'							=> 'Cantidad de mensajes para contacto de TikTok',
	'UCP_TT_POST_COUNT_EXPLAIN'					=> 'Si el contacto de TikTok está configurado por cantidad de mensajes, el usuario podrá completar ese campo después de alcanzar esta cantidad de mensajes.',
	'UCP_DC_POST_COUNT'							=> 'Cantidad de mensajes para contacto de Discord',
	'UCP_DC_POST_COUNT_EXPLAIN'					=> 'Si el contacto de Discord está configurado por cantidad de mensajes, el usuario podrá completar ese campo después de alcanzar esta cantidad de mensajes.',
