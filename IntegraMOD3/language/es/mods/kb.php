...
$lang = array_merge($lang, array(
	...
	'POST_MESSAGE_DESC'		=> '{TITLE} = Article title <br />{DESCRIPTION} = Article description<br />{POST_TIME} = Time when writing<br />{TYPE} = Article type<br />{SUB_CAT} = Category<br />{URL} = URL to article<br />{AUTHOR} = Autor of article<br />{AUTHOR_ID} = User-ID of author.',
	'RELASED'				=> 'Released on',
