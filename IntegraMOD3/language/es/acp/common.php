...
$lang = array_merge($lang, array(
	...
	'ACP_CAT_FILES'			=> 'Archivos',	
	'ACP_CAT_FORUMS'		=> 'Foros',
	'ACP_CAT_GENERAL'		=> 'General',
	'ACP_CAT_KB'				=> 'Knowlege Base',		
...
$lang = array_merge($lang, array(
	...
	'ACP_CALENDAR_MOD'								=> 'Calendario',
	'ACP_CALENDAR_SETTINGS'							=> 'Configuración del Calendario',
	'ACP_CALENDAR_USERS'							=> 'Ajustes del Calendario de Usuario',
	'ACP_CAT_DIGESTS'								=> 'Resúmenes',
	'ACP_IMOD'										=> 'IntegraMOD',
	'ACP_CAT_KB'									=> 'Base de Conocimientos',
	'ACP_FILE_BACKUP'								=> 'Copia de Seguridad de Archivos',
	'LOG_CONFIG_DIGEST_BAD_DATE_PARAM'				=> '<strong>Excepción de resumen: Se encontró un parámetro de fecha de URL incorrecto de "%s". Debe expresarse como una fecha ISO-8601, es decir, en formato AAAA-MM-DD.</strong>',
	'LOG_CONFIG_DIGEST_BAD_DIGEST_TYPE'				=> '<strong>Excepción de resumen: Se encontró un tipo de resumen incorrecto de "%s"</strong>',
	'LOG_CONFIG_DIGEST_BAD_HOUR_PARAM'				=> '<strong>Excepción de resumen: Se encontró un parámetro de hora de URL incorrecto de "%s". Debe ser un número entero entre 0 y 23.</strong>',
	'LOG_CONFIG_DIGEST_BAD_KEY_VALUE'				=> '<strong>Al ejecutar mail_digests.php, el parámetro "key" proporcionado tenía un valor no válido de "%s". Programa finalizado.</strong>',
	'LOG_CONFIG_DIGEST_BOARD_DISABLED'				=> '<strong>Se intentó ejecutar mail_digests.php, pero se detuvo porque el sitio está deshabilitado.</strong>',
	'LOG_CONFIG_DIGEST_EDIT_SUBSCRIBERS'			=> '<strong>Suscriptores del resumen editados</strong>',
	'LOG_CONFIG_DIGEST_GENERAL'						=> '<strong>Configuraciones generales del resumen alteradas</strong>',
	'LOG_CONFIG_DIGEST_LOG'							=> '<strong>Configuraciones de registro del resumen alteradas</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_BAD'				=> '<strong>No se pudo enviar un resumen a %s (%s)</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_BAD_NO_EMAIL'		=> '<strong>No se pudo enviar un resumen a %s</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_GOOD'				=> '<strong>Se envió un resumen a %s (%s) que contiene %s mensajes y %s mensajes privados</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_GOOD_NO_EMAIL'		=> '<strong>Se envió un resumen a %s que contiene %s mensajes y %s mensajes privados</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_NONE'				=> '<strong>NO se envió un resumen a %s (%s) porque sus filtros y preferencias indicaron que no había nada que enviar</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_NONE_NO_EMAIL'		=> '<strong>NO se envió un resumen a %s porque sus filtros y preferencias indicaron que no había nada que enviar</strong>',
	'LOG_CONFIG_DIGEST_LOG_EMAILED'					=> '<strong>Todos los resúmenes de esta hora han sido enviados por correo electrónico</strong>',
	'LOG_CONFIG_DIGEST_LOG_START'					=> '<strong>Iniciando mail_digests.php</strong>',
	'LOG_CONFIG_DIGEST_LOG_END'						=> '<strong>Finalizando mail_digests.php</strong>',
	'LOG_CONFIG_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE'	=> '<strong>Se ejecutó una acción de suscripción o cancelación de suscripción masiva a resúmenes</strong>',
	'LOG_CONFIG_DIGEST_NEED_TWO_PARAMS'				=> '<strong>Excepción de resumen: Se deben especificar un parámetro de fecha y uno de hora para una ejecución irregular de mail_digests.php. Solo se proporcionó uno de estos.</strong>',
	'LOG_CONFIG_DIGEST_NO_BOOKMARKS'				=> '<strong>Excepción de resumen: "%s" solicitó un resumen de los temas marcados como favoritos, pero no tiene ninguno</strong>',
	'LOG_CONFIG_DIGEST_NO_ALLOWED_FORUMS'			=> '<strong>Excepción de resumen: El usuario "%s" no puede acceder a ningún foro, por lo que no se puede crear un resumen</strong>',
	'LOG_CONFIG_DIGEST_NOT_ENABLED'					=> '<strong>Los resúmenes no están habilitados actualmente, por lo que no se enviaron resúmenes durante esta hora.</strong>',
	'LOG_CONFIG_DIGEST_SEND_MASS_EMAIL_ERROR'		=> '<strong>No se pudo enviar un correo electrónico de suscripción/cancelación masiva de resúmenes a %s</strong>',
	'LOG_CONFIG_DIGEST_USER_DEFAULTS'				=> '<strong>Se alteraron los valores predeterminados de usuario del resumen</strong>',
	'LOG_CONFIG_DIGEST_WRITE_LOG_ENTRY_ERROR'		=> '<strong>Excepción de resumen: write_log_entry se invocó con un tipo no compatible de "%s"</strong>',
	'LOG_FILE_BACKUP'								=> '<strong>Copia de Seguridad de Archivos</strong><br />',
	'ACP_DIGEST_SETTINGS'							=> 'Configuración de Resumen',
	'ACP_DIGEST_GENERAL_SETTINGS'					=> 'Configuración general',
	'ACP_DIGEST_GENERAL_SETTINGS_EXPLAIN'			=> 'Estas son las configuraciones generales del resumen.',
	'ACP_DIGEST_USER_DEFAULT_SETTINGS'				=> 'Valores predeterminados de usuario',
	'ACP_DIGEST_USER_DEFAULT_SETTINGS_EXPLAIN'		=> 'Esta configuración permite a los administradores fijar las preferencias predeterminadas que los usuarios verán al suscribirse a un resumen.',
	'ACP_DIGEST_EDIT_SUBSCRIBERS'					=> 'Editar suscriptores',
	'ACP_DIGEST_EDIT_SUBSCRIBERS_EXPLAIN'			=> 'Esta interfaz permite ver quién está o no recibiendo un resumen. Puedes suscribir a los miembros selectivamente, dar de baja de forma selectiva a los miembros, editar todos los detalles de los resúmenes de usuarios individuales. También puedes efectuar altas predeterminadas o bajas a todos los usuarios marcados en la página.',
	'ACP_DIGEST_BALANCE_LOAD'						=> 'Balance de carga',
	'ACP_DIGEST_BALANCE_LOAD_EXPLAIN'				=> 'Si demasiados resúmenes son enviados en determinadas horas debido a problemas de rendimiento, esto nivelará las suscripciones al resumen para enviar una cantidad proporcional por cada hora.',
	'ACP_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE'			=> 'Suscripción / Cancelación masiva',
	'ACP_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE_EXPLAIN'	=> 'Esta función permite a los administradores suscribirse o darse de baja convenientemente a todos los miembros de tu foro de una sola vez. Los ajustes predeterminados del resumen se utilizan para suscribir a los miembros. Si un usuario ya tiene una suscripción al resumen mantendrá la configuración de dicho resumen.',
	'LOG_DELETED_CALENDAR_EVENT'					=> '<strong>Evento del Calendario Eliminado</strong><br />» %s',
	'LOG_DELETED_TOPIC_EVENT'						=> '<strong>Evento del Tema Eliminado</strong><br />» %s',
	'LOG_DELETED_CALENDAR_EVENTS'					=> '<strong>Eventos Repetidos del Calendario Eliminados</strong><br />» %s',
	'LOG_DELETED_TOPIC_EVENTS'						=> '<strong>Eventos Repetidos del Tema Eliminados</strong><br />» %s',
	'LOG_DELETED_CALENDAR_EVENT_INSTANCE'			=> '<strong>Repetida Instancia de Eventos del Calendario Eliminados</strong><br />» %s',
	'LOG_DELETED_TOPIC_EVENT_INSTANCE'				=> '<strong>Repetida Instancia de Eventos del Tema Eliminados</strong><br />» %s',
	'LOG_EDITED_CALENDAR_EVENT'						=> '<strong>Evento del Calendario Editado</strong><br />» %s',
	'LOG_EDITED_CALENDAR_EVENTS'					=> '<strong>Eventos Repetidos del Calendario Editados</strong><br />» %s',
	'LOG_EDITED_CALENDAR_EVENT_INSTANCE'			=> '<strong>Repetida Instancia de Eventos del Calendario Editada</strong><br />» %s',
	'ACP_KB'										=> 'Base de Conocimientos',
	'KB_NAME'										=> 'Base de Conocimientos',
	'ACP_KB_PERMISSIONS'							=> 'Permisos de categoría',
	'ACP_KB_ROLES'									=> 'Roles Base de Conocimientos',
	'KB_CONFIG'										=> 'Configuración',
	'TYPES'											=> 'Tipos de artículos',
	'CATEGORIES'									=> 'Categorías',
	'ACP_MODS_DATABASE'								=> 'Base de datos de Mods',
	'LOG_MOD_DELETE'								=> '<strong>Mod(s) Eliminado de la Base de datos de Mods</strong>',
	'LOG_MOD_ADDED'									=> '<strong>Mod Añadido a la Base de datos de Mods</strong>',
	'LOG_MOD_UPDATED'								=> '<strong>Mod Actualizado en la Base de datos de Mods</strong>',
	'LOG_MCHAT_TABLE_PRUNED'						=> 'Se limpió la tabla de mChat',
	'ACP_USER_MCHAT'								=> 'Ajustes del mChat',
	'LOG_DELETED_MCHAT'								=> '<strong>Eliminado el mensaje de mChat</strong><br />» %1$s',
	'LOG_EDITED_MCHAT'								=> '<strong>Editado el mensaje de mChat</strong><br />» %1$s',
));
