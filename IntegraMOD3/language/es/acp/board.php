...
$lang = array_merge($lang, array(
	...
	'PORTAL_NAME_EXPLAIN'			=> 'Establece la etiqueta predeterminada del enlace del portal.<br> Déjelo como <strong>Portal</strong> para usar la traducción estándar del archivo de idioma. Si se cambia, se pueden introducir nombres localizados para cada idioma instalado.',
	'FORUM_NAME'					=> 'Nombre del foro',
	'FORUM_NAME_EXPLAIN'			=> 'Establece la etiqueta predeterminada del enlace del foro.<br> Déjelo como <strong>Forum</strong> para usar la traducción estándar del archivo de idioma. Si se cambia, se pueden introducir nombres localizados para cada idioma instalado.',
	'LOCALIZED_NAMES'				=> 'Nombres localizados',
	'PORTAL_NAME_LANG'				=> 'Nombre del portal - %s',
	'FORUM_NAME_LANG'				=> 'Nombre del foro - %s',
...
$lang = array_merge($lang, array(
	...
	'COOKIE_DOMAIN'			        => 'Dominio de la cookie',	'COOKIE_HTTPONLY'			    => 'Cookie HTTP only',
...
$lang = array_merge($lang, array(
    ...
    'SERVER_PORT_EXPLAIN'		=> 'El puerto en el que se ejecuta su servidor, normalmente 80 para HTTP y 443 para HTTPS. Cámbielo solo si es diferente.',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED'			=> 'Permitir certificados SSL autofirmados',
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Permitir conexiones al servidor Jabber con certificado SSL autofirmado.<em><strong>Advertencia:</strong> Permitir certificados SSL autofirmados puede tener implicaciones de seguridad.</em>',
	'JAB_VERIFY_PEER'				=> 'Verificar certificado SSL',
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Requiere la verificación del certificado SSL utilizado por el servidor Jabber.<em><strong>Advertencia:</strong> Conectarse con certificados SSL no verificados puede tener implicaciones de seguridad.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Verificar nombre del peer Jabber',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Requiere la verificación del nombre del peer para servidores Jabber que usan conexiones SSL / TLS.<em><strong>Advertencia:</strong> Conectarse con peers no verificados puede tener implicaciones de seguridad.</em>',
...
// Mod links in header
$lang = array_merge($lang, array(
	'MOD_LINKS'				=> 'Seleccionar los enlaces que se mostrarán en la navegación',
	'SHOW_ACTIVITY'			=> 'Red Social',
	'SHOW_ACTIVITY_EXPLAIN'	=> 'Mostrar el enlace de la página de actividad en la navegación.',
	'SHOW_BLOG'				=> 'Blog',
	'SHOW_BLOG_EXPLAIN'		=> 'Mostrar el enlace del blog en la navegación.',
	'SHOW_KB'				=> 'Base de conocimientos',
	'SHOW_KB_EXPLAIN'		=> 'Mostrar el enlace de la base de conocimientos en la navegación.',
	'SHOW_CAL'				=> 'Calendario',
	'SHOW_CAL_EXPLAIN'		=> 'Mostrar el enlace del calendario de temas en la navegación.',
	'SHOW_GALL'				=> 'Galería',
	'SHOW_GALL_EXPLAIN'		=> 'Mostrar el enlace de la galería en la navegación.',
	'SHOW_CHT'				=> 'Chat',
	'SHOW_CHT_EXPLAIN'		=> 'Mostrar el enlace del chat en el encabezado.',
	'SHOW_DLS'				=> 'Descargas',
	'SHOW_DLS_EXPLAIN'		=> 'Mostrar el enlace de descargas en la navegación.',
	'SHOW_FAQ'				=> 'Preguntas frecuentes',
	'SHOW_FAQ_EXPLAIN'		=> 'Mostrar el enlace de preguntas frecuentes en la navegación.',
	'SHOW_MEM'				=> 'Lista de miembros',
	'SHOW_MEM_EXPLAIN'		=> 'Mostrar el enlace de la lista de miembros en la navegación.',
	'SHOW_NOTES'			=> 'Notas',
	'SHOW_NOTES_EXPLAIN'	=> 'Mostrar el enlace de notas en la navegación.',
	'SHOW_MEETING'			=> 'Reuniones',
	'SHOW_MEETING_EXPLAIN'	=> 'Mostrar el enlace de reuniones en la navegación.',
	'SHOW_CONTACT'			=> 'Contáctenos',
	'SHOW_CONTACT_EXPLAIN'	=> 'Mostrar el enlace de contacto en la navegación.',
	'SHOW_RULES'			=> 'Reglas',
	'SHOW_RULES_EXPLAIN'	=> 'Mostrar el enlace de reglas en la navegación.',
));

// Notes settings by OXPUS
$lang = array_merge($lang, array(
	'ACP_NOTES_SETTINGS'		=> 'Máx. número de notas por usuario',

	// Missing variables
	'GUEST_SESSIONS_CACHE'			=> 'Usar caché de sesiones de invitados',
	'GUEST_SESSIONS_CACHE_EXPLAIN'	=> 'Almacena las sesiones de invitados anónimos en el backend de ACM configurado en lugar de la base de datos para reducir la carga de escritura de la tabla de sesiones. Requiere includes/guest_sessions.php y un backend ACM apropiado configurado.',
	'COOKIE_CONSENT_TITLE'			=> 'Título del Consentimiento de Cookies',
	'COOKIE_CONSENT_MESSAGE'		=> 'Mensaje del Consentimiento de Cookies',
));