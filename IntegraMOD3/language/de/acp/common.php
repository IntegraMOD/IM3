...
$lang = array_merge($lang, array(
	...
	'LOG_KB_ROLE_ADD'		=> '<strong>Wissensdatenbank-Rolle hinzugefügt</strong><br />» %s',
	'LOG_KB_ROLE_EDIT'		=> '<strong>Wissensdatenbank-Rolle geändert</strong><br />» %s',
	'LOG_KB_ROLE_REMOVED'	=> '<strong>Wissensdatenbank-Rolle entfernt</strong><br />» %s',
	...
	'ACP_CALENDAR_USERS'							=> 'Kalender Benutzereinstellungen',
	'ACP_CAT_DIGESTS'								=> 'Digests',
	'ACP_IMOD'										=> 'IntegraMOD',
	'ACP_CAT_KB'									=> 'Knowledge Base',
	'ACP_FILE_BACKUP'								=> 'Datei-Backup',
	'LOG_CONFIG_DIGEST_BAD_DATE_PARAM'				=> '<strong>Digest Ausnahme: Ein ungültiger URL-Datums-Parameter "%s" wurde gefunden. Dieser muss im ISO-8601 Datumsformat angegeben werden, d.h. im Format JJJJ-MM-TT.</strong>',
	'LOG_CONFIG_DIGEST_BAD_DIGEST_TYPE'				=> '<strong>Digest Ausnahme: Ein ungültiger Digest-Typ "%s" wurde gefunden</strong>',
	'LOG_CONFIG_DIGEST_BAD_HOUR_PARAM'				=> '<strong>Digest Ausnahme: Ein ungültiger URL-Stunden-Parameter "%s" wurde gefunden. Er muss eine Ganzzahl von 0 bis 23 sein.</strong>',
	'LOG_CONFIG_DIGEST_BAD_KEY_VALUE'				=> '<strong>Beim Ausführen von mail_digests.php wies der angegebene "key" Parameter den ungültigen Wert "%s" auf. Programm beendet.</strong>',
	'LOG_CONFIG_DIGEST_BOARD_DISABLED'				=> '<strong>mail_digests.php Lauf wurde versucht, aber abgebrochen, da das Board deaktiviert ist.</strong>',
	'LOG_CONFIG_DIGEST_EDIT_SUBSCRIBERS'			=> '<strong>Digest Abonnenten geändert</strong>',
	'LOG_CONFIG_DIGEST_GENERAL'						=> '<strong>Allgemeine Digest-Einstellungen geändert</strong>',
	'LOG_CONFIG_DIGEST_LOG'							=> '<strong>Digest-Log-Einstellungen geändert</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_BAD'				=> '<strong>Senden eines Digests an %s (%s) nicht möglich</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_BAD_NO_EMAIL'		=> '<strong>Senden eines Digests an %s nicht möglich</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_GOOD'				=> '<strong>Ein Digest %s wurde an %s (%s) gesendet und enthält %s Beiträge und %s private Nachrichten</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_GOOD_NO_EMAIL'		=> '<strong>Ein Digest %s wurde an %s gesendet und enthält %s Beiträge und %s private Nachrichten</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_NONE'				=> '<strong>Ein Digest wurde NICHT an %s (%s) gesendet, da aufgrund der Benutzerfilter und Einstellungen nichts zu senden war</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_NONE_NO_EMAIL'		=> '<strong>Ein Digest wurde NICHT an %s gesendet, da aufgrund der Benutzerfilter und Einstellungen nichts zu senden war</strong>',
	'LOG_CONFIG_DIGEST_LOG_EMAILED'					=> '<strong>Alle Digests für diese Stunde wurden per E-Mail versendet</strong>',
	'LOG_CONFIG_DIGEST_LOG_START'					=> '<strong>Starte mail_digests.php</strong>',
	'LOG_CONFIG_DIGEST_LOG_END'						=> '<strong>Beende mail_digests.php</strong>',
	'LOG_CONFIG_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE'	=> '<strong>Massen-Abonnieren oder -Abbestellen von Digests durchgeführt</strong>',
	'LOG_CONFIG_DIGEST_NEED_TWO_PARAMS'				=> '<strong>Digest Ausnahme: Es müssen sowohl ein Datum als auch eine Stunde für einen außerplanmäßigen Lauf von mail_digests.php angegeben werden. Es wurde nur eines der beiden angegeben.</strong>',
	'LOG_CONFIG_DIGEST_NO_BOOKMARKS'				=> '<strong>Digest Ausnahme: Ein Digest für Lesezeichen wurde von "%s" angefordert, aber der Benutzer hat keine Lesezeichen gesetzt</strong>',
	'LOG_CONFIG_DIGEST_NO_ALLOWED_FORUMS'			=> '<strong>Digest Ausnahme: Benutzer "%s" kann auf keine Foren zugreifen, daher kann kein Digest erstellt werden</strong>',
	'LOG_CONFIG_DIGEST_NOT_ENABLED'					=> '<strong>Digests sind momentan nicht aktiviert, deshalb wurden diesen Stunde keine Digests versendet.</strong>',
	'LOG_CONFIG_DIGEST_SEND_MASS_EMAIL_ERROR'		=> '<strong>Senden der Digest Massen-Benachrichtigung (Anmeldung/Abmeldung) an %s fehlgeschlagen</strong>',
	'LOG_CONFIG_DIGEST_USER_DEFAULTS'				=> '<strong>Digest Benutzer-Standardeinstellungen geändert</strong>',
	'LOG_CONFIG_DIGEST_WRITE_LOG_ENTRY_ERROR'		=> '<strong>Digest Ausnahme: write_log_entry wurde mit dem unbehandelten Typ "%s" aufgerufen</strong>',
	'LOG_FILE_BACKUP'								=> '<strong>Datei-Backup</strong><br />',
	'ACP_DIGEST_SETTINGS'							=> 'Digest-Einstellungen',
	'ACP_DIGEST_GENERAL_SETTINGS'					=> 'Allgemeine Einstellungen',
	'ACP_DIGEST_GENERAL_SETTINGS_EXPLAIN'			=> 'Dies sind die allgemeinen Digest-Einstellungen.',
	'ACP_DIGEST_USER_DEFAULT_SETTINGS'				=> 'Benutzer-Standardeinstellungen',
	'ACP_DIGEST_USER_DEFAULT_SETTINGS_EXPLAIN'		=> 'Mit diesen Einstellungen können Administratoren die Standards vorgeben, welche die Benutzer bei der Anmeldung zu einem Digest sehen.',
	'ACP_DIGEST_EDIT_SUBSCRIBERS'					=> 'Abonnenten bearbeiten',
	'ACP_DIGEST_EDIT_SUBSCRIBERS_EXPLAIN'			=> 'Diese Oberfläche bietet eine Übersicht darüber, wer Digests empfängt und wer nicht. Du kannst selektiv Anmeldungen hinzufügen, selektiv Mitglieder abmelden und die gesamten Details einzelner Abonnenten bearbeiten. Zudem kannst du auf dieser Seite für alle markierten Benutzer Abmeldungen oder Neuanmeldungen nach Standardvorgabe durchführen.',
	'ACP_DIGEST_BALANCE_LOAD'						=> 'Lastverteilung',
	'ACP_DIGEST_BALANCE_LOAD_EXPLAIN'				=> 'Falls bedingt durch zu viele gleichzeitige Digest-Versendungen Performanceprobleme auftauchen, wird hiermit die Versuchslast so verteilt, dass zu jeder Stunde ungefähr dieselbe Menge verschickt wird.',
	'ACP_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE'			=> 'Massenanmeldung/-abmeldung',
	'ACP_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE_EXPLAIN'	=> 'Diese Funktion ermöglicht es dem Admin, Benutzern Digests im Massenbetrieb ein- bzw. auszuschalten. Für Neuanmeldungen werden die Digest-Standardeinstellungen genutzt. Falls bereits Digests für einen Nutzer aktiviert sind, bleiben die bestehenden Konfigurationen erhalten.',
	'LOG_DELETED_CALENDAR_EVENT'					=> '<strong>Kalenderevent gelöscht</strong><br />» %s',
	'LOG_DELETED_TOPIC_EVENT'						=> '<strong>Themenevent gelöscht</strong><br />» %s',
	'LOG_DELETED_CALENDAR_EVENTS'					=> '<strong>Wiederholte Kalenderevents gelöscht</strong><br />» %s',
	'LOG_DELETED_TOPIC_EVENTS'						=> '<strong>Wiederholte Themenevents gelöscht</strong><br />» %s',
	'LOG_DELETED_CALENDAR_EVENT_INSTANCE'			=> '<strong>Wiederholte Instanz von Kalenderevents gelöscht</strong><br />» %s',
	'LOG_DELETED_TOPIC_EVENT_INSTANCE'				=> '<strong>Wiederholte Instanz von Kalenderevents gelöscht</strong><br />» %s',
	'LOG_EDITED_CALENDAR_EVENT'						=> '<strong>Kalenderevent geändert</strong><br />» %s',
	'LOG_EDITED_CALENDAR_EVENTS'					=> '<strong>Wiederholte Kalenderevents geändert</strong><br />» %s',
	'LOG_EDITED_CALENDAR_EVENT_INSTANCE'			=> '<strong>Wiederholte Instanz von Kalenderevents geändert</strong><br />» %s',
	'ACP_KB'										=> 'Knowledge Base',
	'KB_NAME'										=> 'Knowledge Base',
	'ACP_KB_PERMISSIONS'							=> 'Kategorie-Berechtigungen',
	'ACP_KB_ROLES'									=> 'Knowledge Base Rollen',
	'KB_CONFIG'										=> 'Konfiguration',
	'TYPES'											=> 'Artikeltypen',
	'CATEGORIES'									=> 'Kategorien',
	'ACP_MODS_DATABASE'								=> 'Mods Datenbank',
	'LOG_MOD_DELETE'								=> '<strong>Mod(s) in Mods Datenbank gelöscht</strong>',
	'LOG_MOD_ADDED'									=> '<strong>Mod in Mods Datenbank hinzugefügt</strong>',
	'LOG_MOD_UPDATED'								=> '<strong>Mod in Mods Datenbank aktualisiert</strong>',
	'LOG_MCHAT_TABLE_PRUNED'						=> 'mChat Tabelle wurde bereinigt',
	'ACP_USER_MCHAT'								=> 'mChat Einstellungen',
