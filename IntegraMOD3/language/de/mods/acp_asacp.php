...
$lang = array_merge($lang, array(
	...
	'UCP_FB_POST_COUNT'							=> 'Facebook-Kontakt Beitragsanzahl',
	'UCP_FB_POST_COUNT_EXPLAIN'					=> 'Wenn der Facebook-Kontakt auf Beitragsanzahl eingestellt ist, kann der Benutzer dieses Feld ausfüllen, nachdem er diese Anzahl an Beiträgen erreicht hat.',
	'UCP_IG_POST_COUNT'							=> 'Instagram-Kontakt Beitragsanzahl',
	'UCP_IG_POST_COUNT_EXPLAIN'					=> 'Wenn der Instagram-Kontakt auf Beitragsanzahl eingestellt ist, kann der Benutzer dieses Feld ausfüllen, nachdem er diese Anzahl an Beiträgen erreicht hat.',
	'UCP_PT_POST_COUNT'							=> 'Pinterest-Kontakt Beitragsanzahl',
	'UCP_PT_POST_COUNT_EXPLAIN'					=> 'Wenn der Pinterest-Kontakt auf Beitragsanzahl eingestellt ist, kann der Benutzer dieses Feld ausfüllen, nachdem er diese Anzahl an Beiträgen erreicht hat.',
	'UCP_TWR_POST_COUNT'						=> 'Twitter-Kontakt Beitragsanzahl',
	'UCP_TWR_POST_COUNT_EXPLAIN'				=> 'Wenn der Twitter-Kontakt auf Beitragsanzahl eingestellt ist, kann der Benutzer dieses Feld ausfüllen, nachdem er diese Anzahl an Beiträgen erreicht hat.',
	'UCP_SKP_POST_COUNT'						=> 'Skype-Kontakt Beitragsanzahl',
	'UCP_SKP_POST_COUNT_EXPLAIN'				=> 'Wenn der Skype-Kontakt auf Beitragsanzahl eingestellt ist, kann der Benutzer dieses Feld ausfüllen, nachdem er diese Anzahl an Beiträgen erreicht hat.',
	'UCP_TG_POST_COUNT'							=> 'Telegram-Kontakt Beitragsanzahl',
	'UCP_TG_POST_COUNT_EXPLAIN'					=> 'Wenn der Telegram-Kontakt auf Beitragsanzahl eingestellt ist, kann der Benutzer dieses Feld ausfüllen, nachdem er diese Anzahl an Beiträgen erreicht hat.',
	'UCP_LI_POST_COUNT'							=> 'LinkedIn-Kontakt Beitragsanzahl',
	'UCP_LI_POST_COUNT_EXPLAIN'					=> 'Wenn der LinkedIn-Kontakt auf Beitragsanzahl eingestellt ist, kann der Benutzer dieses Feld ausfüllen, nachdem er diese Anzahl an Beiträgen erreicht hat.',
	'UCP_TT_POST_COUNT'							=> 'TikTok-Kontakt Beitragsanzahl',
	'UCP_TT_POST_COUNT_EXPLAIN'					=> 'Wenn der TikTok-Kontakt auf Beitragsanzahl eingestellt ist, kann der Benutzer dieses Feld ausfüllen, nachdem er diese Anzahl an Beiträgen erreicht hat.',
	'UCP_DC_POST_COUNT'							=> 'Discord-Kontakt Beitragsanzahl',
	'UCP_DC_POST_COUNT_EXPLAIN'					=> 'Wenn der Discord-Kontakt auf Beitragsanzahl eingestellt ist, kann der Benutzer dieses Feld ausfüllen, nachdem er diese Anzahl an Beiträgen erreicht hat.',
