...
$lang = array_merge($lang, array(
	...
	'BASIC_RULES' 			=> "<h2>Unsere Community wird moderiert, jedoch können Moderatoren nicht jeden Beitrag sofort prüfen.<br>
                                Alle Inhalte spiegeln die Ansichten der jeweiligen Autoren wider, nicht die des Forum-Teams oder der Betreiber.<br>

                                Mit Ihrer Teilnahme erklären Sie sich damit einverstanden, keine beleidigenden, obszönen, vulgären, verleumderischen, hasserfüllten, 
                                bedrohlichen, belästigenden oder sexuell expliziten Inhalte zu veröffentlichen sowie keine Inhalte, die gegen geltendes Recht verstoßen. 
                                Verstöße können zu Verwarnungen, vorübergehenden Sperren oder einem dauerhaften Ausschluss aus der Community führen. 
                                IP-Adressen von Beiträgen werden zur Durchsetzung dieser Regeln protokolliert.<br><br>

                                Sie erkennen an, dass das Forum-Team Inhalte bearbeiten, verschieben oder entfernen oder Diskussionen schließen kann, 
                                wenn dies notwendig ist, um eine sichere und konstruktive Umgebung zu gewährleisten. 
                                Informationen, die Sie während der Registrierung oder bei Profilaktualisierungen angeben, können in unserer Datenbank gespeichert werden. 
                                Obwohl wir Ihre persönlichen Daten ohne Ihre Zustimmung nicht weitergeben, ist kein Online-System vollständig vor Sicherheitsverletzungen geschützt.<br><br>

                                Dieses Forum verwendet Cookies, um Ihr Nutzungserlebnis zu verbessern. Cookies enthalten keine persönlichen Daten, 
                                die Sie angegeben haben; sie dienen lediglich dazu, Sitzungsdaten und Einstellungen zu speichern. 
                                Ihre E-Mail-Adresse wird für die Konto­bestätigung, die Passwort­wiederherstellung und optionale Benachrichtigungen über Aktivitäten 
                                in von Ihnen verfolgten Themen verwendet.<br><br>

                                Die Community-Richtlinien können gelegentlich aktualisiert werden. Bitte prüfen Sie sie regelmäßig, um auf dem neuesten Stand zu bleiben.</h2>",
