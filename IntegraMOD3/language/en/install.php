...
$lang = array_merge($lang, array(
    ...
    'CACHE_STORE_EXPLAIN'		=> 'The physical location where data is cached. File-based cache is simple and reliable; memcache/memcached and redis provide faster in-memory caching across processes or servers.',
    'CACHE_EACCELERATOR' => 'eAccelerator',
    'CACHE_FILE' => 'File (default)',
    ...
    'CACHE_XCACHE' => 'XCache',
    'CACHE_MEMORY' => 'Memory (process only)',
    'CACHE_NULL' => 'No cache',
    'CACHE_FILE_EXPLAIN' => 'File cache stores cached data on disk under the store/ directory. It is simple and reliable but slower than in-memory systems.',
    'CACHE_MEMCACHE_EXPLAIN' => 'Memcache (php ext) provides fast distributed in-memory caching. Requires memcache extension and a memcached server.',
    'CACHE_MEMCACHED_EXPLAIN' => 'Memcached (php ext) offers high-performance distributed memory object caching. Requires memcached extension and server.',
    'CACHE_REDIS_EXPLAIN' => 'Redis is an advanced in-memory data store with persistence and rich data types. Requires redis extension and redis server.',
    'CACHE_APC_EXPLAIN' => 'APC/APCu provides local shared memory caching inside PHP processes. Good for single-server setups.',
    'CACHE_WINCACHE_EXPLAIN' => 'WinCache is a PHP opcode and data cache available on Windows-based hosts.',
    'CACHE_XCACHE_EXPLAIN' => 'XCache is an opcode cache that can also store user data in shared memory.',
    'CACHE_EACCELERATOR_EXPLAIN' => 'eAccelerator provides opcode caching and user cache; outdated but present on some systems.',
    'CACHE_MEMORY_EXPLAIN' => 'Memory cache stores data in-process only; fast but not shared between processes or servers.',
	'CAT_CONVERT'				=> 'Convert',
	'CAT_INSTALL'				=> 'Install',
	...
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Required</strong> - You must be running at least version 7.0 of PHP in order to install IntegraMOD. If <var>safe mode</var> is displayed below your PHP installation is running in that mode. This will impose limitations on remote administration and similar features.',
...
$lang = array_merge($lang, array(
	...
	'TOPICS_TOPIC_TITLE'			=> 'Welcome to IntegraMOD',
));