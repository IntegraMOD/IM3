...
$lang = array_merge($lang, array(
	...
	// Begin Digests Mod
	'LOG_CONFIG_DIGEST_BAD_DATE_PARAM'			=> '<strong>Digest exception: A bad URL date parameter of "%s" was encountered. This must be expressed as an ISO-8601 date, i.e. in a YYYY-MM-DD format.</strong>',
	'LOG_CONFIG_DIGEST_BAD_DIGEST_TYPE'			=> '<strong>Digest exception: A bad digest type of "%s" was encountered</strong>',
	'LOG_CONFIG_DIGEST_BAD_HOUR_PARAM'			=> '<strong>Digest exception: A bad URL hour parameter of "%s" was encountered. This must be an integer from 0 to 23.</strong>',
	...
	'LOG_CONFIG_DIGEST_EDIT_SUBSCRIBERS'		=> '<strong>Edited Digest subscribers</strong>',
	...
	'LOG_CONFIG_DIGEST_LOG_ENTRY_BAD_NO_EMAIL'	=> '<strong>Unable to send a digest to %s</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_GOOD'			=> '<strong>A digest was %s %s (%s) containing %s posts and %s private messages</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_GOOD_NO_EMAIL'		=> '<strong>A digest was %s %s containing %s posts and %s private messages</strong>',
	...
	'LOG_CONFIG_DIGEST_LOG_ENTRY_NONE_NO_EMAIL'	=> '<strong>A digest was NOT sent to %s because user filters and preferences meant there was nothing to send</strong>',
	'LOG_CONFIG_DIGEST_LOG_EMAILED'				=> '<strong>All digests for this hour have been e-mailed</strong>',
	...
	'LOG_CONFIG_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE'	=> '<strong>Executed a digests mass subscribe or unsubscribe action</strong>',
	'LOG_CONFIG_DIGEST_NEED_TWO_PARAMS'			=> "<strong>Digest exception: Both a date and an hour parameter must be specified for an irregular run of mail_digests.$phpEx Only one of these was provided.</strong>",
	...
	'LOG_CONFIG_DIGEST_NOT_ENABLED'				=> '<strong>Digests are currently not enabled, so no digests were sent for this hour.</strong>',
	'LOG_CONFIG_DIGEST_SEND_MASS_EMAIL_ERROR'	=> '<strong>Unable to send digest mass suscribe/unsubscribe email to %s</strong>',
	...
	'LOG_FILE_BACKUP'			=> '<strong>File backup</strong><br />',
	...
	'LOG_KB_ROLE_ADD'		=> '<strong>Knowledge Base role added</strong><br />» %s',
	'LOG_KB_ROLE_EDIT'		=> '<strong>Knowledge Base role edited</strong><br />» %s',
	'LOG_KB_ROLE_REMOVED'	=> '<strong>Knowledge Base role removed</strong><br />» %s',
...
$lang = array_merge($lang, array(
	...
	'ACP_DIGEST_EDIT_SUBSCRIBERS'				=> 'Edit subscribers',
	'ACP_DIGEST_EDIT_SUBSCRIBERS_EXPLAIN'		=> 'This interface allows you to see who is or is not receiving digests. You can selectively add digest subscriptions, selectively unsubscribe members, and edit all digest details of individual subscribers. You can also subscribe with defaults or unsubscribe all marked users on the page.',
	'ACP_DIGEST_BALANCE_LOAD'					=> 'Balance load',
	'ACP_DIGEST_BALANCE_LOAD_EXPLAIN'			=> 'If too many digests going out at certain hours are causing performance issues, this will rebalance digest subscriptions so that roughly the same number of digests are sent for each hour. The table below shows the current number of digest subscribers for each hour, with the hour based on the digest hour set in Digest general settings. This function updates digest send hours minimally. Changes occur only on those hours where the number of subscribers exceeds the average load, and only for subscribers that exceed the hourly average for that hour. <strong>Caution</strong>: subscribers may be upset that their subscription times were changed.',
	'ACP_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE'		=> 'Mass subscribe/unsubscribe',
...
//---BEGIN CALENDAR MOD---
$lang = array_merge($lang, array(
    'LOG_DELETED_CALENDAR_EVENT'            => '<strong>Deleted Calendar Event</strong><br />» %s',
    'LOG_DELETED_TOPIC_EVENT'               => '<strong>Deleted Topic Event</strong><br />» %s',
    'LOG_DELETED_CALENDAR_EVENTS'           => '<strong>Deleted Repeat Calendar Events</strong><br />» %s',
    'LOG_DELETED_TOPIC_EVENTS'              => '<strong>Deleted Repeat Topic Events</strong><br />» %s',
    'LOG_DELETED_CALENDAR_EVENT_INSTANCE'   => '<strong>Deleted Repeated Instance Of Calendar Events</strong><br />» %s',
    'LOG_DELETED_TOPIC_EVENT_INSTANCE'      => '<strong>Deleted Repeated Instance Of Calendar Events</strong><br />» %s',
    'LOG_EDITED_CALENDAR_EVENT'             => '<strong>Edited Calendar Event</strong><br />» %s',
    'LOG_EDITED_CALENDAR_EVENTS'            => '<strong>Edited Repeat Calendar Events</strong><br />» %s',
    'LOG_EDITED_CALENDAR_EVENT_INSTANCE'    => '<strong>Edited Repeated Instance Of Calendar Events</strong><br />» %s',
));
//---END CALENDAR MOD---
...
$lang = array_merge($lang, array(
	...
	'LOG_MOD_DELETE'			=> '<strong>Deleted Mod(s) in Mods Database</strong>',
	'LOG_MOD_ADDED'				=> '<strong>Added Mod in Mods Database</strong>',
	'LOG_MOD_UPDATED'			=> '<strong>Updated Mod in Mods Database</strong>',
));
