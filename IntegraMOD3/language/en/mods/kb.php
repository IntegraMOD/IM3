...
$lang = array_merge($lang, array(
	...
	'ARTICLE_TITLE'				=> 'Title',
	'ARTICLE_TITLE_LANG_EXPLAIN'	=> 'To use a localized catalog string, enter the whole field as {L_KEY}. Keys live in language/{iso}/kb/articles.php. Save that PHP file as UTF-8 without BOM (Notepad++: Encoding → Convert to UTF-8 without BOM, then Save). Windows Notepad can add a BOM and crash the board with a headers-already-sent error. Normal titles are stored as typed.',
	'ARTICLE_DESCRIPTION'		=> 'Description',
	'ARTICLE_DESCRIPTION_LANG_EXPLAIN'	=> 'Optional. Use {L_KEY} for a localized description, or leave as normal text. Catalog files must be saved as UTF-8 without BOM.',
	'ARTICLE_LANG_EXPLAIN'		=> 'To localize the article body, enter only {L_KEY} in this field. Otherwise write the article as usual. Edit language/{iso}/kb/articles.php in Notepad++ or another editor that can save UTF-8 without BOM. Do not use Windows Notepad.',
	'KB_LANG_KEY_MISSING'		=> 'The language key %s was not found in language/en/kb/articles.php.',
	'ARTICLE'					=> 'Article',
	...
	'NO_CAT'					=> 'The selected category does not exist.',
