...
$lang = array_merge($lang, array(
    ...
    'USER_PUSH_BROWSER_LOADING'	=> 'Loading desktop notifications...',
    'USER_PUSH_BROWSER_BLOCKED'	=> 'The notification service (cdn.onesignal.com) was blocked by your browser or an extension such as DuckDuckGo Privacy Essentials, uBlock Origin, AdGuard, Brave Shields or Firefox strict tracking protection. Allow it for this site, then',
    'USER_PUSH_BROWSER_RETRY'	=> 'retry',
    'USER_PUSH_BROWSER_DENIED'	=> 'Notifications are blocked for this site in your browser settings.',
    'USER_PUSH_BROWSER_UNSUPPORTED'	=> 'Desktop notifications are not supported in this browser.',
    'USER_PUSH_BROWSER_NOT_CONFIGURED'	=> 'Push notifications are not configured.',
    'USER_PUSH_BROWSER_ERROR'	=> 'Desktop notifications failed to initialize: %s',
