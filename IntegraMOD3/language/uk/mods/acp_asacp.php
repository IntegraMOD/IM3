...
$lang = array_merge($lang, array(
	...
	'UCP_FB_POST_COUNT'							=> 'Кількість повідомлень для контакту Facebook',
	'UCP_FB_POST_COUNT_EXPLAIN'					=> 'Якщо контакт Facebook встановлено за кількістю повідомлень, користувач зможе заповнити це поле після досягнення вказаної кількості повідомлень.',
	'UCP_IG_POST_COUNT'							=> 'Кількість повідомлень для контакту Instagram',
	'UCP_IG_POST_COUNT_EXPLAIN'					=> 'Якщо контакт Instagram встановлено за кількістю повідомлень, користувач зможе заповнити це поле після досягнення вказаної кількості повідомлень.',
	'UCP_PT_POST_COUNT'							=> 'Кількість повідомлень для контакту Pinterest',
	'UCP_PT_POST_COUNT_EXPLAIN'					=> 'Якщо контакт Pinterest встановлено за кількістю повідомлень, користувач зможе заповнити це поле після досягнення вказаної кількості повідомлень.',
	'UCP_TWR_POST_COUNT'						=> 'Кількість повідомлень для контакту Twitter',
	'UCP_TWR_POST_COUNT_EXPLAIN'				=> 'Якщо контакт Twitter встановлено за кількістю повідомлень, користувач зможе заповнити це поле після досягнення вказаної кількості повідомлень.',
	'UCP_SKP_POST_COUNT'						=> 'Кількість повідомлень для контакту Skype',
	'UCP_SKP_POST_COUNT_EXPLAIN'				=> 'Якщо контакт Skype встановлено за кількістю повідомлень, користувач зможе заповнити це поле після досягнення вказаної кількості повідомлень.',
	'UCP_TG_POST_COUNT'							=> 'Кількість повідомлень для контакту Telegram',
	'UCP_TG_POST_COUNT_EXPLAIN'					=> 'Якщо контакт Telegram встановлено за кількістю повідомлень, користувач зможе заповнити це поле після досягнення вказаної кількості повідомлень.',
	'UCP_LI_POST_COUNT'							=> 'Кількість повідомлень для контакту LinkedIn',
	'UCP_LI_POST_COUNT_EXPLAIN'					=> 'Якщо контакт LinkedIn встановлено за кількістю повідомлень, користувач зможе заповнити це поле після досягнення вказаної кількості повідомлень.',
	'UCP_TT_POST_COUNT'							=> 'Кількість повідомлень для контакту TikTok',
	'UCP_TT_POST_COUNT_EXPLAIN'					=> 'Якщо контакт TikTok встановлено за кількістю повідомлень, користувач зможе заповнити це поле після досягнення вказаної кількості повідомлень.',
	'UCP_DC_POST_COUNT'							=> 'Кількість повідомлень для контакту Discord',
	'UCP_DC_POST_COUNT_EXPLAIN'					=> 'Якщо контакт Discord встановлено за кількістю повідомлень, користувач зможе заповнити це поле після досягнення вказаної кількості повідомлень.',
