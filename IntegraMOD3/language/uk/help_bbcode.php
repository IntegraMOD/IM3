...
$help = array(
	...
	array(
		...
		1 => 'Тепер ви можете приєднувати файли в будь-якому місці повідомлення за допомогою нового коду BBCode: <strong>[attachment=][/attachment]</strong> , якщо цю функцію увімкнено адміністратором та вам надано відповідні права для приєднання файлів. Приєднання файлів можливе за допомогою відповідного поля, яке знаходиться під формою відправки повідомлення.'
	),
	array(
		0 => '--',
		1 => 'Інше'
