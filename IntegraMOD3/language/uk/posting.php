...
$lang = array_merge($lang, array(
	...
	'BBCODE_I_HELP'  => 'Курсивний текст: [i]текст[/i]',
	'BBCODE_L_HELP'  => 'Список: [list][*]текст[/list]',
	'BBCODE_LISTITEM_HELP'		=> 'Елемент списку: [*]текст',
	'BBCODE_O_HELP'  => 'Впорядкований список: [list=1][*]Перший пункт[/list] або [list=a][*]Пункт a[/list]',
	'BBCODE_P_HELP'  => 'Вставити зображення: [img]http://url_зображення[/img]',
	...
	'BBCODE_W_HELP'  => 'Вставити URL: [url]http://url[/url] чи [url=http://url]URL text[/url]',
