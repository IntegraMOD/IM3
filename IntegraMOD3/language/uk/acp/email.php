...
$lang = array_merge($lang, array(
	'ACP_MASS_EMAIL_EXPLAIN'		=> 'Тут ви можете відправити e-mail повідомлення усім користувачам або користувачам конкретної групи, <strong>в котрих увімкнено функцію отримання масових розсилань e-mail</strong>. Для цього повідомлення e-mail буде надіслано на вказану адміністративну адресу e-mail, з BCC усім користувачам. Значення за замовчуванням - 20 користувачів для такого листа e-mail, для більшої кількості користувачів буде відіслано більше листів e-mail. Якщо ви надсилаєте листа великій групі, будь-ласка, будьте терпеливі і не зупиняйте процес відправки до його повного завершення. Довготривале відправлення є нормальним для масової розсилки, вас буде повідомлено про завершення даної операції.',
