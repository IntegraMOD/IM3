...
$lang = array_merge($lang, array(
	...
	'ACP_PUSH_SETTINGS'	     => 'Налаштування push-сповіщень',
	'ACP_PUSH_SEND'	         => 'Надіслати push-сповіщення',
...
$lang = array_merge($lang, array(
   ...
   'LOG_IMAGE_GENERATION_ERROR' => '<strong>Помилка під час створення зображення</strong><br />» Помилка в %1$s у рядку %2$s:%3$s',
	...
	'LOG_KB_ROLE_ADD'	=> '<strong>Додано роль бази знань</strong><br />» %s',
	'LOG_KB_ROLE_EDIT'	=> '<strong>Змінено роль бази знань</strong><br />» %s',
	'LOG_KB_ROLE_REMOVED'	=> '<strong>Видалено роль бази знань</strong><br />» %s',
	...
	// Missing variables
	'ACP_CALENDAR'									=> 'Календар',
	'ACP_CALENDAR_MOD'								=> 'Календар',
	'ACP_CALENDAR_SETTINGS'							=> 'Налаштування календаря',
	'ACP_CALENDAR_USERS'							=> 'Налаштування календаря користувача',
	'ACP_CAT_DIGESTS'								=> 'Дайджести',
	'ACP_IMOD'										=> 'IntegraMOD',
	'ACP_CAT_KB'									=> 'База Знань',
	'ACP_FILE_BACKUP'								=> 'Резервне копіювання файлів',
	'LOG_CONFIG_DIGEST_BAD_DATE_PARAM'				=> '<strong>Виняток дайджесту: Знайдений невірний параметр дати в URL "%s". Він повинен бути формату ISO-8601, тобто РРРР-ММ-ДД.</strong>',
	'LOG_CONFIG_DIGEST_BAD_DIGEST_TYPE'				=> '<strong>Виняток дайджесту: Знайдений невірний тип дайджесту "%s"</strong>',
	'LOG_CONFIG_DIGEST_BAD_HOUR_PARAM'				=> '<strong>Виняток дайджесту: Знайдений невірний параметр години в URL "%s". Це має бути ціле число від 0 до 23.</strong>',
	'LOG_CONFIG_DIGEST_BAD_KEY_VALUE'				=> '<strong>Під час виконання mail_digests.php параметр "key" мав недійсне значення "%s". Роботу програми завершено.</strong>',
	'LOG_CONFIG_DIGEST_BOARD_DISABLED'				=> '<strong>Виконання mail_digests.php було розпочато, але зупинено, оскільки форум вимкнено.</strong>',
	'LOG_CONFIG_DIGEST_EDIT_SUBSCRIBERS'			=> '<strong>Змінено підписників на дайджест</strong>',
	'LOG_CONFIG_DIGEST_GENERAL'						=> '<strong>Змінено загальні параметри дайджесту</strong>',
	'LOG_CONFIG_DIGEST_LOG'							=> '<strong>Змінено налаштування логування дайджесту</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_BAD'				=> '<strong>Не вдалося надіслати дайджест до %s (%s)</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_BAD_NO_EMAIL'		=> '<strong>Не вдалося надіслати дайджест до %s</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_GOOD'				=> '<strong>Дайджест %s було надіслано до %s (%s). Він містить %s повідомлень і %s особистих повідомлень.</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_GOOD_NO_EMAIL'		=> '<strong>Дайджест %s було надіслано до %s. Він містить %s повідомлень і %s особистих повідомлень.</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_NONE'				=> '<strong>Дайджест НЕ було надіслано до %s (%s), оскільки через фільтри та параметри користувача не було чого надсилати</strong>',
	'LOG_CONFIG_DIGEST_LOG_ENTRY_NONE_NO_EMAIL'		=> '<strong>Дайджест НЕ було надіслано до %s, оскільки через фільтри та параметри користувача не було чого надсилати</strong>',
	'LOG_CONFIG_DIGEST_LOG_EMAILED'					=> '<strong>Всі дайджести на цю годину були надіслані електронною поштою</strong>',
	'LOG_CONFIG_DIGEST_LOG_START'					=> '<strong>Початок mail_digests.php</strong>',
	'LOG_CONFIG_DIGEST_LOG_END'						=> '<strong>Кінець mail_digests.php</strong>',
	'LOG_CONFIG_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE'	=> '<strong>Виконано масову дію: підписка/відписка від дайджесту</strong>',
	'LOG_CONFIG_DIGEST_NEED_TWO_PARAMS'				=> '<strong>Виняток дайджесту: Ви повинні вказати параметр дати та параметр години для позапланового запуску mail_digests.php. Знайдено тільки один із них.</strong>',
	'LOG_CONFIG_DIGEST_NO_BOOKMARKS'				=> '<strong>Виняток дайджесту: Користувач "%s" попросив дайджест для закладок, але він не має тем у закладках</strong>',
	'LOG_CONFIG_DIGEST_NO_ALLOWED_FORUMS'			=> '<strong>Виняток дайджесту: Користувач "%s" не має доступу до жодних форумів. Дайджест створити неможливо.</strong>',
	'LOG_CONFIG_DIGEST_NOT_ENABLED'					=> '<strong>Зараз дайджести не увімкнені, тому цього часу вони не відправляються.</strong>',
	'LOG_CONFIG_DIGEST_SEND_MASS_EMAIL_ERROR'		=> '<strong>Не вдалося надіслати email через масову підписку/відписку на дайджест до %s</strong>',
	'LOG_CONFIG_DIGEST_USER_DEFAULTS'				=> '<strong>Змінені стандартні налаштування користувача стосовно дайджесту</strong>',
	'LOG_CONFIG_DIGEST_WRITE_LOG_ENTRY_ERROR'		=> '<strong>Виняток дайджесту: write_log_entry був викликаний з невідомим типом "%s"</strong>',
	'LOG_FILE_BACKUP'								=> '<strong>Резервне копіювання файлів</strong><br />',
	'ACP_DIGEST_SETTINGS'							=> 'Налаштування дайджесту',
	'ACP_DIGEST_GENERAL_SETTINGS'					=> 'Загальні налаштування',
	'ACP_DIGEST_GENERAL_SETTINGS_EXPLAIN'			=> 'Це основні настройки для дайджесту.',
	'ACP_DIGEST_USER_DEFAULT_SETTINGS'				=> 'Стандартні параметри користувача',
	'ACP_DIGEST_USER_DEFAULT_SETTINGS_EXPLAIN'		=> 'Адміністратори можуть встановити стандартні опції, які користувачі побачать після підписки на дайджест.',
	'ACP_DIGEST_EDIT_SUBSCRIBERS'					=> 'Редагувати підписників',
	'ACP_DIGEST_EDIT_SUBSCRIBERS_EXPLAIN'			=> 'Ви можете бачити, хто підписаний та відписаний на дайджест. Є можливість додати нових учасників вручну чи змінити параметри поточних. Можна всіх масово підписати за замовчуванням або відписати.',
	'ACP_DIGEST_BALANCE_LOAD'						=> 'Балансування навантаження',
	'ACP_DIGEST_BALANCE_LOAD_EXPLAIN'				=> 'Якщо велику кількість дайджестів розсилають водночас в певні години і це приводить до проблем із сервером, то можна розбити розсилку рівномірніше.',
	'ACP_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE'			=> 'Масова підписка/відписка',
	'ACP_DIGEST_MASS_SUBSCRIBE_UNSUBSCRIBE_EXPLAIN'	=> 'Легкий спосіб адміністраторам усіх учасників підписати або відписати на дайджест.',
	'LOG_DELETED_CALENDAR_EVENT'					=> '<strong>Видалено подію в календарі</strong><br />» %s',
	'LOG_DELETED_TOPIC_EVENT'						=> '<strong>Видалено подію в темі</strong><br />» %s',
	'LOG_DELETED_CALENDAR_EVENTS'					=> '<strong>Видалено повторювані події в календарі</strong><br />» %s',
	'LOG_DELETED_TOPIC_EVENTS'						=> '<strong>Видалено повторювані події в темі</strong><br />» %s',
	'LOG_DELETED_CALENDAR_EVENT_INSTANCE'			=> '<strong>Видалено повторюваний екземпляр події в календарі</strong><br />» %s',
	'LOG_DELETED_TOPIC_EVENT_INSTANCE'				=> '<strong>Видалено повторюваний екземпляр події в темі</strong><br />» %s',
	'LOG_EDITED_CALENDAR_EVENT'						=> '<strong>Відредаговано подію в календарі</strong><br />» %s',
	'LOG_EDITED_CALENDAR_EVENTS'					=> '<strong>Відредаговано повторювані події в календарі</strong><br />» %s',
	'LOG_EDITED_CALENDAR_EVENT_INSTANCE'			=> '<strong>Відредаговано повторюваний екземпляр події в календарі</strong><br />» %s',
	'ACP_KB'										=> 'База Знань',
	'KB_NAME'										=> 'База Знань',
	'ACP_KB_PERMISSIONS'							=> 'Дозволи категорії',
	'ACP_KB_ROLES'									=> 'Ролі Бази Знань',
	'KB_CONFIG'										=> 'Конфігурація',
	'TYPES'											=> 'Типи статей',
	'CATEGORIES'									=> 'Категорії',
	'ACP_MODS_DATABASE'								=> 'База Даних Модів',
	'LOG_MOD_DELETE'								=> '<strong>Мод(и) видалено з Бази Модів</strong>',
	'LOG_MOD_ADDED'									=> '<strong>Мод додано до Бази Модів</strong>',
	'LOG_MOD_UPDATED'								=> '<strong>Мод оновлено в Базі Модів</strong>',
	'LOG_MCHAT_TABLE_PRUNED'						=> 'Таблиця mChat була очищена',
	'ACP_USER_MCHAT'								=> 'Налаштування mChat',
	'LOG_DELETED_MCHAT'								=> '<strong>Видалено повідомлення mChat</strong><br />» %1$s',
	'LOG_EDITED_MCHAT'								=> '<strong>Відредаговано повідомлення mChat</strong><br />» %1$s',
));
