...
$lang = array_merge($lang, array(
	...
	'PORTAL_NAME'					=> 'Назва порталу',
	'PORTAL_NAME_EXPLAIN'			=> 'Встановлює стандартний підпис для посилання на портал.<br> Залиште значення <strong>Portal</strong>, щоб використовувати стандартний переклад із мовного файлу. Якщо значення змінено, можна ввести локалізовані назви для кожної встановленої мови.',
	'FORUM_NAME'					=> 'Назва форуму',
	'FORUM_NAME_EXPLAIN'			=> 'Встановлює стандартний підпис для посилання на форум.<br> Залиште значення <strong>Forum</strong>, щоб використовувати стандартний переклад із мовного файлу. Якщо значення змінено, можна ввести локалізовані назви для кожної встановленої мови.',
	'LOCALIZED_NAMES'				=> 'Локалізовані назви',
	'PORTAL_NAME_LANG'				=> 'Назва порталу - %s',
	'FORUM_NAME_LANG'				=> 'Назва форуму - %s',
	'SITE_DESC'	=> 'Опис сайту',
	'SITE_NAME'	=> 'Назва сайту',
	'SITE_COPYRIGHT_ENABLE'	=> 'Відображати назву сайту як авторське право в нижньому колонтитулі',
...
$lang = array_merge($lang, array(
	...
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Шлях відносно кореневої директорії phpBB, наприклад <samp>images/avatars/upload</samp>.<br />Завантаження аватарів <strong>буде недоступним</strong>, якщо дана директорія не матиме прав на запис.',
...
$lang = array_merge($lang, array(
	...
	'SERVER_PORT'	=> 'Порт',
    'SERVER_PORT_EXPLAIN'		=> 'Порт, на якому працює ваш сервер, зазвичай 80 для HTTP та 443 для HTTPS. Змінюйте це значення лише у разі використання іншого порту.',
...
$lang = array_merge($lang, array(
	...
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Дозволити підключення до сервера Jabber із самопідписаним SSL-сертифікатом.<em><strong>Увага:</strong> Використання самопідписаних SSL-сертифікатів може спричинити ризики безпеки.</em>',
	'JAB_VERIFY_PEER'				=> 'Перевірити SSL-сертифікат',
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Вимагати перевірку SSL-сертифіката, який використовується сервером Jabber.<em><strong>Увага:</strong> Підключення до неперевірених SSL-сертифікатів може спричинити ризики безпеки.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Перевірити ім’я вузла Jabber',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Вимагати перевірку імені вузла для серверів Jabber, що використовують SSL / TLS-з’єднання.<em><strong>Увага:</strong> Підключення до неперевірених вузлів може спричинити ризики безпеки.</em>',
	));
	
// phpBB Digest MOD - Addition begin -------------------------------------------------------
$lang = array_merge($lang, array(
    'DIGEST_ALL'                                => 'Усі',
    'DIGEST_ALL_ALLOWED_FORUMS'                 => 'Усі дозволені форуми',
    'DIGEST_ALL_SUBSCRIBED'                     => 'Усі відповідні користувачі були підписані',
    'DIGEST_ALL_UNSUBSCRIBED'                   => 'Усі відповідні користувачі були відписані',
    'DIGEST_BALANCE_LOAD'                       => 'Балансування навантаження',
    'DIGEST_BLOCK_IMAGES'                       => 'Блокувати зображення',
    'DIGEST_BLOCK_IMAGES_EXPLAIN'               => 'Забороняє відображення будь-яких зображень у зведеннях, включаючи зображення у вкладеннях. Якщо ви турбуєтеся про пропускну здатність каналу, можливо, варто увімкнути цю функцію.',
    'DIGEST_CHANGE_SUBSCRIPTION'                => 'Змінити підписку',
    'DIGEST_CURRENT_VERSION_INFO'               => 'Ви використовуєте версію <strong>%s</strong>.',
    'DIGEST_CUSTOM_STYLESHEET_PATH'             => 'Шлях до власної таблиці стилів',
    'DIGEST_CUSTOM_STYLESHEET_PATH_EXPLAIN'     => 'Це налаштування застосовується лише якщо увімкнено опцію "Увімкнути власну таблицю стилів". Якщо її увімкнено, ця таблиця стилів застосовуватиметься до всіх HTML-зведень. Шлях має бути відносним щодо вашого каталогу стилів phpBB і зазвичай знаходитися в підпапці theme. Примітка: ви несете відповідальність за створення цієї таблиці стилів та розміщення її у файлі з назвою, введеною тут, у відповідному місці на вашому сервері. Приклад: prosilver/theme/digest_stylesheet.css. Для отримання інформації про створення таблиць стилів натисніть <a href="http://www.w3schools.com/css/">тут</a>.',
    'DIGEST_COLLAPSE'                           => 'Згорнути',
    'DIGEST_DEFAULT'                            => 'Підписатися, використовуючи налаштування за замовчуванням',
    'DIGEST_ENABLED'                            => 'Увімкнути зведення',
    'DIGEST_ENABLED_EXPLAIN'                    => 'Якщо ви вимкнете зведення, інтерфейс в Особистому розділі користувача зникне через вимкнення категорії модуля. Крім того, зведення більше не надсилатимуться. Проте всі налаштування зведень користувачів будуть збережені.',
    'DIGEST_ENABLE_AUTO_SUBSCRIPTIONS'          => 'Увімкнути автоматичні підписки',
    'DIGEST_ENABLE_AUTO_SUBSCRIPTIONS_EXPLAIN'  => 'Якщо ви хочете, щоб нові користувачі автоматично отримували зведення, виберіть Так. Будуть автоматично використані налаштування конференції за замовчуванням для зведень. (Вони встановлюються в користувацьких налаштуваннях зведень за замовчуванням). Увімкнення цієї опції <em>не</em> створить підписки для поточних непідписаних користувачів або для нових учасників, які вирішили не отримувати зведення під час реєстрації. Ви можете налаштувати їх індивідуально за допомогою функції "Редагувати підписників" або глобально за допомогою опції "Масова підписка/відписка".',
    'DIGEST_ENABLE_CUSTOM_STYLESHEET'           => 'Увімкнути власну таблицю стилів',
    'DIGEST_ENABLE_CUSTOM_STYLESHEET_EXPLAIN'   => 'Якщо не увімкнено, до HTML-версій зведень користувачів застосовується таблиця стилів за замовчуванням для стилю, вибраного в їхньому профілі.',
    'DIGEST_ENABLE_LOG'                         => 'Записувати всі дії зі зведеннями до журналу адміністратора',
    'DIGEST_ENABLE_LOG_EXPLAIN'                 => "Якщо вибрано Так, всі дії зі зведеннями будуть записуватися до журналу адміністратора (знаходиться на вкладці «Обслуговування»). Це корисно для вирішення проблем зі зведеннями, оскільки вказує на те, що робила програма mail_digests.$phpEx і коли. Однак це швидко призведе до дуже великого журналу адміністратора, оскільки щогодини до журналу записуватиметься щонайменше два записи.",
    'DIGEST_ENABLE_SUBSCRIBE_UNSUBSCRIBE'       => 'Увімкнути масову підписку або відписку',
    'DIGEST_ENABLE_SUBSCRIBE_UNSUBSCRIBE_EXPLAIN' => 'Якщо ви виберете «так», то після натискання кнопки «Надіслати» відбудеться дія масової підписки або відписки. Вмикайте обережно!',
    'DIGEST_EXCLUDE_FORUMS'                     => 'Завжди виключати ці форуми',
    'DIGEST_EXCLUDE_FORUMS_EXPLAIN'             => 'Введіть forum_ids для форумів, які ніколи не повинні з’являтися у зведенні. Розділяйте forum_ids комами. Якщо встановлено значення 0, жодні форуми виключати не потрібно. Щоб визначити forum_ids, під час перегляду форуму зверніть увагу на параметр «f» в адресному рядку URL. Це і є forum_id. Приклад: http://www.example.com/phpBB3/viewforum.php?f=1. Не використовуйте forum_ids, які відповідають категоріям. <i>Це налаштування ігнорується, якщо підписник запитує лише закладки тем.</i>',
    'DIGEST_EXPAND'                             => 'Розгорнути',
    'DIGEST_FROM_EMAIL_ADDRESS'                 => 'Адреса e-mail відправника',
    'DIGEST_FROM_EMAIL_ADDRESS_EXPLAIN'         => 'Коли користувачі отримують зведення, ця адреса електронної пошти відображатиметься в полі ВІД (FROM). Якщо залишити поле порожнім, буде використано контактну адресу електронної пошти вашої конференції за замовчуванням. Будьте обережні при використанні адреси електронної пошти з доменом, відмінним від того, на якому розміщено зведення, оскільки ваш поштовий сервер або поштовий сервер користувача може розцінити цей лист як спам.',
    'DIGEST_FROM_EMAIL_NAME'                    => 'Ім’я відправника e-mail',
    'DIGEST_FROM_EMAIL_NAME_EXPLAIN'            => 'Це текстове ім’я відправника (FROM), яке з’являтиметься в поштовому клієнті. Якщо залишити порожнім, воно буде ідентифікувати себе як робот вашої конференції.',
    'DIGEST_HAS_UNSUBSCRIBED'                   => 'Відписався',
    'DIGEST_HOUR_SENT'                          => 'Година відправки<br />(на основі %s GMT)',
    'DIGEST_IGNORE'                             => 'Ігнорувати глобальні дії',
    'DIGEST_INCLUDE_ADMINS'                     => 'Включати адміністраторів',
    'DIGEST_INCLUDE_ADMINS_EXPLAIN'             => 'Це дозволить підписувати або відписувати адміністраторів на додачу до звичайних користувачів.',
    'DIGEST_INCLUDE_FORUMS'                     => 'Завжди включати ці форуми',
    'DIGEST_INCLUDE_FORUMS_EXPLAIN'             => 'Введіть forum_ids для форумів, які обов’язково повинні з’являтися у зведенні. Розділяйте forum_ids комами. Якщо встановлено значення 0, жодні форуми не є обов’язковими для включення. Щоб визначити forum_ids, під час перегляду форуму зверніть увагу на параметр «f» в адресному рядку URL. Це і є forum_id. Приклад: http://www.example.com/phpBB3/viewforum.php?f=1. Не використовуйте forum_ids, які відповідають категоріям. <i>Це налаштування ігнорується, якщо підписник запитує лише закладки тем.</i>',
    'DIGEST_KEY_VALUE'                          => 'Значення ключа',
    'DIGEST_KEY_VALUE_EXPLAIN'                  => 'Майте на увазі, що це відкритий текст і він не шифрується. Пишіть просто. Уникайте використання кількох слів, пробілів та спеціальних символів. Приклад: qwertyuiop',
    'DIGEST_LAST_SENT'                          => 'Востаннє зведення надіслано',
    'DIGEST_LATEST_VERSION_INFO'                => 'Остання доступна версія — <strong>%s</strong>.',
    'DIGEST_LIST_USER'                          => '1 користувач',
    'DIGEST_LIST_USERS'                         => '%s користувачів',
    'DIGEST_MAX_ITEMS'                          => 'Максимальна кількість повідомлень у будь-якому зведенні',
    'DIGEST_MAX_ITEMS_EXPLAIN'                  => 'З міркувань продуктивності вам може знадобитися встановити абсолютний ліміт на кількість повідомлень в одному зведенні. Якщо встановити значення 0 (нуль), це дозволить створювати зведення необмеженого розміру. У цьому полі можна використовувати будь-яке ціле число. Зверніть увагу, що зведення обмежене кількістю повідомлень у запитаному типі зведення (щоденне, щотижневе або щомісячне), а також іншими критеріями, які може встановити користувач.',
    'DIGEST_NEVER_VISITED'                      => 'Ніколи не відвідував',
    'DIGEST_NEW_SUBSCRIBERS'                    => ' %s користувачів були підписані на отримання зведень: %s.',
    'DIGEST_NONSUBSCRIBER'                      => 'Не підписник',
    'DIGEST_NO_DIGESTS_SENT'                    => 'Зведення не надсилалися',
    'DIGEST_NO_MASS_ACTION'                     => 'Жодних дій не було вжито, оскільки ви не увімкнули цю функцію',
    'DIGEST_NOTIFY_ON_MASS_SUBSCRIBE'           => 'Повідомити учасника електронною поштою про дію, якщо вона його стосується',
    'DIGEST_OVERRIDE_QUEUE'                     => 'Надсилати кожне зведення індивідуально',
    'DIGEST_OVERRIDE_QUEUE_EXPLAIN'             => 'За замовчуванням зведення надсилаються пакетами, якщо розмір пакету електронної пошти більший за нуль. Якщо ви помітили, що не всі зведення надсилаються протягом години, можливо, варто встановити для цього параметра значення «так». Якщо «так», зведення буде надіслано до того, як буде сформовано наступне. Це, швидше за все, призведе до того, що програма розсилки зведень працюватиме довше і споживатиме більше ресурсів процесора, але це надійніше.',
    'DIGEST_RANDOM_HOUR'                        => 'Випадкова година',
    'DIGEST_REBALANCED'                         => 'Під час цього перебалансування загалом для %s підписників зведень було змінено годину їх відправки.',
    'DIGEST_REFRESH'                            => 'Оновити',
    'DIGEST_REGISTRATION_FIELD'                 => 'Дозволити користувачам підписуватися на зведення під час реєстрації',
    'DIGEST_REGISTRATION_FIELD_EXPLAIN'         => 'Якщо увімкнено, під час реєстрації користувачі мають можливість отримувати зведення за допомогою налаштувань конференції за замовчуванням. Ця опція не з’являється, якщо увімкнено автоматичні підписки.',
    'DIGEST_REPLY_TO_EMAIL_ADDRESS'             => 'Адреса e-mail для відповіді (Reply-To)',
    'DIGEST_REPLY_TO_EMAIL_ADDRESS_EXPLAIN'     => 'Коли користувачі отримують зведення, ця адреса електронної пошти відображатиметься в полі ВІДПОВІСТИ (REPLY TO). Якщо залишити поле порожнім, буде використано контактну адресу електронної пошти вашої конференції за замовчуванням. Будьте обережні при використанні адреси електронної пошти з доменом, відмінним від того, на якому розміщено зведення, оскільки ваш поштовий сервер або поштовий сервер користувача може розцінити цей лист як спам.',
    'DIGEST_REQUIRE_KEY'                        => 'Вимагати параметр ключа для запуску mail_digests.php',
    'DIGEST_REQUIRE_KEY_EXPLAIN'                => "Це додатковий захід безпеки, який ви можете увімкнути. Якщо увімкнено, mail_digests.$phpEx надсилатиме зведення лише тоді, коли вказано параметр ключа і цей ключ збігається зі значенням ключа, яке ви визначили нижче. Вам потрібно буде запрограмувати ваше завдання cron або його еквівалент на використання ключа. Приклад отриманого URL: http://www.example.com/phpBB3/mail_digests.$phpEx?key=qwertyuiop",
    'DIGEST_SEARCH_FOR_MEMBER'                  => 'Пошук користувача',
    'DIGEST_SEARCH_FOR_MEMBER_EXPLAIN'          => 'Введіть повне або часткове ім’я користувача для пошуку, а потім натисніть «Оновити». Залиште порожнім, щоб побачити всіх користувачів. Пошук чутливий до регістру і знайде користувачів на основі поточного фільтра користувачів.',
    'DIGEST_SELECT_FORUMS_ADMIN_EXPLAIN'        => 'Список форумів включає лише ті форуми, які цьому користувачеві дозволено читати. Якщо ви хочете надати цьому користувачеві доступ до додаткових форумів, які не показані тут, розширте його права доступу як користувача форуму або групи. Зверніть увагу: хоча ви можете точно налаштувати форуми, які з’являються в їхньому зведенні, якщо тип зведення — «Немає», зведення насправді не буде надіслано.',
    'DIGEST_SHOW'                               => 'Показати',
    'DIGEST_SHOW_OUTPUT'                        => 'Показувати вивід роботи програми',
    'DIGEST_SHOW_OUTPUT_EXPLAIN'                => "Якщо вибрано Так, під час запуску mail_digests.$phpEx на екран виводитимуться повідомлення про те, хто і коли отримав зведення. Зазвичай ці повідомлення ніхто не бачить, оскільки програма запускається автоматично. Пропонується встановити значення Так, доки ви не автоматизуєте процес, а потім встановити значення Ні.",
    'DIGEST_SHOW_EMAIL'                         => 'Показувати адресу email',
    'DIGEST_SHOW_EMAIL_EXPLAIN'                 => "Якщо увімкнено опції «Показувати вивід роботи програми» та «Показувати адресу email», адреса електронної пошти підписника відображатиметься у виводі на екран. Рекомендується <em>негайно</em> вимкнути цю опцію після усунення несправностей, оскільки вона створює потенційну проблему безпеки.",
    'DIGEST_SOCKET_FUNCTIONS_DISABLED'          => 'Функції сокетів наразі вимкнені.',
    'DIGEST_SORT_ORDER'                         => 'Порядок сортування',
    'DIGEST_STOPPED_SUBSCRIBING'                => 'Підписку припинено',
    'DIGEST_SUBSCRIBE'                          => 'Підписатися за замовчуванням',
    'DIGEST_SUBSCRIBE_SUBJECT'                  => 'Вас підписано на отримання зведень електронною поштою',
    'DIGEST_SUBSCRIBE_ALL'                      => 'Підписати всіх',
    'DIGEST_SUBSCRIBE_ALL_EXPLAIN'              => 'Якщо ви виберете «ні», усі користувачі будуть відписані.',
    'DIGEST_SUBSCRIBE_LITERAL'                  => 'Підписатися',
    'DIGEST_SUBSCRIBED'                         => 'Підписаний',
    'DIGEST_SUBSCRIBER'                         => 'Підписник',
    'DIGEST_SUBSCRIBERS'                        => 'Підписники',
    'DIGEST_SUBSCRIBER_DETAIL'                  => 'Деталі підписника на зведення',
    'DIGEST_TIME_ZONE'                          => 'Часовий пояс',
    'DIGEST_TIME_ZONE_EXPLAIN'                  => 'Функції редагування підписників та балансування навантаження відображають годину, коли зведення надсилаються електронною поштою. Якщо ви встановите тут певний часовий пояс, година відправлення буде переведена у встановлений вами часовий пояс. Спочатку тут встановлено часовий пояс конференції. Значення мають бути цілими числами від -12 до 12, де 0 — це GMT.',
    'DIGEST_UNKNOWN'                            => 'Невідомо',
    'DIGEST_UNSUBSCRIBE'                        => 'Відписатися',
    'DIGEST_UNSUBSCRIBE_MARKED'                 => 'Відписати виділені',
    'DIGEST_UNSUBSCRIBE_SUBJECT'                => 'Вас було відписано від отримання зведень електронною поштою',
    'DIGEST_UNSUBSCRIBED'                       => 'Ніколи не підписувався',
    'DIGEST_USER_DIGEST_ATTACHMENTS'            => 'Значення за замовчуванням для показу вкладень',
    'DIGEST_USER_DIGEST_BLOCK_IMAGES'           => 'Значення за замовчуванням для блокування зображень',
    'DIGEST_USER_DIGEST_CHECK_ALL_FORUMS'       => 'Чи хочете ви вибирати всі форуми за замовчуванням',
    'DIGEST_USER_DIGEST_FILTER_TYPE'            => 'Типи повідомлень у зведеннях за замовчуванням',
    'DIGEST_USER_DIGEST_MAX_DISPLAY_WORDS'      => 'Максимальна кількість слів для відображення в повідомленні за замовчуванням',
    'DIGEST_USER_DIGEST_MAX_DISPLAY_WORDS_EXPLAIN' => 'Встановіть значення -1, щоб за замовчуванням показувати повний текст повідомлення. Значення нуль (0) означає, що за замовчуванням користувач взагалі не бачитиме текст повідомлення.',
    'DIGEST_USER_DIGEST_MAX_POSTS'              => 'Максимальна кількість повідомлень у зведенні за замовчуванням',
    'DIGEST_USER_DIGEST_MAX_POSTS_EXPLAIN'      => 'Якщо встановлено значення нуль, це дозволить будь-яку кількість повідомлень. Будь ласка, зверніть увагу, що жодне зведення ніколи не міститиме більше повідомлень, ніж встановлено у вашому налаштуванні максимальної кількості повідомлень, дозволених у будь-якому зведенні (вище).',
    'DIGEST_USER_DIGEST_MIN_POSTS'              => 'Мінімальна кількість слів за замовчуванням для появи повідомлення у зведенні',
    'DIGEST_USER_DIGEST_MIN_POSTS_EXPLAIN'      => 'Якщо встановлено значення нуль, допускаються повідомлення з будь-якою кількістю слів у повідомленні.',
    'DIGEST_USER_DIGEST_NEW_POSTS_ONLY'         => 'Значення за замовчуванням для показу тільки нових повідомлень',
    'DIGEST_USER_DIGEST_PM_MARK_READ'           => 'Значення за замовчуванням для позначення приватних повідомлень як прочитаних, коли вони з’являються у зведенні',
    'DIGEST_USER_DIGEST_RANDOM_HOUR'            => 'Випадкова година',
    'DIGEST_USER_DIGEST_REGISTRATION'           => 'Значення за замовчуванням для того, чи підписується користувач на зведення під час реєстрації',
    'DIGEST_USER_DIGEST_RESET_LASTVISIT'        => 'Значення за замовчуванням для скидання дати останнього відвідування при надсиланні зведення',
    'DIGEST_USER_DIGEST_SEND_HOUR_GMT'          => 'Година відправлення за замовчуванням (всесвітній час)',
    'DIGEST_USER_DIGEST_SEND_ON_NO_POSTS'       => 'Значення за замовчуванням для надсилання зведення, якщо немає нових повідомлень',
    'DIGEST_USER_DIGEST_SHOW_FOES'              => 'Значення за замовчуванням для видалення повідомлень від недругів користувача',
    'DIGEST_USER_DIGEST_SHOW_MINE'              => 'Значення за замовчуванням для видалення власних повідомлень користувача',
    'DIGEST_USER_DIGEST_SHOW_PMS'               => 'Значення за замовчуванням для додавання непрочитаних приватних повідомлень користувача',
    'DIGEST_USER_DIGEST_SORT_ORDER'             => 'Порядок сортування повідомлень за замовчуванням',
    'DIGEST_USER_DIGEST_STYLE'                  => 'Стиль зведення за замовчуванням',
    'DIGEST_USER_DIGEST_TYPE'                   => 'Тип зведення користувача за замовчуванням',
    'DIGEST_USER_DIGEST_TOC'                    => 'Значення за замовчуванням для таблиці змісту',
    'DIGEST_USER_TYPE'                          => 'Тип користувача',
    'DIGEST_USERS_PER_PAGE'                     => 'Підписників на сторінку',
    'DIGEST_USERS_PER_PAGE_EXPLAIN'             => 'Це контролює, скільки підписників на зведення бачить адміністратор на сторінці, коли вибирає опцію редагування підписників. Виходячи з вашого значення max_input_vars, ви повинні обмежити це число до ' . floor((ini_get('max_input_vars') - 100) / 24) . ' підписників на сторінку або менше. В іншому випадку вам доведеться збільшити max_input_vars у файлі php.ini, щоб запобігти збою функції.',
    'DIGEST_VERSION_NOT_UP_TO_DATE'             => 'Ця версія phpBB Digests застаріла. Оновлення доступні на <a href="%s">веб-сайті Digests</a>.',
    'DIGEST_VERSION_UP_TO_DATE'                 => 'Ця версія phpBB Digests є актуальною, оновлення не потрібні.',
    'DIGEST_WEEKLY_DIGEST_DAY'                  => 'Виберіть день тижня для розсилки щотижневих зведень',
    'DIGEST_WITH_SELECTED'                      => 'З виділеними',
...
// Mod links in header
$lang = array_merge($lang, array(
    'MOD_LINKS'                 => 'Виберіть посилання для відображення в навігації',
    'SHOW_ACTIVITY'             => 'Соціальна мережа',
    'SHOW_ACTIVITY_EXPLAIN'     => 'Показувати посилання на сторінку активності в навігації.',    
    'SHOW_BLOG'                 => 'Блог',
    'SHOW_BLOG_EXPLAIN'         => 'Показувати посилання на блог в навігації.',
    'SHOW_KB'                   => 'База знань',
    'SHOW_KB_EXPLAIN'           => 'Показувати посилання на базу знань в навігації.',
    'SHOW_CAL'                  => 'Календар',
    'SHOW_CAL_EXPLAIN'          => 'Показувати посилання на календар тем в навігації.',
    'SHOW_GALL'                 => 'Галерея',
    'SHOW_GALL_EXPLAIN'         => 'Показувати посилання на галерею в навігації.',
    'SHOW_CHT'                  => 'Чат',
    'SHOW_CHT_EXPLAIN'          => 'Показувати посилання на чат в шапці сайту.',
    'SHOW_DLS'                  => 'Завантаження',
    'SHOW_DLS_EXPLAIN'          => 'Показувати посилання на завантаження в навігації.',
    'SHOW_FAQ'                  => 'FAQ',
    'SHOW_FAQ_EXPLAIN'          => 'Показувати посилання на FAQ в навігації.',
    'SHOW_MEM'                  => 'Список учасників',
    'SHOW_MEM_EXPLAIN'          => 'Показувати посилання на список учасників в навігації.',
    'SHOW_NOTES'                => 'Нотатки',
    'SHOW_NOTES_EXPLAIN'        => 'Показувати посилання на нотатки в навігації.',
    'SHOW_MEETING'              => 'Зустрічі',
    'SHOW_MEETING_EXPLAIN'      => 'Показувати посилання на зустрічі в навігації.',    
    'SHOW_CONTACT'              => 'Зворотній зв’язок',
    'SHOW_CONTACT_EXPLAIN'      => 'Показувати посилання на сторінку зв’язку в навігації.',    
    'SHOW_RULES'                => 'Правила',
    'SHOW_RULES_EXPLAIN'        => 'Показувати посилання на правила в навігації.',
));
