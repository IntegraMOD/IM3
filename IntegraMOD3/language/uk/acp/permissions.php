...
$lang = array_merge($lang, array(
   ...
   'ROLE_DESCRIPTION_USER_NEW_MEMBER' => 'Роль для членів спеціальної групи "Нові користувачі", що обмежує можливості нових зареєстрованих користувачів.',
	...
	// Missing variables
	'ROLE_KB_ADMIN'					=> 'Адмін БЗ',
	'ROLE_KB_MODERATOR'				=> 'Модератор БЗ',
	'ROLE_KB_USER'					=> 'Користувач БЗ',
	'ROLE_KB_SU_USER'				=> 'Суперкористувач БЗ',
	'ROLE_KB_GUEST'					=> 'Гість БЗ',
	'ROLE_KB_BOT'					=> 'Бот БЗ',
	'ROLE_DESCRIPTION_KB_ADMIN'		=> 'Має доступ до всіх інструментів модератора Бази Знань у цій категорії.',
	'ROLE_DESCRIPTION_KB_MODERATOR'	=> 'Має доступ до всіх інструментів модератора Бази Знань у цій категорії.',
	'ROLE_DESCRIPTION_KB_USER'		=> 'Може подавати статті до Бази Знань у цій категорії. Подача статей потребує схвалення модератора. Може модерувати власні статті у Базі Знань.',
	'ROLE_DESCRIPTION_KB_SU_USER'	=> 'Може подавати статті до Бази Знань у цій категорії. Може подавати статті без схвалення модератора. Може модерувати власні статті у Базі Знань.',
	'ROLE_DESCRIPTION_KB_GUEST'		=> 'Може переглядати статті у цій категорії.',
	'ROLE_DESCRIPTION_KB_BOT'		=> 'Може переглядати статті у цій категорії.',
));
