...
$lang = array_merge($lang, array(
  ...
  'FIREBIRD_DBMS_UPDATE_REQUIRED' => 'phpBB більше не підтримує версії Firebird/Interbase, нижчі за 2.1. Будь-ласка, оновіть Firebird, принаймні до версії 2.1.0 перед продовженням процесу оновлення.',
	...
	'INSTALL_SN'                => 'Продовжити встановлення Соціальної мережі',
	'INSTALL_CONGRATS_EXPLAIN'  => 'Ви успішно встановили IntegraMOD %1$s.</p>
		<h2>Ви майже на фініші!</h2>
		<p><strong>Будь ласка, видаліть, перемістіть або перейменуйте каталог установки зараз, перш ніж перейти до останнього кроку — встановлення соціальної мережі.</strong>',
	'INSTALL_INTRO' => 'Ласкаво просимо до встановлення IntegraMOD',

	'INSTALL_INTRO_BODY' => 'За допомогою цього параметра можна встановити IntegraMOD на ваш сервер.</p><p>Щоб продовжити, вам знадобляться налаштування бази даних. Якщо ви їх не знаєте, зверніться до свого хостинг-провайдера. Без них ви не зможете продовжити. Вам потрібно:</p>
  	<ul>
...
// TODO: Write some explanatory introduction text
	...
	'OVERVIEW_BODY'				=> 'Ласкаво просимо до IntegraMOD!<br /><br />IntegraMOD побудовано на phpBB. phpBB® є найпоширенішим рішенням для дошок оголошень з відкритим кодом у світі. phpBB3 є останньою частиною в лінійці пакетів, започаткованій у 2000 році. Як і його попередники, phpBB3 є багатофункціональним, дружнім до користувача та повністю підтримується командою phpBB. phpBB3 значно вдосконалює те, що зробило phpBB2 популярним, і додає часто запитувані функції, яких не було в попередніх версіях. Сподіваємось, він перевершить ваші очікування.<br /><br />Портал KISS&copy; є оригінальною системою порталу phpBB3. Kiss Portal був першим модом, написаним для phpBB3 (розробленим на стадіях альфа/бета phpBB3)...<br />Портал KISS постійно розроблявся з 2005 року, і це єдиний доступний повністю інтегрований портал phpBB3. KISS Portal — це найбільший мод, написаний для phpBB3, тому для ознайомлення з ним знадобиться трохи часу. Нехай вас не лякає його розмір, його досить легко навчитися. для більшості людей все, що потрібно, це кілька налаштувань адміністратора, і немає необхідності торкатися цього знову.<br /><br />Ця система встановлення допоможе вам встановити phpBB3 / KISS Portal, оновлення до останньої версії phpBB3 з попередніх випусків, а також перетворення на phpBB3 з іншої системи дискусій (включаючи phpBB2). Для отримання додаткової інформації радимо прочитати <a href="../docs/INSTALL.html">посібник із встановлення</a>.<br /><br />Щоб прочитати ліцензію phpBB3 або дізнатися про отримання підтримки і нашу позицію щодо цього, виберіть відповідні параметри з бічного меню. Щоб продовжити, виберіть відповідну вкладку вище.',
  ...
  'PCRE_UTF_SUPPORT_EXPLAIN'		=> 'phpBB <strong>не</strong> буде працювати, якщо встановлена версія PHP не скомпільована з підтримкою UTF-8 для розширення PCRE.',
	...
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Необхідно</strong> - Для встановлення phpBB у вас повинно бути встановлено PHP як мінімум версії 7.0. Якщо у вас відображається напис <var>безпечний режим</var> внизу, то це означає, що PHP працює у цьому режимі. Це накладає обмеження на віддалене адміністрування та тому подібні функції.',
	...
	'PHP_VERSION_REQD'				=> 'Версія PHP >= 7.0',
