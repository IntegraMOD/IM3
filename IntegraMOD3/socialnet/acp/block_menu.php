        ...
        switch ($action) {
            case "delete":
                ...
                if (confirm_box(true)) {
                    ...
                    add_log('admin', 'LOG_CONFIG_SN_BLOCK_MENU_' . strtoupper((string) $action), 'aaa' . $button_name);
            ...
            case "add_button":
                ...
                if ($submit) {
                    ...
                    $db->sql_query($sql);
                    add_log('admin', 'LOG_CONFIG_SN_BLOCK_MENU_' . strtoupper((string) $action), $button_name);
            ...
            case 'move_down':
                ...
                add_log('admin', 'LOG_CONFIG_SN_BLOCK_MENU_' . strtoupper((string) $action), $row['button_name'], $button_moved_by);
                redirect($this->p_master->u_action . '&amp;block=block_menu&amp;parent_id=' . $parent_id);
            ...
            default:
                ...
                if ($submit) {
                    $button_name = request_var('button_name', '', true);
                    redirect($this->p_master->u_action . '&amp;block=block_menu&amp;action=add_button&amp;parent_id=' . $parent_id . '&amp;button_name=' . urlencode((string) $button_name));
                }
