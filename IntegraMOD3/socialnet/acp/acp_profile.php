...
class acp_profile extends socialnet
{
    ...
    public function manage_reasons()
    {
        global $db, $template, $user;
    ...
    public function manage_emotes()
    {
        global $template, $db, $user, $phpbb_root_path;

        $this->p_master->acpPanel_title = $user->lang['SN_PROFILE_MANAGE_EMOTES'] ?? '{ SN_PROFILE_MANAGE_EMOTES }';
        $this->p_master->acpPanel_explain = $user->lang['SN_PROFILE_MANAGE_EMOTES_EXPLAIN'] ?? '{ SN_PROFILE_MANAGE_EMOTES_EXPLAIN }';
    ...
    public function emote_order(&$error, $action)
    {
    ...
    public function emote_edit(&$error)
    {
    ...
    public function emote_delete($error)
    {
        global $db, $user;
        $emote_id = request_var('emote_id', 0);
