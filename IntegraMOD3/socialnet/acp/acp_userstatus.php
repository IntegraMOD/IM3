            ...
            if (in_array($action, array_keys($user_tools)) && !empty($username)) {
                ...
                switch ($action) {
                    ...
                    case 'delete_statuses':
                        ...
                        $commen_in_set = str_replace('status_id', 'entry_target', (string) $sql_in_set);
                ...
                add_log('admin', 'LOG_CONFIG_SN_USERSTATUS_BASICTOOLS_' . strtoupper((string) $action), $username_);
                ...
                add_log('admin', 'LOG_CONFIG_SN_USERSTATUS_BASICTOOLS_' . strtoupper((string) $action));
                trigger_error($user->lang[$user_tools[$action]]);
            }
        }
