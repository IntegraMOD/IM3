...
{
    public $modulesName = array();
    public $modulesID = array();
    public $time = 0;

    public $commentTemplate = 'socialnet/block_comments.html';

    /**
     * Constructor
     * - load existing modules using cache
     */
    function __construct(public $p_master)
    {
     ...
     */
    function add($module, $module_id, $poster, $text)
    {
        global $db;
     ...
     * Delete a comment
     */
    function del($module, $cmt_id, $cmt_one = true)
    {
        global $db, $auth;
     ...
     * Retrieve a comment
     */
    function get($module, $classPrefix, $module_id, $cmt_id = 0, $limit = false, $only_comments = false)
    {
        ...
        $template->assign_vars(array(
            ...
            'SN_CLASS_PREFIX_DOT'				 => preg_replace('/[^a-z0-9]/si', '.', (string) $classPrefix),
    ...
    function getField($module, $cmt_id, $field)
    {
        global $db;
    ...
    function getPosters($module, $cmt_mid, $with_me = false)
    {
        global $db, $user;
