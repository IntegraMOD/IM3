...
//      $this->snFunctions();
    ...
    public function get_username_string($cfg_module, $mode, $user_id, $username, $username_colour = '', $guest_username = false, $custom_profile_url = false, $cache_friends = true)
    {
        ...
        if (isset($this->friends['colourNames'][$user_id][$mode]) && $username != $user->lang['GUEST'] && !str_contains((string) $this->friends['colourNames'][$user_id][$mode], (string) $user->lang['GUEST'])) {
