...
$sql = $db->sql_build_query('SELECT', array(
	'SELECT'	=> 'u.*, z.friend, z.foe, p.*, pb.id AS pb_id, pb.holding AS pb_holding, gu.personal_album_id, gu.user_images',
...
if(!empty($topic_data['topic_calendar_time']) && !empty($topic_data['topic_calendar_duration']))
{
    ...
    $sql = 'SELECT username, user_id, user_colour FROM ' . USERS_TABLE . '
            WHERE ' . $db->sql_in_set('user_id', explode(',', (string) $topic_data['event_attendees']));
    $result = $db->sql_query($sql);
    ...
    $sql = 'SELECT username, user_id, user_colour FROM ' . USERS_TABLE . '
            WHERE ' . $db->sql_in_set('user_id', explode(',', (string) $topic_data['event_non_attendees']));
    $result = $db->sql_query($sql);
