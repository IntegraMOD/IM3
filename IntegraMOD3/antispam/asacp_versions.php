...
$versions = array(
	'0.1.0'		=> array(
		...
		'module_add'	=> array(
			array('acp', 'ACP_CAT_IMOD', 'ANTISPAM'),
	...
	'0.1.10'		=> array(
		'config_add'	=> array(
			array('asacp_profile_fb', 2),
			array('asacp_profile_fb_post_limit', 5),
			array('asacp_profile_ig', 2),
			array('asacp_profile_ig_post_limit', 5),
			array('asacp_profile_pt', 2),
			array('asacp_profile_pt_post_limit', 5),
			array('asacp_profile_twr', 2),
			array('asacp_profile_twr_post_limit', 5),
			array('asacp_profile_skp', 2),
			array('asacp_profile_skp_post_limit', 5),
			array('asacp_profile_tg', 2),
			array('asacp_profile_tg_post_limit', 5),
			array('asacp_profile_li', 2),
			array('asacp_profile_li_post_limit', 5),
			array('asacp_profile_tt', 2),
			array('asacp_profile_tt_post_limit', 5),
			array('asacp_profile_dc', 2),
			array('asacp_profile_dc_post_limit', 5),
...
function asacp_update($action, $version)
{
	...
	switch ($version)
	{
		...
		case '0.7.0' :
			...
			$umil->module_remove('acp', 'ACP_CAT_IMOD', 'ANTISPAM');

			$umil->module_add('acp', 'ANTISPAM', array('module_basename' => 'asacp'));
			$umil->module_add('acp', 'ACP_CAT_IMOD', 'ANTISPAM');
		break;
	}
}
