...
CREATE TABLE phpbb_calendar (
	...
	bbcode_bitfield varchar(255) DEFAULT '' NOT NULL,
	bbcode_uid varchar(8) DEFAULT '' NOT NULL,
	event_start INT4 DEFAULT '0' NULL CHECK (event_start >= 0),
	event_end INT4 DEFAULT '0' NULL CHECK (event_end >= 0),
	event_repeat varchar(8) DEFAULT '' NULL,
	invite_attendees INT2 DEFAULT '0' NULL CHECK (invite_attendees >= 0),
...
CREATE TABLE phpbb_calendar_repeat_events (
	...
	event_start_time INT4 DEFAULT '0' NULL CHECK (event_start_time >= 0),
	event_end_time INT4 DEFAULT '0' NULL CHECK (event_end_time >= 0),
	PRIMARY KEY (id)
);
...
CREATE TABLE phpbb_forums (
	...
	forum_share_enable INT2 DEFAULT '1' NOT NULL CHECK (forum_share_enable >= 0),
...
CREATE TABLE phpbb_sn_im (
	im_id INT4 DEFAULT nextval('phpbb_sn_im_seq'),
...
CREATE TABLE phpbb_topics (
	...
	poll_last_vote INT4 DEFAULT '0' NOT NULL CHECK (poll_last_vote >= 0),
	poll_vote_change INT2 DEFAULT '0' NOT NULL CHECK (poll_vote_change >= 0),
	topic_calendar_time INT4 DEFAULT '0' NULL,
	topic_calendar_duration INT4 DEFAULT '0' NULL CHECK (topic_calendar_duration >= 0),
	event_repeat varchar(8) DEFAULT '' NULL,
	invite_attendees INT2 DEFAULT '0' NULL CHECK (invite_attendees >= 0),
	event_attendees TEXT DEFAULT '' NULL,
	event_non_attendees TEXT DEFAULT '' NULL,
...
CREATE TABLE phpbb_users (
	...
	user_push_web_friend_req INT2 DEFAULT '1' NOT NULL CHECK (user_push_web_friend_req >= 0),
	user_push_web_friend_acc INT2 DEFAULT '1' NOT NULL CHECK (user_push_web_friend_acc >= 0),
	user_push_web_pm INT2 DEFAULT '1' NOT NULL CHECK (user_push_web_pm >= 0),
	user_push_web_like INT2 DEFAULT '1' NOT NULL CHECK (user_push_web_like >= 0),
	user_push_web_activity INT2 DEFAULT '1' NOT NULL CHECK (user_push_web_activity >= 0),
	user_push_web_sub_post INT2 DEFAULT '1' NOT NULL CHECK (user_push_web_sub_post >= 0),
	user_push_web_sub_topic INT2 DEFAULT '1' NOT NULL CHECK (user_push_web_sub_topic >= 0),
	user_push_web_news INT2 DEFAULT '1' NOT NULL CHECK (user_push_web_news >= 0),
	user_push_web_announce INT2 DEFAULT '1' NOT NULL CHECK (user_push_web_announce >= 0),
	user_push_sms_friend_req INT2 DEFAULT '0' NOT NULL CHECK (user_push_sms_friend_req >= 0),
	user_push_sms_friend_acc INT2 DEFAULT '0' NOT NULL CHECK (user_push_sms_friend_acc >= 0),
	user_push_sms_pm INT2 DEFAULT '0' NOT NULL CHECK (user_push_sms_pm >= 0),
	user_push_sms_like INT2 DEFAULT '0' NOT NULL CHECK (user_push_sms_like >= 0),
	user_push_sms_activity INT2 DEFAULT '0' NOT NULL CHECK (user_push_sms_activity >= 0),
	user_push_sms_sub_post INT2 DEFAULT '0' NOT NULL CHECK (user_push_sms_sub_post >= 0),
	user_push_sms_sub_topic INT2 DEFAULT '0' NOT NULL CHECK (user_push_sms_sub_topic >= 0),
	user_push_sms_news INT2 DEFAULT '0' NOT NULL CHECK (user_push_sms_news >= 0),
	user_push_sms_announce INT2 DEFAULT '0' NOT NULL CHECK (user_push_sms_announce >= 0),
	PRIMARY KEY (user_id)
);
