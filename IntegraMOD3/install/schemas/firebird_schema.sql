...
CREATE TABLE phpbb_calendar (
	...
	bbcode_bitfield VARCHAR(255) CHARACTER SET NONE DEFAULT '' NOT NULL,
	bbcode_uid VARCHAR(8) CHARACTER SET NONE DEFAULT '' NOT NULL,
	event_start INTEGER DEFAULT 0 NULL,
	event_end INTEGER DEFAULT 0 NULL,
	event_repeat VARCHAR(8) CHARACTER SET NONE DEFAULT '' NULL,
...
CREATE TABLE phpbb_calendar_repeat_events (
	id INTEGER NOT NULL,
	repeat_id VARCHAR(8) CHARACTER SET NONE DEFAULT '' NULL,
	event_start_time INTEGER DEFAULT 0 NULL,
	event_end_time INTEGER DEFAULT 0 NULL
);;
...
ALTER TABLE phpbb_sn_comments ADD PRIMARY KEY (cmt_id);;
...
ALTER TABLE phpbb_sn_comments_modules ADD PRIMARY KEY (cmtmd_id);;
...
ALTER TABLE phpbb_sn_fms_groups ADD PRIMARY KEY (fms_gid);;
...
ALTER TABLE phpbb_sn_im ADD PRIMARY KEY (im_id);;
...
CREATE GENERATOR phpbb_sn_im_gen;;
SET GENERATOR phpbb_sn_im_gen TO 0;;

CREATE TRIGGER t_phpbb_sn_im FOR phpbb_sn_im
BEFORE INSERT
AS
BEGIN
	NEW.im_id = GEN_ID(phpbb_sn_im_gen, 1);
END;;
...
CREATE TABLE phpbb_topics (
	...
	poll_last_vote INTEGER DEFAULT 0 NOT NULL,
	poll_vote_change INTEGER DEFAULT 0 NOT NULL,
	topic_calendar_time INTEGER DEFAULT 0 NULL,
	topic_calendar_duration INTEGER DEFAULT 0 NULL,
	event_repeat VARCHAR(8) CHARACTER SET NONE DEFAULT '' NULL,
	invite_attendees INTEGER DEFAULT 0 NULL,
	event_attendees BLOB SUB_TYPE TEXT CHARACTER SET UTF8 DEFAULT '' NULL,
	event_non_attendees BLOB SUB_TYPE TEXT CHARACTER SET UTF8 DEFAULT '' NULL,
