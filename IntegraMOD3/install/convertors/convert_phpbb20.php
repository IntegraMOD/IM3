...
/*				array('',						'',									'search_indexing'),
			...
			array(
				...
				array('user_fb',				'users.user_fb',					array('function1' => 'phpbb_set_encoding')),
				array('user_ig',				'users.user_ig',					array('function1' => 'phpbb_set_encoding')),
				array('user_pt',				'users.user_pt',					array('function1' => 'phpbb_set_encoding')),
				array('user_twr',				'users.user_twr',					array('function1' => 'phpbb_set_encoding')),
				array('user_skp',				'users.user_skp',					array('function1' => 'phpbb_set_encoding')),
				array('user_tg',				'users.user_tg',					array('function1' => 'phpbb_set_encoding')),
				array('user_li',				'users.user_li',					array('function1' => 'phpbb_set_encoding')),
				array('user_tt',				'users.user_tt',					array('function1' => 'phpbb_set_encoding')),
				array('user_dc',				'users.user_dc',					array('function1' => 'phpbb_set_encoding')),
				array('user_jabber',			'',									''),
