...
// Load jQuery and set up no-conflict mode
...
function initBBCode($) {
    ...
    window.attachInline = attachInline;
...
(function(d, s) {
    ...
    if (d.getElementById('jquery-script')) return;
    js = d.createElement(s);
    js.id = 'jquery-script';
    js.src = 'https://code.jquery.com/jquery-3.6.0.min.js'; // Updated to the latest stable version
    js.onload = function() {
        // jQuery is loaded, now we can run our main code
        jQuery.noConflict();
        (function($) {
            $(document).ready(function() {
