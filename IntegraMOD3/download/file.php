...
if (isset($_GET['avatar']))
{
	...
	// worst-case default
	$browser = !empty($_SERVER['HTTP_USER_AGENT']) ? htmlspecialchars($_SERVER['HTTP_USER_AGENT'], ENT_COMPAT) : 'msie 6.0';
...
{
	$user_agent = !empty($_SERVER['HTTP_USER_AGENT']) ? htmlspecialchars($_SERVER['HTTP_USER_AGENT'], ENT_COMPAT) : '';
