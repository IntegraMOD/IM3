        ...
        if (confirm(mChatDelConfirm)) {
            $j.ajax({
                ...
                success: function() {
                    ...
                    mChat.sound(mChatForumRoot + 'mchat/del.mp3')
                },
                error: function() {
                    alert(mChatNoAccess)
                },
        ...
        $j.ajax({
            ...
            success: function(html) {
                if (html != '' && html != 0) {
                    ...
                    mChat.sound(mChatForumRoot + 'mchat/add.mp3')
                }
                setTimeout(function() {
                    $j('#mChatLoadIMG,#mChatErrorIMG,#mChatPauseIMG').hide();
                    $j('#mChatOkIMG').show();
            ...
            error: function() {
                $j('#mChatLoadIMG,#mChatOkIMG,#mChatPauseIMG,#mChatRefreshTextNo').hide();
                $j('#mChatErrorIMG').show();
                mChat.sound(mChatForumRoot + 'mchat/error.mp3')
            },
            complete: function() {
